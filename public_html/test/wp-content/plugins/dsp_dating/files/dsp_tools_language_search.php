                    ...
                    <ul>
                        <li class="heading">
                           <span class="code-name">
                               <?php echo __('Code Name', 'wpdating'); ?>
                           </span> 
                           <span class="txt-name">
                               <?php echo __('Text Name', 'wpdating'); ?>
                           </span> 
                        ...
                        <li>
                           ...
                           <span style='float:left;width:10%;'>
                               <a href="<?php
                                        ...
                                        ?>"><?php echo __('Edit This Only', 'wpdating'); ?></a>
                            </span>
                        </li>
                        <?php } ?>
                     </ul>
                    <div class="btn-save">
                        <input class="button" name="update_lang_text" type="submit" value="<?php echo __('Save', 'wpdating'); ?>" />
                    </div>                                                                      
                </div>
            </form>                                                                     
        <?php
