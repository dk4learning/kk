...
/////////pagination dynamic color from admin start/////////////////
?>
<div class="wrap"><h2><?php echo __('Discount Codes', 'wpdating'); ?></h2></div>
<div id="navmenu" align="left">
	<ul>
		<li>
			<a href="admin.php?page=dsp-admin-sub-page5&pid=dsp_discount_codes" title="<?php echo __('Discount Setting', 'wpdating'); ?>">
			</a>
		</li>
