...
if ($action == 'add') {
    if ($new_gender != "") {
        ...
        if ($check_gender_exist == 0) {
            ...
            ?>
            <li id="list_<?php echo $gender_id; ?>"><span class="title-name"><?php echo $new_gender; ?></span><span class="links-edit"><a href="<?php echo $gender_id; ?>" id="dsp_edit_gender"><?php echo __('Edit', 'wpdating'); ?></a> - <a href="<?php echo $gender_id; ?>" id="dsp_delete_gender"><?php echo __('Delete', 'wpdating'); ?></a></span></li>
            <?php
        }
    }
}
