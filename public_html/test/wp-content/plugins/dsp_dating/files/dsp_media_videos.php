                                ...
                                <td align="left" class="thumbnails-bg">
                                    <table cellpadding="0" border="0">
                                        <tr><td align="center"><table align="center" style="border:1px solid #CCCCCC;">
                                                    ...
                                                    <tr>
                                                        <td><span onclick="approve_video('<?php echo $video_file_id ?>')" class="span_pointer" style="font-size:12px;"><?php echo __('Approve', 'wpdating') ?></span>&nbsp;&nbsp;|&nbsp;&nbsp;</td>
                                                        <td><span onclick="reject_video('<?php echo $video_file_id ?>')" class="span_pointer" style="font-size:12px;"><?php echo __('Reject', 'wpdating') ?></span>&nbsp;&nbsp;|&nbsp;&nbsp;</td>
                                                        <td><span onclick="delete_video('<?php echo $video_file_id ?>')" class="span_pointer" style="font-size:12px;"><?php echo __('Delete', 'wpdating'); ?></span></td></tr>
                                                </table></td></tr>
                                    </table>
                                </td>
                                <?php
                                    ...
                                    <table cellpadding="0" border="0">
                                        <tr><td align="center" colspan="2">
                                                <table align="center" style="border:1px solid #CCCCCC;">
                                                    ...
                                                    <tr>
                                                        <td align="right"><span onclick="approve_video('<?php echo $video_file_id ?>')" class="span_pointer" style="font-size:12px;"><?php echo __('Approve', 'wpdating') ?></span>&nbsp;&nbsp;|&nbsp;&nbsp;</td>
                                                        <td><span onclick="delete_video('<?php echo $video_file_id ?>')" class="span_pointer" style="font-size:12px;"><?php echo __('Delete', 'wpdating'); ?></span></td></tr>
                                                </table></td></tr>
                                    </table>
                                </td>
