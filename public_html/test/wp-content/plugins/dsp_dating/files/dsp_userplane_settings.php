...
<div id="general" class="postbox">
    <h3 class="hndle"><span><?php echo __('Instant Messenger', 'wpdating'); ?></span></h3>
                    ...
                    <table cellpadding="0" cellspacing="0" border="0" class="dsp_thumbnails1">
                        ...
                        <tr valign="top">
                            <td colspan="2" scope="row" class="form-field form-required"><label
                                    for="gatewayaddress"><?php _e(__('IM Solution:', 'wpdating')) ?></label>
                        ...
                        ?>;">
                            <td width="133" scope="row" class="form-field form-required"><label
                                    for="gatewayaddress"><?php _e(__('Site ID', 'wpdating')) ?></label></td>
                        ...
                        ?>;">
                            <td width="133" scope="row" class="form-field form-required"><label
                                    for="gatewayaddress"><?php _e(__('API Key', 'wpdating')) ?></label></td>
