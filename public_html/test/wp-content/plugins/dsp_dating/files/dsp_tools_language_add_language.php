<script type="text/javascript">
    ...
    function checkValidLang()
    {
        ...
        if(!validLangName){
            ...
            alert("<?php echo __('Language name already exist!', 'wpdating'); ?>");
            return false;
        }
    ...
    if(langName == ''){
        ...
        var emptyMsg = "<?php echo __('Please enter language name!', 'wpdating'); ?>";
            ...
            <form action="" method="post" enctype="multipart/form-data"  <?php if ($mode == "add") { ?>onsubmit="return checkValidLang();" <?php } else { ?> onsubmit="return checkValidEditLang();" <?php } ?>>
                <table width="100%">
                    ...
                    <tr>
                        ...
                        <td >
                            <a href="<?php echo WPDATE_URL . '/flags/flags.zip';?>" style="color: red"><?php echo __('Download Flag First', 'wpdating'); ?></a>
