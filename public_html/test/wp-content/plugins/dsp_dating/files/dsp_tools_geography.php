...
if($update_geo == 'setting_update'){
    ...
    if(in_array(0,$result)){
        $_SESSION['successMsg'] = __('Settings changes are saved.', 'wpdating');
    }
    ?>
...
<form name="add_dsp_geography" action="" method="post">
    ...
    <div class="dsp_wrap">
        <div id="general" class="postbox">
            <h3 class="hndle"><span><?php echo __('Geography', 'wpdating') ?></span></h3>
            <div class="dsp_wrap dsp_thumbnails1">
                ...
                ?>
                <div class="dsp_col1"><strong><?php echo __('Country:', 'wpdating') ?></strong>
                ...
                <div class="dsp_col3">
                    <input type="button" name="edit_button" class="button" value="<?php echo __('edit', 'wpdating'); ?>" onclick="update_dsp_country();"/>
                    &nbsp;<input type="button" name="delete_button" class="button" value="<?php echo __('Delete', 'wpdating'); ?>" onclick="delete_dsp_country();" /></div>
                <div class="dsp_col4"><input type="text" id="txtcounty" name="txtcounty" value="" /></div>
                <div class="dsp_col5">
                    <input type="button" name="add_country_button" id="country_button" class="button" value="<?php echo __('Add', 'wpdating'); ?>" onClick="add_dsp_country();" />
                </div>
                <?PHP //**************************  DISPLAY COUNTRY DROPDOWN, TEXT AND EDIT,DELETE,ADD BUTTON *************************//  ?>
                <div class="clear"></div>
                <?PHP //**************************  DISPLAY STATE DROPDOWN, TEXT AND EDIT,DELETE,ADD BUTTON *************************//   ?>
                <div class="dsp_col1"><strong><?php echo __('State:', 'wpdating') ?></strong>
                    ...
                    <select name="cmbState" id="cmbState" style="width:150px; float:left;" onChange="document.add_dsp_geography.submit();">
                        ...
                        foreach ($states as $state) {
                         ...
                         ?>
                           ...
                           <?php endif; ?>
                      <?php } ?>
              <!--<option value="1"><?php echo __('Select State', 'wpdating') ?></option>-->
                    </select>
                ...
                <div class="dsp_col3">
                    <input type="button" name="edit_button" class="button" value="<?php echo __('edit', 'wpdating'); ?>" onclick="update_dsp_state();"/>&nbsp;
                    <input type="button" name="delete_button" class="button" value="<?php echo __('Delete', 'wpdating'); ?>" onclick="delete_dsp_state();" />
                </div>
                <div class="dsp_col4"><input type="text" id="txtstate" name="txtstate" value="" /></div>
                <div class="dsp_col5">
                    <input type="button" name="add_button" id="state_button" class="button" value="<?php echo __('Add', 'wpdating'); ?>"  onClick="add_dsp_state();"/></div>
                <?PHP //**************************  DISPLAY STATE DROPDOWN, TEXT AND EDIT,DELETE,ADD BUTTON *************************//   ?>
                </FORM>
                <div class="clear"></div>  
                <?PHP //**************************  DISPLAY CITY DROPDOWN, TEXT AND EDIT,DELETE,ADD BUTTON *************************//   ?>
                <div class="dsp_col1"><strong><?php echo __('City:', 'wpdating') ?></strong>
                ...
                <div class="dsp_col3"><input type="button" name="edit_button" class="button" value="<?php echo __('edit', 'wpdating'); ?>" onclick="update_dsp_city();" />&nbsp;
                    <input type="button" name="delete_button" class="button" value="<?php echo __('Delete', 'wpdating'); ?>" onclick="delete_dsp_city();" /></div>
                <div class="dsp_col4"><input type="text" name="txtcity" id="txtcity" value="" /></div>
                <div class="dsp_col5"><input type="button" name="add_button" id="city_button" class="button" value="<?php echo __('Add', 'wpdating'); ?>" onclick="add_dsp_city();"/></div>
                <?PHP //**************************  DISPLAY CITY DROPDOWN, TEXT AND EDIT,DELETE,ADD BUTTON *************************//   ?>
                <div class="clear"></div>
            </div>
            <br><br>
...
<form name="frmgeneralsettings" method="post" action="<?php
    ...
    <div class="dsp_wrap">
        <div id="general" class="postbox">
            <h3 class="hndle"><span><?php echo __('Settings', 'wpdating') ?></span></h3>
            <table>
                <!-- Module to select default country -->
                <tr >
                    <td style="width:112px;" class="form-field form-required" id="head"><?php echo __('Default Country', 'wpdating'); ?></td>
                    ...
                    <td align="left" ><span class="description"><?php _e(__('Select default country', 'wpdating')) ?></span> </td>  
                </tr>
                ...
                -->
                <tr>
                    <td class="form-field form-required display-option-head" id="head"><?php echo __('Search Form Type', 'wpdating'); ?></td>
                    <td>
                       
                        <select name="search_form_options" style="width:210px;">
                            <?php 
                                if ($check_search_from_option->setting_value == 'ow') : // Old way search form ?>
                                        <option value="ow" selected="selected"><?php echo __('Search form with country list', 'wpdating'); ?></option>
                                        <option value="nw"><?php echo __('Search form with geography', 'wpdating'); ?></option>
                                        <option value="nn"><?php echo __('None', 'wpdating'); ?></option>
                                       
                            <?php elseif ($check_search_from_option->setting_value == 'nw') : // new way search form by using Google geography  ?>
                                       <option value="ow" ><?php echo __('Search form with country list', 'wpdating'); ?></option>
                                       <option value="nw" selected="selected"><?php echo __('Search form with geography', 'wpdating'); ?></option> 
                                       <option value="nn" ><?php echo __('None', 'wpdating'); ?></option>
                            <?php else : //No country search ?>
                                        <option value="ow"><?php echo __('Search form with country list', 'wpdating'); ?></option>
                                        <option value="nw" ><?php echo __('Search form with geography', 'wpdating'); ?></option>
                                        <option value="nn" selected="selected"><?php echo __('None', 'wpdating'); ?></option>
                            <?php endif; ?>
                        </select>
                    </td>
                    <td><span class="description" style="white-space:nowrap;">&nbsp;<?php echo __('Select which layouts to show in members not loggedin page', 'wpdating'); ?></span></td>
                </tr>
