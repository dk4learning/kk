   	...
   	case 'Add':
   	   if (!empty($url) && !empty($caption)) { 
                ...
                if(dsp_insert_template_values($template_info)){
                    echo __('Uploaded successfully.', 'wpdating') . "\n";
                }else{
                    echo __('<#FILE_NAME#> cannot be uploaded.', 'wpdating') . "\n";
                }
        }
   		break;
...
<div id="general" class="postbox">
	<table border="0" cellspacing="5" cellpadding="5" width="45%" class="wp-list-table widefat fixed users">
       <thead >
            <tr>
                <th><?php echo __('Template Images', 'wpdating');?></th>
                <th><?php echo __('Caption', 'wpdating');?></th>
                <th><?php echo __('status', 'wpdating');?></th>
                 ...
                 ?>
                    ...
                    <tr>
                        ...
                        <td style=" font-size:15px;">
                            <a href="<?php echo $root_link . "&Action=edit&id=" . $id; ?>"><?php echo __('edit', 'wpdating'); ?></a>
                            <span>-</span>
                            <a href="<?php echo $root_link . "&Action=delete&id=" . $id; ?>" onclick="return confirm('Are you sure you wanna delete?');"><?php echo __('Delete', 'wpdating'); ?></a>
                        </td>
                    </tr>
      ...
      <tfoot>
            <tr>
                ...
                <th><?php echo __('Caption', 'wpdating');?></th>
                <th><?php echo __('status', 'wpdating');?></th></th>
                <th><?php echo __('Actions', 'wpdating');?></th></th>
            </tr>
        </tfoot>  
	</table>
</div>
...
?>
<div id="general" class="postbox">
 <h3 class="hndle"><?php echo __('Upload Template Images', 'wpdating'); ?></h3>
<form action="" method="post" name="templateImageUploadFrm" enctype="multipart/form-data" class="upload-template upload-template-image">
    <table width="50%">
        ...
        <tr><td>&nbsp;</td></tr>
        <tr>
            <td><?php echo __('Caption', 'wpdating'); ?>:</td>
        ...
        <tr>
            <td><?php echo __('status', 'wpdating'); ?>:</td>
        ...
        <tr>
         <tr>
            <td><?php echo __('Upload Template Images', 'wpdating'); ?>:</td>
            <td>
                ...
                <div id="wpss_upload_image_thumb" class="wpss-file">
                    <div class="upload-image-text-block">
                        <p class="description"><?php echo __('Please upload template images of following sizes for template1(566px*361px),template2(950px*694px),template3(950px*413px),template4(950px*457px),template5(950px*482px),template6(525px*418px),template7(950px*457px)', 'wpdating'); ?></p>
...
<script >
    function Checkform() {
        ...
        {
            alert('<?php __('Please choose image file.', 'wpdating'); ?>');
