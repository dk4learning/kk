...
<script type="text/javascript">
    ...
    {
        var cnf = confirm('<?php echo __('Are you sure to delete it?', 'wpdating'); ?>');
        if (cnf)
        {
            return true;
        }
    ...
    function checkValidEditLang()
    {
        ...
        {
            alert("<?php echo __('Please enter language name!', 'wpdating'); ?>");
            return false;
        }
    ...
    function checkvalidSearch()
    {
        ...
        {
            alert("<?php echo __('Please select language!', 'wpdating'); ?>");
            return false;
        }
        if (document.getElementById('search_text_name').value == '')
        {
            alert("<?php echo __('Please enter code!', 'wpdating'); ?>");
            return false;
        }
    ...
    function checkValidLang()
    {
        ...
        if (document.getElementById('default_image').value == "")
        {
            ...
            alert("<?php echo __('Please select image!', 'wpdating'); ?>");
            return false;
        }
        if (document.getElementById('language_file').value == "")
        {

            alert("<?php echo __('Please select language file!', 'wpdating'); ?>");
            return false;
        }
        return true;
    }
...
<div>
    <div id="general" class="postbox">
        <h3 class="hndle"><span><?php echo __('Language Admin', 'wpdating'); ?></span></h3>
        <br />
            ...
            <div style="width:421px;">
                <form name="search" method="post"  action="" onsubmit="return checkvalidSearch();">
                    <div style="float:none;" >
                        ...
                        <input name="search" type="submit" value="<?php echo __('Search', 'wpdating'); ?>" class="button" />
                    </div>
                </form>
            </div>
            <div>
                        ...
                        <form name='abc' method="post" action="" >
                            <table border="0" style="width:995px;">
                                <tr style="line-height: 10px;">
                                    ...
                                    <td class="dsp_language_txt"><?php echo __('Code Name', 'wpdating'); ?></td>
                                    <td class="dsp_language_txt1"><?php echo __('Text Name', 'wpdating'); ?></td>
    ...
    <div id="general" class="postbox">
        <h3 class="hndle"><span><?php echo __('Add Language Text', 'wpdating') ?></span></h3>
        <br />
        <div class="dsp_thumbnails3" >
                                ...
                                <form name="addcode_<?php echo $i; ?>" method="post" action="" onsubmit="return validation('<?php echo $i; ?>');" >
                                    <table width="100%">
                                        <tr>
                                            ...
                                            <td width="10%" ><input name="addcode" type="submit" value="<?php echo __('Add', 'wpdating') ?>" class="button" />
                        ...
                        <form name='abc' method="post" action="">
                            <table width="100%" border="0">
                                <tr style="line-height: 10px;">
                                    ...
                                    <td width="31%" class="dsp_language_txt" ><?php echo __('Code Name', 'wpdating'); ?></td>
                                    <td width="20%" class="dsp_language_txt1"><?php echo __('Text Name', 'wpdating'); ?></td>
                                    <td style="width: 100px;">&nbsp;</td>
                                </tr>
                                <?php
                                foreach ($language_table as $language) {
...
<!--                <div  style="color:#FF0000; font-weight:bold; margin-bottom: 7px;"> NOTE: Please consult this <a href="http://www.wpdating.com/support/forums/how-to/add-new-text-to-language/" style=" color:#FF0000;">Support Forum Thread</a> before adding new text to the language base.</div>-->
    ...
    <!-- ------------------------ADD NEW LANGUAGE------------------------------------------- -->
    <div id="general" class="postbox">
        <h3 class="hndle"><span><?php echo __('Add New Language', 'wpdating'); ?></span></h3>
        <br />
        <div class="dsp_thumbnails3" >
            <div style="width:800px;">
                            ...
                            foreach ($all_languages as $lang) {
                                ...
                                <tr>
                                    ...
                                    <td style=" font-size:15px;">
                                        <a href="<?php echo $root_link . "&Action=edit&lId=" . $lang_id; ?>"><?php echo __('edit', 'wpdating'); ?></a>
                                    </td> 
                                    <td>-</td>
                                    <td style=" font-size:15px;">
                                        <a href="<?php echo $root_link . "&Action=delete&lId=" . $lang_id; ?>" onclick="return checkconfirm();"><?php echo __('Delete', 'wpdating'); ?></a>
                                    </td>
                                </tr>
                            <?php }
                            ?>
                ...
                <br>
                <br>
                <span style="font-weight:bold;font-size: 14px "><?php echo __('Add New Language', 'wpdating'); ?></span>
                <br>
                <br>
                <br>
                <form action="" method="post" enctype="multipart/form-data"  <?php if ($mode == "add") { ?>onsubmit="return checkValidLang();" <?php } else { ?> onsubmit="return checkValidEditLang();" <?php } ?>>
                    <table width="100%">
                        ...
                        <tr><td>&nbsp;</td></tr>
                        <tr>
                            <td width="25%"><?php echo __('Language Name', 'wpdating'); ?>:</td>
                            <td><input id="txt_language_name" type="text" value="<?php if (isset($langName)) echo $langName; ?>" name="txt_language_name" /></td>
                            <td>&nbsp;</td>
                        </tr>

                        <tr>
                            <td><?php echo __('Charset', 'wpdating'); ?>:</td>
                            <td><input type="text" value="<?php if (isset($charSet)) echo $charSet; ?>" name="txt_charset" /></td>
                            <td>&nbsp;</td>
                        </tr>
                        <tr>
                            <td><?php echo __('Import Language File', 'wpdating'); ?>:</td>
                            <td><input id="language_file" type="file" name="language_file" size="18"  value="" /></td>

                            <td ><a href="<?php echo WPDATE_URL . '/language.php' ?>" style="color: red"><?php echo __('Download Language File and Translate Before Importing', 'wpdating'); ?><a></td>
                                        </tr>
                                        <tr>
                                            <td><?php echo __('Flag Image', 'wpdating'); ?>:</td>
                                            <td><input id="default_image" type="file" name="default_image" size="18" accept="image/*" value=""/></td>
                                            <td >
                                                <a href="<?php echo get_option('siteurl') . '/wp-content/uploads/flags.zip' ?>" style="color: red"><?php echo __('Download Flag First', 'wpdating'); ?></a>
