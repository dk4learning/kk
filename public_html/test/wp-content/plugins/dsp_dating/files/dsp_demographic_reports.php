...
<div id="general" class="postbox">
    <h3 class="hndle"><span><?php echo __('Demographics', 'wpdating') ?></span></h3>
    <div style="margin:20px">
        <table class="dsp_thumbnails1" border="0" width="100%">
            <tr>
                <td>
                    <table width="500" border="0" cellspacing="0" cellpadding="6" style="padding-top:20px">
                        <tr>
                ...
                <td rowspan="2">
                    <table width="100%">
                        <tr>
                            <td colspan="2">
                                <img src="<?php echo WPDATE_URL . '/files/dsp_piechart.php?data=' . $count_total_males ?>*<?php echo $count_total_females ?>*<?php echo $count_total_couples ?>&label=Males*Females*couple" alt="pie chart"/>
