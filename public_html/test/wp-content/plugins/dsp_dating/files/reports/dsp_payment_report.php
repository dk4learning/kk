...
wp_enqueue_script('jquery-ui-1.8.6.custom',WPDATE_URL . '/js/jquery-ui-1.8.6.custom.min.js', array(), '', true);
...

    {
...

        {
...

            {
                ...
                alert("<?php echo __('Please enter days!', 'wpdating'); ?>");
...

            {
...

                {
                    ...
                    alert("<?php echo __('Please enter a number!', 'wpdating'); ?>");
...

        {
...

            {
                ...
                alert("<?php echo __('Please enter the date!', 'wpdating'); ?>");
...

        {
...

            {
                ...
                alert("<?php echo __('please enter date range!', 'wpdating'); ?>");
...
include_once('functions/dsp_accounting_report_function.php');
...
<div class="admin_setting_div">
    ...
    <div id="general" class="postbox">
        ...
        <h3 class="hndle"><span><?php echo __('Accounting', 'wpdating') ?></span></h3>

        <div style="margin:20px;">

            <form action="" method="post" onsubmit="return checkValidPost();" class="report-account">
                ...
                <table  style="width:60% "   border="0" cellspacing="0" cellpadding="00" >
                    ...
                    <tr>
                        ...
                        <td width="20%" colspan="2" >
                            ...
                            <input type="radio" <?php echo $total ?>  name="radio_payment" value="total_amount" />&nbsp;<?php echo __('Total Amount', 'wpdating') ?>
                    ...
                    <tr>
                        ...
                        <td width="25%" ><input type="radio" <?php echo $seldays ?> name="radio_payment" value="last_days"  />&nbsp;
                            ...
                            <?php echo __('During Last:', 'wpdating') ?></td>

                        <td><input type="text" id="txt_during_last_days" name="txt_during_last_days" value="<?php if (isset($days)) echo $days; ?>" />

                            <?php echo __("Days (Type 0 for today's transactions)", 'wpdating') ?></td>

                    </tr>

                    <tr>

                        <td width="25%" ><input type="radio" <?php echo $selDate ?> name="radio_payment" value="on_date" />&nbsp;<?php echo __('On the Date: ', 'wpdating') ?></td>
                    ...
                    <tr>
                        ...
                        <td width="25%" ><input type="radio" <?php echo $selBetween ?> name="radio_payment" value="between_days" />&nbsp;
                            ...
                            <?php echo __('Between Dates:', 'wpdating') ?></td>
                    ...
                    <tr><td>&nbsp;</td>
                        ...
                        <td ><p class="submit"><input type="submit" class="button-primary" name="submit" value="<?php echo __('Submit', 'wpdating') ?>"/></p></td>  
                        ...
                        <td colspan="2" align="center">
                            ...
                            <table width="90%" border="0" cellspacing="0" cellpadding="0">
                                ...
                                <tr style="height:20px;">
                                    ...
                                    if ($type == 'last_days') {
                                        ...
                                        <tr  style="height:20px;">
                                            ...
                                            <td><?php echo __('$', 'wpdating') . ' ' . $username->pay_plan_amount; ?></td>  
                                            ...
                                            <tr  style="height:20px;">
                                                ...
                                                <td><?php
                                                    if ($username->pay_plan_amount != "") {
                                                        echo __('$', 'wpdating') . ' ' . $username->pay_plan_amount;
                                                    }
                                                    ?></td>  
                                ...
                                <tr>
                                    ...
                                    <td align="right" style=" padding-right:10px; font-size:15px; font-weight:bold; color:#058C14;"> <?php echo __('Totals', 'wpdating') ?>:</td>

                                    <td style="font-weight:bold; color:#058C14;font-size:15px;"><?php echo __('$', 'wpdating') . '  ' . $total_payment ?> 
