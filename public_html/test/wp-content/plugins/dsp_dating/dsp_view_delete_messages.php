...
<div class="dsp_box-out box-border">
    <div class="dsp_box_in_with_scroll">
        <div class="box-page">
            <div class="dsp_back_inbox dspdp-spacer-md"><a class="dspdp-btn dspdp-btn-sm dspdp-btn-default" href="<?php echo $root_link . "email/inbox/"; ?>"><?php echo __('Back to Inbox', 'wpdating'); ?></a></div>
            <?php
            //+++++++++++++++++++++++++++++++++++++++++++++++++++++++
            if (get('page'))
                $page = get('page');
                        ...
                        <div class="dsp-row">
                            ...
                            <div class="pull-left dsp-sm-6">
                                ...
                                <?php if ($message->sender_id != $user_id) { ?>
                                    <div><a class="dspdp-btn dspdp-btn-xs dspdp-btn-default dsp-btn dsp-btn-primary dsp-btn-sm" href="<?php echo $root_link . "email/compose/msgid/" . $message->message_id . "/sender_ID/" . $message->sender_id . "/Act/Reply/"; ?>"><?php echo __('Reply', 'wpdating'); ?></a></div>
                                <?php } //end if   ?>
                            </div>  
