...
if (!$user_ID) {
    ...
    if (isset($_POST['submit'])) {// check user registration
        ...
        if (empty($username)) {
            ...
            $reg_msg = __('Fields should not be empty.', 'wpdating');
        } else {
            ...
            /* if(!preg_match("^[_a-z0-9-]+(\.[_a-z0-9-]+)*@[a-z0-9-]+(\.[a-z0-9-]+)*(\.[a-z]{2,3})$^", $email))
              {
              $reg_msg= __('Please enter a valid email address.', 'wpdating');
              echo $reg_msg;
              } */
              ...
              $fail_challenge = true;
                ...
                if ($check_blacklist_ipaddress_table <= 0) {
                    ...
                    if (( is_wp_error($status))) {
                        $reg_msg = __('Username or Email already exist. Please try another one.', 'wpdating');
                    } else {
                        ...
                        $reg_msg = __('Please check your email for your username and password.', 'wpdating');
                    }
                }
            }
        }
...
//Check whether user registration is enabled by the administrator 
    ?>
    <div class="dsp_mb_header"><?php echo __('Login', 'wpdating') ?></div><br>
    <div class="dsp_mb_gray">
        ...
        <form method="post" action="<?php bloginfo('url') ?>/wp-login.php"  >
            <table style="margin-left: 20px">
                ...
                <?php } ?>
                <tr>
                    <td><?php _e(__('Username: ', 'wpdating')); ?></td>
                </tr>
                <tr>
                ...
                <tr>
                    <td><?php _e(__('Password: ', 'wpdating')); ?></td>
                </tr>
                <tr>
                ...
                <tr>
                    <td>&nbsp;</td>
                    <td><input type="checkbox" name="rememberme" value="forever" checked="checked" id="rememberme" tabindex="13" /><?php echo __('Remember Me', 'wpdating') ?>
                    </td>
                </tr>
                <tr>
                    <td>&nbsp;</td>
                    <td><?php do_action('login_form'); ?>
                        <input type="submit" name="user-submit" value="<?php _e(__('Login', 'wpdating')); ?>" tabindex="14" class="user-submit" />
    ...
    <div class="dsp_mb_header"><?php echo __('Register', 'wpdating') ?></div><br>
    <?php if (get_option('users_can_register')) { ?>
        <div class="dsp_mb_gray">
            ...
            <form action="" method="post">
                <table style="margin-left: 20px;" border="0" >
                    ...
                    <tr>
                        <td ><?php echo __('Username: ', 'wpdating'); ?></td>
                    </tr>
                    <tr>
                        <td><input type="text" name="username" class="text" value="" /></td>
                    </tr>
                    <tr>
                        <td><?php echo __('Email:', 'wpdating'); ?></td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        <td>&nbsp;</td>
                        <td><input type="submit" id="submitbtn" name="submit" value="<?php echo __('Register', 'wpdating'); ?>" /></td>
                    </tr>
        ...
        echo __('Registration is currently disabled.', 'wpdating');
    ?>
