...
if ($intTotalRecordsEffected != '0' && $intTotalRecordsEffected != '') {
    ...
    <div>
        ...
        <table width="100%" border="0" cellspacing="0" cellpadding="0">
            ...
            <tr align="center">
                <td colspan="9"><?php echo __('No record found for your search criteria.', 'wpdating'); ?><br><br><?php if (isset($if_record_not_found)) echo $if_record_not_found; ?></td>
            </tr>
            <tr><td></td></tr>
            <tr><td align="center">
                    <?php
                    if (is_user_logged_in()) {
                        ?>
                        <a href="<?php echo $root_link ?>?pid=5&pagetitle=basic_search"><?php echo __('Start a new Search', 'wpdating'); ?></a></td></tr>
                <?php
            } else {
                ?>
                <a href="<?php echo $root_link ?>?pgurl=guest_search"><?php echo __('Start a new Search', 'wpdating'); ?></a></td></tr>
                <?php
            }
            ?>
        </table>
        ...
        <table width="100%" border="0" cellspacing="0" cellpadding="0" class="search_table">
            <tr>
                ...
                <td style="padding-left:5px;">
                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                        <tr>
                            <td width="30%"><?php echo __('Name', 'wpdating') ?></td>
                        ...
                        <tr>
                            <td ><?php echo __('Age:', 'wpdating'); ?></td>
                            <td><?php echo $s_age ?></td>
                        </tr>
                        <tr>
                            <td valign="top"><?php echo __('Location:', 'wpdating'); ?></td>
                        ...
                        <tr>
                            ...
                            <td >
                                ...
                                <?php } else {
                                    ?>
                                    <a href="<?php echo add_query_arg(array('pgurl' => 'register'), $root_link); ?>" title="Login"><?php echo __('Add to Favorites', 'wpdating'); ?></a>
                                <?php } ?>
                            </td>
                        </tr>
                    </table>
