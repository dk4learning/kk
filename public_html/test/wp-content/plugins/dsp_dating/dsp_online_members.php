...
<div style="margin-bottom: 10px; ">
    <form action="<?php echo $root_link . "online_members" ?>" method="post">
        <div align="center"><?php echo __('Gender:', 'wpdating') ?>
            <select name="gender">
            ...
            <input name="submit" type="submit" value="<?php echo __('Filter', 'wpdating') ?>" />
    </form></div>
</div>
                ...
                <ul>
                            ...
                            <div class="dsp_fav_link_border">
                                ...
                                if (is_user_logged_in()) {  // CHECK MEMBER LOGIN
                                    if ($check_user_profile_exist > 0) {  // check user dating profile exist or not
                                        ?>
                                        <a href="<?php echo $root_link . "add_friend/user_id/" . $user_id . "/frnd_userid/" . $s_user_id . "/"; ?>" title="<?php echo __('Add to Friends', 'wpdating'); ?>" alt="<?php echo __('Add to Friends', 'wpdating'); ?>"/>
                                            <img src="<?php echo $fav_icon_image_path ?>friends.jpg" border="0" /></a>
                                    <?php } else { ?>
                                        <a href="<?php echo $root_link . "edit"; ?>" title="Edit Profile"><img  alt="Edit Profile" src="<?php echo $fav_icon_image_path ?>friends.jpg" border="0" alt="<?php echo __('Add to Friends', 'wpdating'); ?>" /></a> 
                                    <?php } ?>
                                <?php } else { ?>
                                    <a href="<?php echo wp_login_url(get_permalink()); ?>" title="Login"><img alt="Edit Login" src="<?php echo $fav_icon_image_path ?>friends.jpg" border="0" alt="<?php echo __('Add to Friends', 'wpdating'); ?>" /></a>
                                <?php } ?>
                            </div>
                        </li>
                    ...
                    <li>
                        <div class="dsp_fav_link_border">
                            ...
                            if (is_user_logged_in()) {  // CHECK MEMBER LOGIN
                                ?>
                                <a href="<?php echo $root_link . "add_favorites/user_id/" . $user_id . "/fav_userid/" . $s_user_id . "/"; ?>" title="<?php echo __('Add to Favorites', 'wpdating'); ?>"><img src="<?php echo $fav_icon_image_path ?>star.jpg" border="0"  alt="<?php echo __('Add to Favorites', 'wpdating'); ?>"/></a>
                            <?php } else { ?>
                                <a href="<?php echo wp_login_url(get_permalink()); ?>" title="Login"><img src="<?php echo $fav_icon_image_path ?>star.jpg" border="0" alt="<?php echo __('Add to Favorites', 'wpdating'); ?>" /></a>
                            <?php } ?>
                        </div>
                    </li>
                    <li>
                        <div class="dsp_fav_link_border" >
                            ...
                            if (is_user_logged_in()) {  // CHECK MEMBER LOGIN
                                if (isset($check_my_friends_list) && $check_my_friends_list > 0) {
                                    ...
                                    <a href="<?php echo $root_link . "email/compose/frnd_id/" . $s_user_id . "/Act/send_msg/"; ?>" title="<?php echo __('Send Message', 'wpdating'); ?>">
                                        <img src="<?php echo $fav_icon_image_path ?>mail.jpg" border="0" alt="<?php echo __('Send Message', 'wpdating'); ?>" /></a>
                                <?php } else { ?>
                            ...
                            <?php } else { ?>
                                <a href="<?php echo wp_login_url(get_permalink()); ?>" title="Login">  <img src="<?php echo $fav_icon_image_path ?>mail.jpg" border="0"  alt="<?php echo __('Send Message', 'wpdating'); ?>" /></a>
                            <?php } ?>
                        </div>
                    </li>
                                ...
                                if (is_user_logged_in()) {  // CHECK MEMBER LOGIN
                                    if ($check_user_profile_exist > 0) {  // check user dating profile exist or not
                                        ...
                                        <a href='<?php echo $root_link . "view/send_wink_msg/receiver_id/" . $s_user_id . "/"; ?>' title="<?php echo __('Send Wink', 'wpdating'); ?>">
                                            <img src="<?php echo $fav_icon_image_path ?>wink.jpg" border="0" alt="<?php echo __('Send Wink', 'wpdating'); ?>"/></a>
                                    <?php } else { ?>
                                        <a href="<?php echo $root_link . "edit"; ?>" title="Edit Profile"><img alt="Edit Profile" src="<?php echo $fav_icon_image_path ?>wink.jpg" border="0" alt="<?php echo __('Send Wink', 'wpdating'); ?>"/></a>
                                    <?php } ?>
                                <?php } else { ?>
                                    <a href="<?php echo wp_login_url(get_permalink()); ?>" title="Login">  <img alt="Login" src="<?php echo $fav_icon_image_path ?>wink.jpg" border="0" alt="<?php echo __('Send Wink', 'wpdating'); ?>" /></a>
                                <?php } ?>
                            </div>
                        </li>
                    <?php } // END My friends module Activation check condition   ?> 
