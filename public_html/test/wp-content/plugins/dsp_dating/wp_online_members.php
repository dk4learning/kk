...
<div class="select-info dspdp-form-inline"><span class="title dspdp-control-label"><?php echo __('Gender:', 'wpdating'); ?></span>&nbsp;<select id="dsp_online_gender_select" class="dspdp-form-control">
        <option value="All"><?php echo __('All', 'wpdating'); ?></option>
        <?php echo get_gender_list(); ?>
    </select> <input class="button dspdp-btn  dspdp-btn-default" id="dsp_change_gender" type="button" value="<?php echo __('Filter', 'wpdating'); ?>" /></div>
