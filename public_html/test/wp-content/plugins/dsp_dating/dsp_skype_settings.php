...
<div class="box-border">
    <div class="box-pedding">
        <div class="heading-submenu"><strong><?php echo __('Skype', 'wpdating'); ?></strong></div> <span class="dsp-none"></br></br></span>
        <div class="dsp-form-container">
            <form name="frmskypesettings" action="" method="post" class="dspdp-form-horizontal lm-skype">
                <div class="setting-page">
                    <p class="dspdp-form-group dsp-form-group clearfix">
                        <span class="bold-text dspdp-control-label dsp-control-label dspdp-col-sm-3 dsp-sm-3">
                            <?php echo __('Skype Name:', 'wpdating'); ?>
                        </span>
                    ...
                    <p class="dspdp-form-group dsp-form-group clearfix">
                        <span class="bold-text dspdp-control-label dsp-control-label dspdp-col-sm-3 dsp-sm-3">
                            <?php echo __('Skype Setting:', 'wpdating'); ?>
                        </span>
                        <span class="dspdp-col-sm-6 dsp-sm-6">
                            <select class="dspdp-form-control dsp-form-control" name="cmb_skype_setting">
                                <?php
                                    ...
                                    ?>
                                    <option value="Y" selected="selected"><?php echo __( 'Show to Favorites', 'wpdating' ) ?></option>
                                    <option value="N"><?php echo __( 'Show to Everyone', 'wpdating' ); ?></option>
                                <?php } else { ?>
                                    <option value="Y"><?php echo __( 'Show to Favorites', 'wpdating' ) ?></option>
                                    <option value="N"  selected="selected"><?php echo __( 'Show to Everyone', 'wpdating' ); ?></option>
                                <?php } ?>
                            </select>
                        </span>
                    </p>
                    <div class="dspdp-form-group dsp-form-group clearfix">
                        ...
                        <p class="dspdp-col-sm-6 dsp-sm-6">
                            <input type="submit" name="submit" value="<?php echo __( 'Submit', 'wpdating' ) ?>" class="dsp_submit_button dspdp-btn dspdp-btn-default"/>
                        </p>
                    </div>
                </div>
            </form>
