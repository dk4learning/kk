...
if ($check_user_blocked > 0) {
?>
<div style="height:300px; text-align:center; vertical-align:middle; line-height:300px; font-weight:bold;"><?php echo __('Sorry, you have been blocked by this user.', 'wpdating') ?></div>
<?php } else { ?>
													...
													<div class="form-chat">
															...
															<div id="wrapper">
																	...
																	<div>	<form class="submit-chat-form" name="message" action="post" action="post_one.php" >
																					...
																					<span class="dspdp-input-group-btn"> <input class="dspdp-btn dspdp-btn-default" name="submitmsg" type="submit"  id="submitmsg1" value="<?php echo __('Send', 'wpdating'); ?>" /></span></div>
																			</form>
