...
echo __('Profile Questions', 'wpdating');
;
?></h1>
...
<form id="frmEditQuestion" style="padding-top:10px">
    ...
    <ul class="edit-question">
        ...
        <li><span><?php echo __('About Me', 'wpdating') ?></span>
        ...
        <li class="row"><span><?php echo __('My Interests', 'wpdating'); ?></span>
        ...
        <li>
            ...
            <input onclick="editPartnerQuestion('true', '<?php echo __('Fields should not be empty.', 'wpdating'); ?>')" type="button" name="submit1" value="<?php _e(__('Update', 'wpdating')); ?>" />
        </li>
