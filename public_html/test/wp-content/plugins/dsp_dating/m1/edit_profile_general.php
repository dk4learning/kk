...
include_once(WP_DSP_ABSPATH . '/m1/country_st_ct.php');
?>
...
<ul class="edit-profile">
        ...
        <li>
            ...
            <input type="button" name="submit1" onclick="editProfileGeneral('true', '<?php echo __('Fields should not be empty.', 'wpdating'); ?>')" value="<?php _e(__('Update', 'wpdating')); ?>" />
        </li>
