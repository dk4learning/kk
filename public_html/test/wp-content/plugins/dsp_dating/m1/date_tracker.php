...
<div role="banner" class="ui-header ui-bar-a" data-role="header">
    ...
    <h1 aria-level="1" role="heading" class="ui-title"><?php echo __('Date Tracker', 'wpdating'); ?></h1>
                                                ...
                                                <div class="tracker-detail">
                                                    <strong>
                                                        ...
                                                        <input type="hidden" name="page1" value="<?php echo $page; ?>" />
                                                            ...
                                                            <input name="edit" type="button" class="reply-button" onclick="myDate('editSave', '<?php echo __('You forgot to enter Message.', 'wpdating'); ?>', 0, 1)" value="Edit" />
                                                    ...
                                                    <div class="profile-username">
                                                            ...
                                                            if ($check_couples_mode->setting_status == 'Y') {
                                                                ...
                                                                <div class="row-btn-traker">
                                                                    <span>
                                                                        <a class="reply-button" onclick="myDate('edit', 'text', '<?php echo $message->t_message_id ?>', '<?php echo $page ?>');" ><?php echo __('Edit', 'wpdating'); ?></a>
                                                                    </span>
                                                                    <span>
                                                                        <a class="delete-button" onclick="myDate('delUser', '<?php echo __('Are you sure to delete it?', 'wpdating'); ?>', '<?php echo $s_user_id ?>', '<?php echo $page ?>')"><?php echo __('Delete', 'wpdating'); ?></a>
                                                                    </span>
                                                                </div>
                                                            </div>
                                                        </li>
