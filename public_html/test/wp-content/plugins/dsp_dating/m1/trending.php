...
<form id="dsp_div_trending">
 <fieldset>
    <div class="heading-text"><strong><?php echo __('Trending Profiles', 'wpdating'); ?></strong></div>
    <label data-role="fieldcontain" class="select-group">  
        ...
        <div class="mam_reg_lf select-label"><?php echo language_code('DSP_SELECT_CAEGORY'); ?></div>
            <select id="profile_filter" name="profile_filter" onchange="ExtraLoad('div_trending', 'true')">
                <option><?php echo __('Select', 'wpdating') ?></option>
                <option value="all" <?php if (isset($_REQUEST['profile_filter']) && $_REQUEST['profile_filter'] == "all") { ?> selected="selected" <?php } ?> ><?php echo __('All', 'wpdating'); ?></option>
                <option value="Wink" <?php if (isset($_REQUEST['profile_filter']) && $_REQUEST['profile_filter'] == "Wink") { ?> selected="selected" <?php } ?> ><?php echo __('Wink', 'wpdating'); ?></option>    
                <option value="emails" <?php if (isset($_REQUEST['profile_filter']) && $_REQUEST['profile_filter'] == "emails") { ?> selected="selected" <?php } ?> ><?php echo __('Emails', 'wpdating'); ?></option>
                <option value="friend" <?php if (isset($_REQUEST['profile_filter']) && $_REQUEST['profile_filter'] == "friend") { ?> selected="selected" <?php } ?> ><?php echo __('Friend', 'wpdating'); ?></option>
                <option value="favorited" <?php if (isset($_REQUEST['profile_filter']) && $_REQUEST['profile_filter'] == "favorited") { ?> selected="selected" <?php } ?> ><?php echo __('Favorited', 'wpdating'); ?></option>
            </select>
        </div>
    </label>
        ...
        <label data-role="fieldcontain" class="select-group">  
            <div class="clearfix">                                    
                ...
                <select id="gender_filter" name="gender_filter" onchange="ExtraLoad('div_trending', 'true')">
                    <option value="M" <?php if ($gender == 'F') { ?> selected="selected" <?php } ?> ><?php echo __('Male', 'wpdating'); ?></option>
                    <option value="F" <?php if ($gender == 'M') { ?> selected="selected" <?php } ?> ><?php echo __('Female', 'wpdating'); ?></option>
            ...
            <label data-role="fieldcontain" class="select-group">  
                <div class="clearfix">                                    
                    ...
                    <select id="gender_filter" name="gender_filter" onchange="ExtraLoad('div_trending', 'true')">
                        ...
                        <?php if ($check_couples_mode->setting_status == 'Y') {
                            ?> 
                            <option value="C" <?php if ($gender == 'C') { ?> selected="selected" <?php } ?> ><?php echo __('Couples', 'wpdating'); ?></option> <?php }
                            ?>       
                        </select> 
                    </div>
                </label>
