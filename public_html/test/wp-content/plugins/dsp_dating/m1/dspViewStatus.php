...
<div role="banner" class="ui-header ui-bar-a" data-role="header">
   <?php include_once("page_menu.php");?> 
    <h1 aria-level="1" role="heading" class="ui-title">	<?php echo __('Status', 'wpdating'); ?></h1>
...
<div class="ui-content" data-role="content"  role="main">
       ...
       <form  id="frm_status">
                ...
                <fieldset>
                        ...
                        <textarea name="new_status" value="<?php echo $status; ?>" type="text" class="textarea-box-sm" placeholder="<?php echo __('My Status:', 'wpdating'); ?>"/><br>
                        </div>
                        <input type="hidden" name="user_id" value="<?php echo $user_id; ?>" />
                        <input type="hidden" name="update_status" value="Update" />
                         <div class="btn-blue-wrap">
                        <input  name="update_status" type="button"  class="mam_btn btn-blue" onclick="viewStatus(1)" value="<?php echo __('Update', 'wpdating'); ?>" />
                      </div>
                    </fieldset>
                </form>
