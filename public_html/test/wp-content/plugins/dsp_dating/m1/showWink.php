...
<div class="delete-button spacer-bottom-sm" onclick="updateWink(<?php echo $wink_msg_id ?>, '<?php echo __('Are you sure to delete it?', 'wpdating') ?>');" ><?php echo __('Delete', 'wpdating'); ?>
