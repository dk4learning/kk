        ...
        <div class="content-primary">	 
            <ul data-divider-theme="d" data-theme="d" data-inset="true" data-role="listview" >
                <li data-corners="false" data-shadow="false" data-iconshadow="true" data-wrapperels="div" data-icon="arrow-r" data-iconpos="right" data-theme="d" class="text-center ui-btn ui-btn-icon-right ui-li-has-arrow ui-li ui-btn-up-d btn-blue">
                    <strong ><?php echo __('Register', 'wpdating'); ?></strong>
                 </li>
            </ul>
    ...
    <form id="login_form" >
        ...
        <fieldset>
            <div data-role="fieldcontain">
                <input type="text" value="" name="loginUsername" id="loginUsername" placeholder="<?php echo __('Username', 'wpdating'); ?>"/>
            </div>                                  
            <div data-role="fieldcontain">                                      
                <input type="password" value="" name="password" id="password" placeholder="<?php echo __('Password', 'wpdating'); ?>"/> 
            </div>
            <input class="mam_btn" type="button" name="submit" id="submit"  value="<?php echo __('Login', 'wpdating'); ?>">
        </fieldset>
