...
?>
    <div class="line">
        <div <?php if (($profile_pageurl == "basic_search")) { ?>class="dsp_tab1-active"
             <?php } else { ?>class="dsp_tab1" <?php } ?>>
            <a href="<?php echo $root_link . "search/basic_search/"; ?>"><?php echo __('Search', 'wpdating'); ?></a>
        </div>
        <div <?php if (($profile_pageurl == "advance_search")) { ?>class="dsp_tab1-active"
             <?php } else { ?>class="dsp_tab1" <?php } ?>>
            <a href="<?php echo $root_link . "search/advance_search/"; ?>"><?php echo __('Advanced', 'wpdating'); ?></a>
        </div>
        <?php //////////////////////////////////////////Zip Code////////////////////////////////////////////////////////?>
        <?php if ($check_zipcode_mode->setting_status == 'Y') { ?>
            <div <?php if (($profile_pageurl == "zipcode_search")) { ?>class="dsp_tab1-active"
                 <?php } else { ?>class="dsp_tab1" <?php } ?>>

                <a href="<?php echo $root_link . "search/zipcode_search/"; ?>"><?php echo __('Zip Code', 'wpdating'); ?></a>
            </div>
        <?php } ?>
        <?php /////////////////////////////////////////////////////////////////////////////////////////////////////////////////// ?>
        ...
        <?php if ($check_distance_mode->setting_status == 'Y') { ?>
            <div <?php if (($profile_pageurl == "distance_search")) { ?>class="dsp_tab1-active"
                 <?php } else { ?>class="dsp_tab1" <?php } ?>>

                <a href="<?php echo $root_link . "search/distance_search/"; ?>"><?php echo __('Distance Search', 'wpdating'); ?></a>
            </div>
        <?php } ?>
        <?php /////////////////////////////////////////////////////////////////////////////////////////////////////////////////// ?>
        ...
        <?php if ($check_near_me->setting_status == 'Y') { ?>
            <div <?php if (($profile_pageurl == "near_me")) { ?>class="dsp_tab1-active"
                 <?php } else { ?>class="dsp_tab1" <?php } ?>>

                <a href="<?php echo $root_link . "search/near_me/"; ?>"><?php echo __('Near Me', 'wpdating'); ?></a>
            </div>
        <?php } ?>
        <?php /////////////////////////////////////////////////////////////////////////////////////////////////////////////////// ?>

        <div <?php if (($profile_pageurl == "save_searches")) { ?>class="dsp_tab1-active"
             <?php } else { ?>class="dsp_tab1" <?php } ?>>
            <a href="<?php echo $root_link . "search/save_searches/"; ?>"><?php echo __('Saved Searches', 'wpdating'); ?></a>
        </div>
        <!-- <div <?php if (($profile_pageurl == "search_result")) { ?>class="dsp_tab1-active" <?php } else { ?>class="dsp_tab1" <?php } ?>>
        <a href="<?php echo $root_link . "search/search_result/"; ?>"><?php echo __('Search Result', 'wpdating'); ?></a></div> -->
        <div class="clr"></div>
    </div>
    </div>
...
switch ($profile_pageurl) {
    case ($profile_pageurl == 'new_search'):
        include_once(WP_DSP_ABSPATH . "members/loggedin/search/new_search/new_search.php");
        break;
