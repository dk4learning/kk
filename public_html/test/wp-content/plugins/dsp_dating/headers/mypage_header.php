...
<div class="line dsp-none">
    ...
    <?php if ($check_flirt_module->setting_status == 'Y') { ?>
        <div <?php if (($profile_pageurl == "view_winks")) { ?>class="dsp_tab1-active" <?php } else { ?>class="dsp_tab1" <?php } ?>>
            <?php if ($count_wink_messages > 0) { ?>
                <a href="<?php echo $root_link . "home/view_winks/Act/R/"; ?>" style="color:#FF0000;"><?php echo __('Winks', 'wpdating') ?>&nbsp;(<?php echo $count_wink_messages ?>)</a>
            <?php } else { ?>
                <a href="<?php echo $root_link . "home/view_winks/"; ?>"><?php echo __('Winks', 'wpdating'); ?></a>
            <?php } ?>
        </div>
    <?php } ?>
    <?php // --------------------------------------- END WINKS MENU ----------------------------------------------------// ?>
    ...
    <?php if ($check_my_friend_module->setting_status == 'Y') { ?>
        <div <?php if (($profile_pageurl == "view_friends")) { ?>class="dsp_tab1-active" <?php } else { ?>class="dsp_tab1" <?php } ?>>
            <a href="<?php echo $root_link . "home/view_friends/"; ?>"><?php echo __('Friends', 'wpdating'); ?></a></div>
    <?php } ?>
    <?php // --------------------------------------- END FRIENDS MENU ----------------------------------------------------// ?>
    <?php // --------------------------------------- END MY FAVOURITES MENU ----------------------------------------------// ?>
    <div <?php if (($profile_pageurl == "my_favorites")) { ?>class="dsp_tab1-active" <?php } else { ?>class="dsp_tab1" <?php } ?>>
        <a href="<?php echo $root_link . "home/my_favorites/"; ?>"><?php echo __('Favorites', 'wpdating'); ?></a></div>
    <?php // --------------------------------------- END MY FAVOURITES MENU ------------------------------------------------// ?>
    ...
    <?php if ($check_virtual_gifts_mode->setting_status == 'Y') { ?>
        <div <?php if (($profile_pageurl == "virtual_gifts")) { ?>class="dsp_tab1-active" <?php } else { ?>class="dsp_tab1" <?php } ?>>
            <?php if ($count_friends_virtual_gifts > 0) { ?>
                <a href="<?php echo $root_link . "home/virtual_gifts/"; ?>" style="color:#FF0000;"><?php echo __('Gifts', 'wpdating'); ?>&nbsp;(<?php echo $count_friends_virtual_gifts ?>)</a>
            <?php } else { ?>
                <a href="<?php echo $root_link . "home/virtual_gifts/"; ?>"><?php echo __('Gifts', 'wpdating'); ?></a>
            <?php } ?>
        </div>
    <?php } ?>
    <?php // --------------------------------------- END virtual gifts MENU ------------------------------------------------// ?>
    ...
    <div <?php if (($profile_pageurl == "my_matches")) { ?>class="dsp_tab1-active" <?php } else { ?>class="dsp_tab1" <?php } ?>>
        <a href="<?php echo $root_link . "home/my_matches/"; ?>"><?php echo __('Matches', 'wpdating'); ?></a></div>
    <?php // --------------------------------------- END MY MATCHES MENU ------------------------------------------------// ?>
    <?php // ----- Match Alert Menu ---- ?>
     <?php if ($check_match_alert_mode->setting_status == 'Y') { ?>
       <div <?php if (($profile_pageurl == "match_alert")) { ?>class="dsp_tab1-active" <?php } else { ?>class="dsp_tab1" <?php } ?>>
           <a href="<?php echo $root_link . "home/match_alert/"; ?>"><?php echo __('Match alerts', 'wpdating'); ?></a></div>
   <?php } ?>
   <?php // ----- End Match Alert Menu ---- ?>
    ...
    <div <?php if ($profile_pageurl == "alerts") { ?>class="dsp_tab1-active" <?php } else { ?>class="dsp_tab1" <?php } ?> style="color:#FF0000;">
        <?php if ($count_friends_request > 0) { ?>
            <a href="<?php echo $root_link . "home/alerts/"; ?>" style="color:#FF0000;"><?php echo __('Alerts', 'wpdating'); ?>&nbsp;(<?php echo $count_friends_request ?>)</a>
        <?php } else { ?>
            <a href="<?php echo $root_link . "home/alerts/"; ?>"><?php echo __('Alerts', 'wpdating'); ?></a>
        <?php } ?>
    </div>
    <?php // --------------------------------------- END ALERTS MENU ---------------------------------------------------// ?>
        ...
        <div <?php if (($profile_pageurl == "comments")) { ?>class="dsp_tab1-active" <?php } else { ?>class="dsp_tab1" <?php } ?>>
            <?php if ($check_approve_comments_status->setting_status == 'N') { ?>
                <?php if ($count_friends_comments > 0) { ?>
                    <a href="<?php echo $root_link . "home/comments/"; ?>" style="color:#FF0000;"><?php echo __('Comments', 'wpdating'); ?>&nbsp;(<?php echo $count_friends_comments ?>)</a>
                <?php } else { ?>
                    <a href="<?php echo $root_link . "home/comments/"; ?>"><?php echo __('Comments', 'wpdating'); ?></a>
                <?php } ?>
            <?php } else { ?>
                <a href="<?php echo $root_link . "home/comments/"; ?>"><?php echo __('Comments', 'wpdating'); ?></a>
            <?php } ?></div>
    ...
    <?php /* ?><div <?php if($profile_pageurl=="blocked") { ?>class="dsp_tab1-active" <?php } else { ?>class="dsp_tab1" <?php } ?>>
      <a href="<?php echo add_query_arg (array('pid' =>1,'pagetitle'=>'blocked'), $root_link);?>"><?php echo __('Blocked', 'wpdating');?></a>
      </div><?php */ ?>
    <?php // --------------------------------------- END BLOCKED MENU ---------------------------------------------------// ?>
    <?php // ----------------------------------------- START NEWS MENU ---------------------------------------------------// ?>
    <div <?php if ($profile_pageurl == "news_feed") { ?>class="dsp_tab1-active" <?php } else { ?>class="dsp_tab1 last" <?php } ?>>
        <a href="<?php echo $root_link . "home/news_feed/"; ?>"><?php echo __('News Feed', 'wpdating'); ?></a>
    </div>
    <?php // --------------------------------------- END NEWS MENU ---------------------------------------------------// ?>
    <div class="clr"></div>
</div>
...
//        include_once(WP_DSP_ABSPATH . "members/loggedin/home/news_feed/dsp_user_news_feed.php");
        include_once(WP_DSP_ABSPATH . "members/loggedin/home/newsfeed/dsp_news_feed.php");
        break;
