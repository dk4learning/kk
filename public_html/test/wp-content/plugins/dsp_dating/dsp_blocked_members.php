        ...
        <div class="dsp-row">
            ...
            if ($total_results1 > 0) {
                ...
                <form name="delblockedmembersfrm" action="" method="post">
                    <div class="title-text"><strong><?php echo __('Blocked Members', 'wpdating') ?></strong></div>
                    <?php
                    ...
                    foreach ($blocked_members as $Member) {
                        ...
                        if (($i % 3) == 0) {
                            ?>
                        <?php }  // End if(($i%4)==0) ?>
                        <div class="dsp-sm-3"><div class="image-container">
                            <?php
                            if ($check_couples_mode->setting_status == 'Y') {
                                if ($Member->gender == 'C') {
                                    ?>
                                ...
                                <?php } ?>
                            <?php } ?>
                            <span style="float:left; width:100%;" onclick="delete_blocked_member(<?php echo $blocked_id ?>);" class="dsp_span_pointer"><?php echo __('Unblock', 'wpdating') ?></span> 
                        </div></div>
                        <?php
                        $i++;
                        unset($favt_mem);
