...
<div class="box-border">
    <div class="box-pedding">
        <div class="dsp-row">
            ...
            <div class="dsp-md-9">     
                    <h3 class="heading-feed margin-btm-2"><?php echo __('My Gifts', 'wpdating'); ?></h3>
                    <div class="dspdp-row ">
                    <?php
                                    ...
                                    <div class="show-comment">
                                        ...
                                        <?php if($gifts->status_id == 0): ?>
                                            <span class="dsp-none"><br />
                                                <a class="dspdp-btn-sm dspdp-btn dspdp-btn-success" href="<?php echo $root_link . "home/virtual_gifts/Action/approve/gift_Id/" . $gifts->gift_id; ?>"><?php echo __('Approve', 'wpdating'); ?></a>
                                                <a class="dspdp-btn-sm dspdp-btn dspdp-btn-danger" href="<?php echo $root_link . "home/virtual_gifts/Action/Del/gift_Id/" . $gifts->gift_id; ?>" onclick="if (!confirm('<?php echo __('Are you sure you want to delete this Virtual gift?', 'wpdating'); ?>'))
                                                                return false;"><?php echo __('Delete', 'wpdating'); ?> </a>
                                            </span>

                                             <span class="dsp-block" style="display:none">
                                                <a class="dsp-delete" title="<?php echo __('Delete', 'wpdating'); ?>" href="<?php echo $root_link . "home/virtual_gifts/Action/Del/gift_Id/" . $gifts->gift_id; ?>" onclick="if (!confirm('<?php echo __('Are you sure you want to delete this Virtual gift?', 'wpdating'); ?>'))
                                                                return false;"><i class="fa fa-trash-o"></i></a>
                                                <a class="dsp-success" title="<?php echo __('Accept This Gifts', 'wpdating'); ?>" href="<?php echo $root_link . "home/virtual_gifts/Action/approve/gift_Id/" . $gifts->gift_id; ?>"><i class="fa fa-gift"></i></a>                                           
                                            </span>
                                        <?php else: ?>
                                            <h3><br></h3>
                                        <?php endif; ?>
            ...
            <div class="dsp-md-9">    
                    <h3 class="heading-feed margin-btm-2"><?php echo __('Sent Gifts', 'wpdating'); ?></h3>
                    <div class="dspdp-row ">
                    <?php
