 <?php 
    ...
    if (($request_Action == "approve") && ($frnd_request_Id != "")) {
        ...
        $_SESSION['msg'] = __('You are now friend with this user', 'wpdating');
                ...
                <div class="box-profile-link">                            
                    ...
                    <div class="menus-profile">
                        <ul>
                            ...
                            <li><a href="<?php echo $root_link . "online_members/show/all/"; ?>"><img src="<?php echo $fav_icon_image_path ?>whos_online.jpg" title="<?php echo __('Who\'s Online', 'wpdating') ?>&nbsp;(<?php echo isset($count_online_member) ? $count_online_member : ''; ?>)" alt="<?php echo __('Who\'s Online', 'wpdating') ?>&nbsp;(<?php echo isset($count_online_member) ? $count_online_member : ''; ?>)"/></a></li>
                            <li><a href="<?php echo $root_link . "email/inbox/"; ?>"><img src="<?php echo $fav_icon_image_path ?>message.jpg" title="<?php echo __('New Email', 'wpdating'); ?>&nbsp;(<?php echo $count_inbox_messages ?>)"  alt="<?php echo __('New Email', 'wpdating'); ?>&nbsp;(<?php echo $count_inbox_messages ?>)" border="0"/></a></li>
                        </ul>
                    </div>
                    <div class="clr"></div>
                ...
                <?php
                    ...
                    <div class="dsp-md-9">
                     <h3 class="heading-feed margin-btm-2"><?php echo __('Alerts', 'wpdating') ?></h3>
                        <div class="title-txt dspdp-h5 dsp-spacer-sm"><?php echo __('Pending Friend Requests.', 'wpdating') ?></div>
                                    ...
                                    <div class="image-container">
                                        ...
                                        <div class="dsp-friend-info">
                                          <span style="margin-right: 500px;">
                                            ...
                                            <p><?php echo __('Gender:', 'wpdating').' '.$exist_frnd_name->gender;?></p>
                                            <p><?php echo __('Age:', 'wpdating').' '.GetAge($exist_frnd_name->age);?></p>
                                            <p><?php echo __('About Me', 'wpdating').' : '.stripslashes($exist_frnd_name->about_me);?></p>
                                            </span>
                                        </div>
