            ...
            <div class="box-profile-link">
                <div class="menus-profile">
                    <ul>
                        ...
                        <li><a href="<?php echo $root_link . "extras/i_viewed/"; ?>"><img src="<?php echo $fav_icon_image_path ?>who_iviewed.jpg" title="<?php echo __('Who I Viewed', 'wpdating') ?>" title="<?php echo __('Who I Viewed', 'wpdating') ?>" /></a> </li>
                        <li><a href="<?php echo $root_link . "online_members/show/all/"; ?>"><img src="<?php echo $fav_icon_image_path ?>whos_online.jpg" title="<?php echo __('Who\'s Online', 'wpdating') ?>&nbsp;(<?php echo  isset($count_online_member) ? $count_online_member : ''; ?>)"   alt="<?php echo __('Who\'s Online', 'wpdating') ?>"/></a></li>
        ...
        <div class="dsp-md-9">
            ...
            if ($total_results1 > 0) {
                ...
                <form name="delfavoritesfrm" action="" method="post">
                    ...
                    <h3 class="heading-feed margin-btm-2"><?php echo __('My Favorites', 'wpdating') ?></h3>
    ...
    AND favourites.user_id = '$user_id' AND profile.gender!='C' ORDER BY favourites.fav_date_added");
                        ...
                        <div class="dspdp-col-sm-3 dspdp-col-xs-6 dsp-sm-6"><div class="image-container">
                            <div class="dsp-friend-image-holder">
                                <a href="<?php echo $redirect_location . "Action/Del/favourite_Id/" . $favourite_id; ?>"  onclick="if (!confirm('<?php echo __('Are you sure you want to delete?', 'wpdating'); ?>'))
                                            return false;" class="dspdp-del" >
                                            <span class="delete-icon dsp_span_pointer" title="<?php echo __('Delete', 'wpdating') ?>">&times;</span></a>
                                   <?php
                                   if ($check_couples_mode->setting_status == 'Y') {
                            ...
                            <a href="<?php echo $redirect_location . "Action/Del/favourite_Id/" . $favourite_id; ?>" onclick="if (!confirm('<?php echo __('Are you sure you want to delete?', 'wpdating'); ?>'))
                                            return false;" class="dsp-block dsp-delete" style="display:none" title="<?php echo __('Delete', 'wpdating') ?>"><i class="fa fa-trash-o"></i></a>
