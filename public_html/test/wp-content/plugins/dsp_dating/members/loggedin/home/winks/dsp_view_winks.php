                    ...
                    <form name="del`textfrm" action="" method="post">
                        ...
                        foreach ($my_winks as $winks) {
                            ...
                            <div class="dspdp-col-sm-4 dspdp-wink-sender">
                                ...
                                <li class="last">
                                    <a href="<?php echo $root_link . "home/view_winks/Action/Del/del_wink_id/" . $wink_msg_id; ?>" class="dsp-block dsp-delete" style="display:none" onclick="return confirm('Are you sure you want to remove this wink?')">
