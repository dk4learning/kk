            ...
            <div class="dsp-box-container dsp-form-container dsp-space">
                ...
                <ul class="edit-profile ">
                    ...
                    <li class=" dsp-form-group dspdp-form-group">
                        <span
                                class="dsp-sm-3 dsp-control-label dspdp-col-sm-3 dspdp-control-label"><?php echo __('I am:', 'wpdating') ?></span>
                        <?php
                        $edited = '';
                ...
                <?php endif; ?>
                    ...
                    <li class="dsp-form-group dspdp-form-group">
						<span
                                class="dsp-sm-3 dsp-control-label dspdp-col-sm-3 dspdp-control-label"><?php echo __('Country:', 'wpdating') ?></span>
