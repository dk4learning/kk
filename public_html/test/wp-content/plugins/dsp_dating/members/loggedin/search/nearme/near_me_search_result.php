...
<div class="box-border">
    <div class="box-pedding">
        ...
        if (is_wp_error($usermeta_table)){
            echo "<div class='near-me-message'>You need to set your current location.
            <a href='" .get_site_url() . "/members/edit/'>Click Here</a>
            </div>";
            die();
        }
        ...
        ?>
            <div class="heading-submenu"><strong><?php echo __('Near Me', 'wpdating'); ?></strong></div></br></br>
