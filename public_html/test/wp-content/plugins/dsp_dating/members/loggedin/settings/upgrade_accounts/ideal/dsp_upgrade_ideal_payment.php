...
// 000000 OK betekent succesvol. We kunnen het product leveren
    if (($status = CheckReturnurl($rtlo, get('trxid'))) == "000000 OK") {
        ...
        <?php
        $msg = __('Status was Successful...Thank you for your order.', 'wpdating');
        die($msg);
    }
...
<div class="dsp_search_result_box_in">';
    echo "<form method=\"post\" name=\"idealform\">";
        echo __('Choose your bank:', 'wpdating');
    ?>
...
// De reporturl hoort OK terug te geven aan Targetpay.
        ...
        $msg = __('IP address not correct... This call is not from Targetpay.', 'wpdating');
        die($msg);
    }
}
...
function httpGetRequest($url) {
    ...
    if ($strResponse === false){
        $msg = __('Could not fetch response', 'wpdating');
        die($msg . $url);
    }
    return $strResponse;
}
