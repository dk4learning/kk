                ...
                <div class="setting-page-account">
                    ...
                    <div class="dspdp-form-group ">
                        ...
                        ?>
                            <!-- <div class="dspdp-form-group">
                                <p class="bold-text dspdp-control-label dsp-control-label dspdp-col-sm-4 dsp-sm-4">
                                    <?php echo __('Enable Trending Feature', 'wpdating'); ?>
                                </p>
                                <p class="dspdp-col-sm-6 dsp-sm-6">
                                    <select name="trending_status" class="dspdp-form-control dsp-form-control">
                                        ...
                                        if ($member_privacy_settings->trending_status == 'Y') {
                                            ?>
                                            <option value="Y" selected="selected"><?php echo __('ON', 'wpdating'); ?></option>
                                            <option value="N"><?php echo __('OFF', 'wpdating'); ?></option>
                                        <?php } else { ?>
                                            <option value="Y"><?php echo __('ON', 'wpdating'); ?></option>
                                            <option value="N"  selected="selected"><?php echo __('OFF', 'wpdating'); ?></option>
                                        <?php } ?>
                                    </select>
                                </p>
                            </div> -->
