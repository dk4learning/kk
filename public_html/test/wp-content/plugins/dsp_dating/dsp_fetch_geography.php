...
<div id="display_state">
    <div style="float:left;">
        ...
        <select name="cmbState" id="cmbState" <?php if ($user_id != "") { ?> onChange="Show_city(this.value)" <?php } else { ?> onChange="Show_city2(this.value)" <?php } ?> style="width:190px;">
            ...
            if ($num == 0) {
                ?>	
                <option value="<?php echo $country_id ?>,0" id="<?php echo $country_id ?>" ><?php echo __('Non State', 'wpdating'); ?></option>
            <?php } else {
                ?>	
                <option value="0" id="0" ><?php echo __('Select State', 'wpdating'); ?></option>
            <?php } ?>	
            <?php
