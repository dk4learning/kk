...
add_action( 'wp_enqueue_scripts', 'remove_plugin_stylesheet', 20 );
...
function remove_plugin_stylesheet() {
   ...
   wp_dequeue_style( 'user_section_styles' );

   wp_deregister_style( 'user_section_styles' );

	

	wp_dequeue_style( 'paging' );
