<form name="" method="GET" action="">
    ...
    <div class="box-border">
        <div class="box-pedding">
            <div class="heading-submenu dsp-blog-title"><strong><?php echo __('Blogs', 'wpdating') ?></strong></div>
            <div class="lavish-blog row">
                <div class="dspdb_blog_head">
                    <div style="width:20%; float:left;"><strong><?php echo __('Title', 'wpdating') ?></strong></div>
                    <div style="width:20%; float:left;"><strong><?php echo __('Date', 'wpdating') ?></strong></div>
                    <div style="width:60%; float:left;"><strong><?php echo __('Blog', 'wpdating') ?></strong></div>
                </div>
                ...
                foreach ($blogs_table as $blogs) {
                    ...
                    <div class="dspdb_blog_head">
                        <div style="float:right">
                            ...
                            <span  onclick="delete_blog('<?php echo $blog_id = $blogs->blog_id; ?>');" class="delete-blog dspdp-btn dspdp-btn-danger dspdp-btn-xs  dsp-btn dsp-btn-default dsp-btn-xs"><?php echo __('Delete', 'wpdating'); ?></span></td>
                        </div>
                    </div>
