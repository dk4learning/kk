...
<div class="box-border">
    <div class="box-pedding">
        <div class="box-page dsp-favourite-notification">
            ...
            <div style="text-align:center;"><a href="<?php echo $root_link . get_username($fav_user_id); ?>" class="dspdp-btn dspdp-btn-info"><?php echo __('Back to Profile', 'wpdating') ?></a></div>
        </div>
    </div>
</div>
