            ...
            <div class="slider dspdp-featured">  
                <div class="join-info search_box">
                    ...
                    <div class="join-box  join-searchbox  dspdp-search-box dspdp-col-md-6  dspdp-col-sm-9 dsp-md-6  dsp-sm-9">
                        <div class="heading-bar dspdp-spacer-md"><div class="changebox dspdp-h4 dsp-h4" id="searchbox"><?php echo __('Quick search', 'wpdating'); ?></div>
    						<?php if (!is_user_logged_in()) { ?>
    						<b class="reg_popoup" id="freebox" title=""><?php echo __('Join Free', 'wpdating'); ?></b>
    						<?php } ?>
    					</div>
