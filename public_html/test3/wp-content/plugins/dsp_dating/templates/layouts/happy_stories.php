<div class="story-clm home-box  dspdp-col-sm-4 dspdp-spacer-lg  dsp-sm-4 dsp-spacer-lg">
    <div class="dsp-home-widget" data-aos="fade-up" data-aos-easing="linear" data-aos-delay="1000" data-aos-duration="1000"><div class="dspdp-h4 dspdp-text-uppercase dspdp-spacer-md dsp-h4 dsp-text-uppercase dsp-spacer-md ">
    <span class="heading-text">&nbsp;</span><?php echo __("Happy Stories", "wpdating");?></div>
    <?php
    ...
    if (count($story_result) > 0) {
        ...
        <?php if (is_user_logged_in()) { ?>
            ...
            <a class="read-more dsp-read-more" href="<?php echo $root_link . '/stories'; ?>"><?php echo __('Read More', 'wpdating');?></a>
        <?php } else { ?>

            <a class="read-more dsp-read-more" href="<?php echo get_bloginfo('url'); ?>/<?php echo 'members/stories' ?>"><?php echo __('Read More', 'wpdating');?></a>
