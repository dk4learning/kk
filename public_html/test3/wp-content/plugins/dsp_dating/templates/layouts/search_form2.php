            ...
            <div class="dspdp-form-group dsp-form-group">
                ...
                <div class=" dspdp-col-sm-12">
					<?php /* if (!is_user_logged_in()) { ?>
                            <input class="login-btn  dspdp-btn dspdp-btn-default dspdp-search-submit dsp-btn dsp-btn-default dsp-search-submit" type="button" value="<?php echo strtoupper(__('Login', 'wpdating')); ?>"  />
                    <?php } */ ?>
