<div class="online-members-clm home-box dspdp-col-sm-4 dspdp-spacer-lg dsp-sm-4">
    <div data-aos="fade-up" data-aos-easing="linear" data-aos-duration="1000" data-aos-delay="500">
    <div class="dsp-home-widget">
    <div class="dspdp-h4 dsp-h4 dspdp-text-uppercase dspdp-spacer-md dsp-spacer-md  dsp-text-uppercase">
        <span class="heading-text">&nbsp;</span><?php echo __('Online Members', 'wpdating'); ?>
    </div>
        ...
        ?>
            <div class="dspdp-col-xs-4 dspdp-text-center dspdp-small dspdp-spacer  dsp-clearfix dsp-online-member">
                ...
                <span class="user-details dspdp-block dsp-block dsp-xs-8">
                    ...
                    <span class="color-txt age-text"><?php echo GetAge($member->age) ?> <?php echo __('year old', 'wpdating'); ?></span>
                </span>
            </div>
