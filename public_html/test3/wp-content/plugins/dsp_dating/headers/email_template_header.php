...
<div class="line">
    ...
    <div <?php if (($message_template == "inbox") || ($message_template == "")) { ?>class="dsp_tab1-active" <?php } else { ?>class="dsp_tab1" <?php } ?>>
        <?php if ($count_messages > 0) { ?>
            <a href="<?php echo $root_link . "email/inbox/"; ?>" ><?php echo __('Inbox', 'wpdating'); ?>&nbsp;(<?php echo $count_messages ?>)</a>
        <?php } else { ?>
            <a href="<?php echo $root_link . "email/inbox/"; ?>"><?php echo __('Inbox', 'wpdating'); ?></a>
        <?php } ?>
    </div>
    ...
    <div <?php if ($message_template == "compose") { ?>class="dsp_tab1-active" <?php } else { ?>class="dsp_tab1" <?php } ?>>
        <a href="<?php echo $root_link . "email/compose/"; ?>"><?php echo __('Compose', 'wpdating'); ?></a>
    </div>
    <?php // --------------------------------------- END COMPOSE MENU ----------------------------------------------------// ?>
    <?php // --------------------------------------- START SENT MENU ----------------------------------------------------//  ?>
    <div <?php if ($message_template == "sent") { ?>class="dsp_tab1-active" <?php } else { ?>class="dsp_tab1" <?php } ?>>
        <a href="<?php echo $root_link . "email/sent/"; ?>"><?php echo __('Sent', 'wpdating'); ?></a>
    </div>
    <?php // --------------------------------------- END SENT MENU ----------------------------------------------------// ?>

    <?php // --------------------------------------- START DRAFT MENU ----------------------------------------------------//  ?>
    <div <?php if ($message_template == "draft") { ?>class="dsp_tab1-active" <?php } else { ?>class="dsp_tab1" <?php } ?>>
        <a href="<?php echo $root_link . "email/draft/"; ?>"><?php echo __('Draft','wpdating'); ?></a>
    </div>
    <?php // --------------------------------------- END DRAFT MENU ----------------------------------------------------// ?>

    <?php // --------------------------------------- START DELETED MENU ----------------------------------------------------//  ?>
    <div <?php if ($message_template == "deleted") { ?>class="dsp_tab1-active" <?php } else { ?>class="dsp_tab1" <?php } ?>>
        <a href="<?php echo $root_link . "email/deleted/"; ?>"><?php echo __('Deleted', 'wpdating'); ?></a>
    </div>
...
// *********** Start compose  ********* //
    ...
    if ($message_template == "draft") {
    if(
        ($no_of_credits >= $giftSettingValue && $check_credit_mode->setting_status == 'Y') ||
        $_SESSION['free_member']
    ){ 
         include_once(WP_DSP_ABSPATH . "members/loggedin/email/dsp_draft_messages.php");
    }else{
...
} else if ($message_template == "draft") {
    include_once(WP_DSP_ABSPATH . "members/loggedin/email/dsp_draft_messages.php");
