    ...
    <div class="box-border">
        <div class="box-pedding">
            <form name="frmuseraccount" method="post" action="<?php echo $root_link . "extras/blogs/add_blogs/blog_id/" . $my_blog_table->blog_id . "/mode/edit/action/update/"; ?>" class="dspdp-form-horizontal">
                <div class="heading-submenu"><strong><?php echo __('edit', 'wpdating'); ?></strong></div>
                <ul class="edit-blog">
                    <li class="dspdp-form-group"><span class="dspdp-control-label dsp-control-label dspdp-col-sm-3 dsp-sm-3"><?php echo __('Title', 'wpdating') ?>:</span> <span class="dspdp-col-sm-6 dsp-sm-6 "><input type="text" class="dspdp-form-control dsp-form-control " name="title" value="<?php echo stripslashes($my_blog_table->blog_title); ?>" /></span></li>
                    <li class="dspdp-form-group"><span class="dspdp-control-label dsp-control-label dspdp-col-sm-3 dsp-sm-3"><?php echo __('Blog', 'wpdating') ?>:</span> 
                    ...
                    <li class="dspdp-form-group"><span class="dspdp-control-label dsp-control-label dspdp-col-sm-3 dsp-sm-3"><?php echo __('Tags', 'wpdating') ?>:</span>
    ...
    <div class="box-border dsp-form-container">
        <div class="box-pedding">
            <form name="frmuseraccount" method="post" action="<?php echo $root_link . "extras/blogs/add_blogs/mode/add/"; ?>" class="dspdp-form-horizontal">
                <div class="heading-submenu"><strong><?php echo __('Add Blogs', 'wpdating') ?></strong></div>
                <ul class="edit-blog">
                    ...
                    <li class="dspdp-form-group dsp-form-group clearfix"><span class="dspdp-control-label dsp-control-label dspdp-col-sm-3 dsp-sm-3"><?php echo __('Blog', 'wpdating') ?>:</span> <span class="dspdp-col-sm-9 dsp-sm-6"><textarea name="blog_content" class="dspdp-form-control dsp-form-control " cols="30" rows="10"  ></textarea></span></li>
                    <li class="dspdp-form-group dsp-form-group clearfix"><span class="dspdp-control-label dsp-control-label dspdp-col-sm-3 dsp-sm-3"><?php echo __('Tags', 'wpdating') ?>:</span>
                       <span class="dspdp-col-sm-6 dsp-sm-6  dsp-sm-6 dspdp-xs-form-group dsp-xs-form-group">
                        ...
                        <span class="dspdp-col-sm-3 dsp-sm-3"><input type="submit" name="submit" class="dsp_myblog_submit_button dspdp-btn dspdp-btn-default" value="<?php echo __('Add', 'wpdating') ?>"   /></span>
                    </li>
                </ul>
