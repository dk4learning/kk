...
include_once( WP_DSP_ABSPATH . 'wpdating-search/wpdating-search.php' );
...
include_once( WP_DSP_ABSPATH . 'wpdating-newsfeed/wpdating-newsfeed.php' );
...
include_once 'dsp_sc_home_register.php';
