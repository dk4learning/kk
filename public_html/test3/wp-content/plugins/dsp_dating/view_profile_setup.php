...
$member_blocked_status  = check_blocked_status($session_id, $member_id);
...
// ------------------------------------START BLOCKED MEMBER -------------------------------------//
    ...
    if (($blocked_event == "blocked") && ($user_id != $member_id) && ($user_id != "")) {
        if (!$member_blocked_status) {
            ...
            $wpdb->delete($dsp_blocked_members_table, array(
                  'user_id'         => $user_id,
                  'block_member_id' => $member_id
            ));
            $msg_blocked = __('Member Unblocked.', 'wpdating');
        }
        $member_blocked_status  = check_blocked_status($session_id, $member_id);
    }
    ...
    if ((isset($check_user_privacy_settings->view_my_profile) &&  $check_user_privacy_settings->view_my_profile == 'Y') && ($check_my_friends_list <= 0) && ($user_id != $member_id)) {   // check member is not in my friend list
            ...
            <div class="box-pedding center">
                ...
                <div class=" dspdp-btn dspdp-btn-primary center add_friends">
				   ...
				   title="<?php echo __('Add to Friends', 'wpdating') ?>">
                    <?php echo __('Add to Friends', 'wpdating') ?></a>
                </div>
        ...
        <div class="box-border">
            <div class="box-pedding">
                <div align="center"><?php echo __('You cannot view this profile', 'wpdating'); ?></div>
            </div>
        </div>
        <?php
    } else {
...
// MEMBER TOTAL ADDED PHOTOS
        ...
        <?php if (stristr($goback, 'search')): ?>
            <div class="back">
                <a href="<?php echo $goback; ?>"><?php echo __('Back to search results', 'wpdating'); ?></a>
            </div>
        <?php endif; ?>
            ...
            <div class="box-pedding">
                ...
                if (isset($_POST['btn_report'])) {
                    ...
                    if (isset($_POST['re-report-description']) && ! empty($_POST['re-report-description'])) {
                        ...
                        $message = __('Please enter the reason for report.', 'wpdating');
                        $err_msg = 1;
                    }
                    ...
                    if ($err_msg == 0) {
                        ...
                        if ($insert_report_id) {
                            $message = __('Your report was successfully submitted.', 'wpdating');
                            $admin_email    = get_option('admin_email');
                            ...
                            $message = __('Your report was not submitted.', 'wpdating');
                            $err_msg = 1;
                        }
                    }
                    if ($err_msg == 0) {
                                                ...
                                                if (is_user_logged_in()) {  // CHECK MEMBER LOGIN
                                                    ...
                                                    <?php } else { ?>
                                                        <a href="<?php echo $root_link . "edit"; ?>"
                                                           title="<?php echo __('Add to Friends', 'wpdating') ?>"><span
                                                                    class="fa fa-plus-square"></span></a>
                                                    <?php } ?>
                                                <?php } else { ?>
                                                    <a onClick="javascript:not_loggedin_message();"
                                                       title="<?php echo __('You must be logged in to use this feature.', 'wpdating'); ?>"><span
                                                                class="fa fa-plus-square"></span></a>
                                                <?php } ?>
                                            </div>
                                        </li>
                                        ...
                                        <li>
                                            <div class="fav_icons_border">
                                                <a href="#dsp-popup" class="divinline"
                                                   title="<?php echo __('Send a Gift', 'wpdating'); ?>"><span
                                                ...
                                                <li>
                                                    <div class="fav_icons_border">
                                                                        ...
                                                                        <?php if ($check_free_mode->setting_status == "Y" && $_SESSION['gender']) { ?>
                                                                            <div class="dsp_fav_link_border_user">
                                                                                <a href="skype:<?php echo $skype_name->skype_name ?>"
                                                                                   title="<?php echo __('Send Skype', 'wpdating'); ?>"><span
                                                                                ...
                                                                                if ($check_member_trial_msg == "Expired") {
                                                                                    ...
                                                                                    <div
                                                                                        ...
                                                                                        <a onClick="javascript:expired();"><img
                                                                                                    ...
                                                                                                    title="<?php echo __('Send Skype', 'wpdating'); ?>"
                                                                                                    border="0"
                                                                                                    style="width:16px;"/></a>
                                                                                    </div>
                                                        ...
                                                        <?php } else { ?>
                                                            <div class="dsp_fav_link_border_user">
                                                                <a onClick="javascript:not_loggedin_message();"
                                                                   title="<?php echo __('Login', 'wpdating'); ?>">
																	<span
                                                                            title="<?php echo __('Send Skype', 'wpdating'); ?>"
                                                    ...
                                                    <li>
                                                        <div class="fav_icons_border">
                                                            <a href="<?php echo $root_link . "view/one_on_one_chat/mem_id/" . $member_id . "/action/send_request/"; ?>"
                                                               title="<?php echo __('Send Chat Request', 'wpdating'); ?>"><span
                    ...
                    <div class="profle-detail dsp-profle-detail dsp-sm-8 dsp-md-offset-1">
                                ...
                                if (is_user_logged_in()) {  // CHECK MEMBER LOGIN
                                    ...
                                    <?php if ($check_date_tracker_mode->setting_status == 'Y') { // Check Skype mode Activated or not   ?>
                                        <span
                                                ...
                                                class="dsp_span_pointer  dspdp-btn dspdp-btn-primary dspdp-btn-xs dspdp-sm-block dspdp-spacer-xs"><?php echo __('Date Tracker', 'wpdating'); ?></span>
                                    <?php } ?>

                                    <!-- Start editing -->
                                    <a href="#report_for" id="re_report" class='report_mem'
                                       data-id="<?php echo $member_id ?>" data-title="<?php echo __('Report User', 'wpdating'); ?>">
										<span class="dsp_span_pointer  dspdp-btn dspdp-btn-warning dspdp-btn-xs  dspdp-sm-block dspdp-spacer-xs">

										<?php echo __('Report User', 'wpdating'); ?> </span></a>
                                        ...
                                        <div id='report_for' style='padding:10px; background:#fff;'>
                                            <form action="" method="POST">
                                                ...
                                                <div class="dspdp-form-group">
                                                    <h5><?php echo __('Please write us your reason:', 'wpdating'); ?></h5>
                                    ...
                                    <span onclick="update_blocked_member();"
                                          class="dsp_span_pointer  dspdp-btn dspdp-btn-danger dspdp-btn-xs  dspdp-sm-block dspdp-spacer-xs"><?php echo (!$member_blocked_status ? __('Block User', 'wpdating') : __('Unblock User', 'wpdating')) ; ?></span>
                                    <form name="block_memberfrm" method="post">
                                        <input type="hidden" name="block_event" id="block_event" value=""/>
                                    </form>
                                <?php } } else { ?>
                                    <span><?php /* ?><a href="<?php echo get_site_url(); ?>" title="Login" ><?php echo __('Block member', 'wpdating');?></a><?php */ ?></span>
                                <?php } ?>
                            </div>
                        </div>
                        ...
                        <div class="dspdp-row dspdp-list-sign dsp-content">
                            ...
                            if ($check_astrological_signs_mode->setting_status == 'Y') {
                                ...
                                ?>
                                <div class="zodic-sign dspdp-col-sm-6 dspdp-text-right"><h4>Zodiac</h4><img
                ...
                <div class="other-details margin-btm-3" data-aos="fade-up" data-aos-easing="linear" data-aos-duration="1000">
                    <div class="heading-row dsp-section-title">
                        <div class="heading-profile dspdp-h4">
                            <?php echo $displayed_member_name->display_name ?> <?php echo __('other details', 'wpdating'); ?>
                        </div>
                    </div>
                    <div class="dsp-row">
                        <?php
                    ...
                    if (isset($_POST['add_comment']) && $new_comment != "") {
                        ...
                        if ($insertedId) {
                            $msg_comments = __('The comment has been successful.It will be shown after approval of this user.', 'wpdating');
                            echo "<script>window.onload = displayMessage('" . $msg_comments . "'); </script>";
                        }
                        ...
                        $message         = __('The following user has commented on your profile. Please check the comments', 'wpdating');
                        $message         .= $url;
                ...
                <div class="fullwidth" data-aos="fade-up" data-aos-easing="linear" data-aos-duration="1000">
                    <?php if ($check_comments_mode->setting_status == 'Y') {
                        ...
                        <div class="heading-row">
                            <div
                                    class="heading-profile dspdp-h4 comments"><?php echo __('Comments', 'wpdating') ?></div>
                        </div>
                                    ...
                                    <li>
                                        ...
                                        <?php if ($member_id == $user_id) { ?>
                                            ...
                                            <span id="<?php echo $comments->comments_id; ?>"
                                                  class="comment-delete-icon"><?php echo __('Delete', 'wpdating'); ?></span>
                                        <?php }
                                        ...
                                        <p>
                                            <a class='inline_report_comment'
                                               ...
                                               data-title="<?php echo __('Report this comment', 'wpdating'); ?>"
                                               href="#inline_content"><span
                                                        class="dspdp-label dspdp-label-danger"><?php echo __('Report', 'wpdating'); ?></span></a>
                                        </p>
                        ...
                        <div class="add-comment dspdp-spacer-lg">
                            <span><?php echo __('Add comment', 'wpdating') ?>:</span>
                            <?php
                            if (is_user_logged_in()) {
                                            ...
                                            <form method="post" class="dspdp-form">
                                                <input name="new_comment" class="dspdp-form-control dspdp-spacer"
                                                       maxlength="100" type="text"/> <input
                                                        ...
                                                        value="<?php echo __('Add', 'wpdating') ?>"
                                                        name="add_comment"
                                                        type="submit"/>
                                            </form>
                                            <?php
                                    ...
                                    if ($_SESSION['free_member']) {
                                        ...
                                        <form method="post">
                                            <input name="new_comment" class="dspdp-form-control dspdp-spacer"
                                                   maxlength="100" type="text"/> <input
                                                    class="btn-add dspdp-btn dspdp-btn-default"
                                                    value="<?php echo __('Add', 'wpdating') ?>" name="add_comment"
                                                    type="submit"/>
                                        </form>
                                        <?php
                                    }
                        ...
                        if (isset($_REQUEST['image'])) {
                            ...
                            if ($user_id != $member_id) {
                                ...
                                if ($check_free_mode->setting_status == "Y" || $check_membership_msg == 'Access') {
                                    ...
                                    echo '<script>jQuery(document).ready(function(){ jQuery("#message-box").text("' . __('Sent', 'wpdating') . '"); });</script>';
                                 ...
                                 */
                                    ...
                                    echo '<p>You don\'t have enough credit to send email<br/><a href="' . $root_link . 'setting/upgrade_account/">  ' . __('Click here', 'wpdating') . ' </a>  to buy some credit</p> ';
                                }
                            }
                        }

                        ?>
                        <div class="virtual-gifts" data-aos="fade-up" data-aos-easing="linear" data-aos-duration="1000">
                            <div class="heading-row dsp-section-title">
                                <div
                                        class="heading-profile dspdp-h4"><?php echo __('Virtual Gifts', 'wpdating'); ?></div>
                            </div>
                            <ul class="virtual-gift-list">
                                ...
                                foreach ($user_virtual_gifts as $row_gift) {
                                    ...
                                    ?>
                                    <li><img
                                                title="<?php echo __('Sent by', 'wpdating'); ?> <?php echo $gift_sendername ?>"
                                                src="<?php echo get_bloginfo('url') . "/wp-content/uploads/dsp_media/gifts/" . $row_gift->gift_image; ?>"
                                                style="width:67px; height:67px;"/>
                                        <?php if ($user_id == $member_id) { ?>
                                            <div class="gift_delete"
                                                 id="<?php echo $row_gift->gift_id; ?>"><?php echo __('Delete', 'wpdating') ?></div><?php } ?>
                                    </li>
                                <?php } ?>
                            </ul>
                        </div>
                ...
                <div class="rate-profile margin-btm-3" data-aos="fade-up" data-aos-easing="linear" data-aos-duration="1000">
                    ...
                    if (isset($_POST['submit'])) {
                        ...
                        $_SESSION['msg'] = __('You have rated this user successfully. Thank you !', 'wpdating');
                    ...
                    if ($current_user->ID != '') {
                        if ($check_rate_profile_mode->setting_status == 'Y') {
                            ...
                            if (($check_member_exist > 0)) {
                                ...
                                ?>
                                <div class="title"><strong><?php echo __('Rate Results', 'wpdating') ?></strong>
                                </div>
                                ...
                                if ($mem_id == $user_id) {
                                    ...
                                    <div class="own-profile-rate">
                                        <div class="title-rating">
                                            <strong><?php echo __('Rate Results', 'wpdating') ?></strong></div>
                                        <ul class="rating-box">
                                            <li><?php echo __('You Rated', 'wpdating') ?></li>
                                            <li>
                                                <?php
                                    ...
                                    <form action="" method="post">
                                        <div class="title-rating">
                                            <strong><?php echo __('Rate Profile', 'wpdating') ?></strong>
                                        </div>
                                        <?php
                ...
                <?php if ($member_id == $user_id) { ?>
                    <div align="center"><?php
                        ...
                        if ($chk_profile_created > 0) {
                            echo __('Your profile has not been approved yet. Please wait for 24 hours or write to the admin.', 'wpdating');
                        } else {
                            echo __('No Profile Exists.', 'wpdating');
                        }
                        ?>
                        <?php
