...
class Wpdating_Search_Public
{
    ...
    ?>
                ...
                <div class="row">
                    <div class="col-lg-12 quick_search">
                        <form name="quick_search_form" id="quick_search_form" method="GET">
                            <div class="col-lg-2">
                                <label> <?php echo __('Name', 'wpdating'); ?>:</label>
                        ...
                        <div class="col-lg-2 search_btn">
                            <label>&nbsp;</label>
                            <button onclick="quick_search()"><?php echo __('Search', 'wpdating'); ?></button>
                        </div>
                    </div>
                </div>
        ...
        <div class="row">
            <div class="col-lg-2 advance_search">
                <div>
                    <h4 class="advance_search_title"><?php echo __('Advance search', 'wpdating'); ?></h4>
                </div>
                <div class="dsp-row">
                    <form  name="filter_search_form" id="filter_search_form"  action="" method="GET">
                        ...
                        <div class="add_option">
                            <a role="button" data-toggle="collapse" data-target="#demo">
                                <span class="icon-plus" style="margin-right: 10px;"></span>
                                <?php echo __('More option', 'wpdating'); ?>
                            </a>
                    ...
                    <div class="dsp_filter_btn">
                        <label>&nbsp;</label>
                        <button onclick="search_filter()"><?php echo __('Filter', 'wpdating'); ?></button>
                    </div>
    ...
    function get_results_by_other_criteria($request, $page, $quick = true)
    {
        ...
        if (true == $quick) {
            ...
            if ('Y' == $online_only){
                $sql_query = str_replace("LEFT JOIN ", "INNER JOIN ", $sql_query);
            }
        ...
        if (1 == $page &&  empty($data)){
            return "<h3>" . __('No record found for your search criteria.', 'wpdating') . "</h3>";
        }

        return $this->prepare_items_for_response($data);
    }
