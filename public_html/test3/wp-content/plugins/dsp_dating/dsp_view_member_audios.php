    ...
    if ($check_my_friends_list <= 0) {   // check member is not in my friend list
        ...
        <div class="box-border">
            <div class="box-pedding">
                <div align="center"><?php echo __('You can&rsquo;t view member Audios.', 'wpdating'); ?></div>
                    ...
                    <?php }else{ ?>
                        <ul>
                            <li class="dspdp-col-sm-12 dsp-sm-12 dspdp-col-xs-12 dsp-xs-12">
                                <span class="dsp_span_pointer"><?php echo __('The user has not uploaded any audios.', 'wpdating'); ?></span><br />
                            </li>
                        </ul>
                    <?php } ?>
                </div>
