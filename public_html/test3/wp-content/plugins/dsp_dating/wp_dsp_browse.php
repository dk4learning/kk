...
<div class="dsp-browse-widget-box dspdp-spacer-hg dspdp-plugin">
    <div class="widget-gender-heading widget-heading-box"><?php echo __('By Sex', 'wpdating') ?><span class="heading-arrow"></span></div>
    <?php
...
//	}
    ...
    echo '</ul>';
    ?>
    <div class="widget-age-heading widget-heading-box"><?php echo __('By Age', 'wpdating') ?><span class="heading-arrow"></span></div>
        <?php
