    ...
    <?php } else { ?>
        <form name="composefrm" action="" method="post">
            <table width="100%" border="0" cellspacing="0" cellpadding="3">
                <tr>
                    <td width="2%" ><?php echo __('To', 'wpdating') ?>:</td>
                    <td>
                        <?php
                        if ($get_receiver_id != "") {
                ...
                <?php } ?>
                <tr>
                    <td colspan="2"  ><?php echo __('Subject', 'wpdating') ?>:&nbsp;</td>
                </tr>
                <tr>
                ...
                <?php } ?>
                <tr><td  colspan="2"><?php echo __('Message', 'wpdating') ?>:</td></tr>
                <tr>
                    <td colspan="2">
                        <div >
