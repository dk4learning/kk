...
<div class="dsp_mb_line">
    <div class="dsp_mb_menu" >
        ...
        if (is_user_logged_in()) {  // CHECK MEMBER LOGIN
            ?>
            <a href="<?php echo add_query_arg(array('pid' => 1, 'pagetitle' => 'mypage'), $root_link); ?>" title="<?php echo __('Home', 'wpdating') ?>"><img src="<?php echo $imagepath . 'home.png' ?>"/></a></div>
    <?php } else { ?>
...
<div class="dsp_mb_menu">
    ...
    if (is_user_logged_in()) {  // CHECK MEMBER LOGIN
        ...
        ?>" title="<?php echo __('Messages', 'wpdating') ?>"><img src="<?php echo $imagepath . 'invelop.png' ?>"/></a></div>
    <?php } else { ?>
    <a href="<?php echo add_query_arg(array('pgurl' => 'register'), $root_link); ?>" title="Login"><img src="<?php echo $imagepath . 'peop.png' ?>"/></a></div>
<?php } ?>
<div class="dsp_mb_menu">
...
<div class="dsp_mb_menu">
    ...
    if (is_user_logged_in()) {  // CHECK MEMBER LOGIN
        ?>
        <a href="<?php echo add_query_arg(array('pid' => 5, 'pagetitle' => 'basic_search'), $root_link); ?>" title="<?php echo __('Search', 'wpdating') ?>"><img src="<?php echo $imagepath . 'srch.png' ?>"/></a></div>
<?php } else { ?>
    <a href="<?php echo add_query_arg(array('pgurl' => 'register'), $root_link); ?>" title="Login"><img src="<?php echo $imagepath . 'peop.png' ?>"/></a></div>
<?php } ?>
<?php
