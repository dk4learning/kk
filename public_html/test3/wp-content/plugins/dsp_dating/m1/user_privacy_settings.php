...
<a class="ui-btn-left ui-btn-corner-all ui-icon-back ui-btn-icon-notext ui-shadow"  onclick="viewSetting(0, 'setting')" href="#" >
    ...
    <h1 aria-level="1" role="heading" class="ui-title"><?php echo __('Privacy', 'wpdating'); ?></h1>
...
<div class="ui-content" data-role="content">
    <div class="content-primary">	
                ...
                if (isset($settings_updated) && $settings_updated == true) {
                    ...
                    <div class="thanks success-message">
                       <?php echo __('Settings Updated.', 'wpdating'); ?>
                    </div>
            ...
            <div class="clearfix">                                    
                <div class="mam_reg_lf select-label"><?php echo __('Who can view my pictures', 'wpdating'); ?></div>
                        ...
                        <label data-role="fieldcontain" class="select-group">  
            <div class="clearfix">                                    
                <div class="mam_reg_lf select-label"><?php echo __('Who can view my friends', 'wpdating'); ?></div>
                        ...
                        <label data-role="fieldcontain" class="select-group">  
            <div class="clearfix">                                    
                <div class="mam_reg_lf select-label"><?php echo __('Who can view my Profile', 'wpdating'); ?></div>
 ...
 <label data-role="fieldcontain" class="select-group">  
            <div class="clearfix">                                    
                <div class="mam_reg_lf select-label"><?php echo __('Who can view my Audio', 'wpdating'); ?></div>
                        ...
                        <select name="view_my_audio">
                         ...
                         <label data-role="fieldcontain" class="select-group">  
            <div class="clearfix">                                    
                <div class="mam_reg_lf select-label"><?php echo __('Who can view my Video', 'wpdating'); ?></div>
                       ...
                       <div class="btn-blue-wrap"><input onclick="viewSetting(0, 'post')" type="button" class="mam_btn btn-red" name="submit" value="<?php echo __('Submit', 'wpdating'); ?>" /></div>
                </fieldset>
                </form>
    </div>	
