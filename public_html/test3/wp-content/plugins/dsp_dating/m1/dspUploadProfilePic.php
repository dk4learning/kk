...
//    echo "<pre>"; print_r($_FILES); echo "</pre>"; die;
    ...
    if ($_FILES['ReferenceName']['name']) {
        ...
        $update_img = $wpdb->get_results("select picture from $dsp_members_photos where user_id=$user_id");
        $my_img = mysqli_fetch_array($update_img);
...
//            }
            ...
            $new_name = $user_id . "_" . str_replace('%', '', $img_name) . "." . $extension;
            ...
            if (!$copied) {
                ...
                if ($check_approve_photos_status->setting_status == 'Y') {  // if photo approve status is Y then photos Automatically Approved.
                    ...
                    $msg = __('Uploaded successfully.', 'wpdating');
                    ...
                    $approval_message = __('Uploaded successfully.', 'wpdating');
