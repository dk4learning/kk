                        ...
                        <a href="dsp_edit_profile.html" data-corners="false" data-shadow="false" data-iconshadow="true"
                           ...
                           class="ui-btn ui-btn-inline ui-btn-up-a  <?php if ($edit_profile_pageurl == "") {
                            ...
                            <span class="ui-btn-inner"><span
                                        class="ui-btn-text"><?php echo __('My Profile', 'wpdating'); ?></span></span>
                        </a>
                    </li>
                    <li class="ui-block-b">
                        <a href="dsp_edit_partner_profile.html" data-corners="false" data-shadow="false"
                           ...
                           class="ui-btn ui-btn-inline ui-btn-up-a <?php if ($edit_profile_pageurl == "partner_profile") {
                            ...
                            <span class="ui-btn-inner"><span
                                        class="ui-btn-text"><?php echo __('Partner Profile', 'wpdating'); ?></span></span>
                        </a>
                    </li>
...
// ************************* INSERT PROFILE QUESTION OPTION INFORMATION *****************************//
            ...
            foreach ($question_option_id as $key => $value) {
                if ($value != 0) {
                    ...
                    $wpdb->query("INSERT INTO $dsp_question_details SET user_id = $user_id,profile_question_id = '$key',profile_question_option_id='" . $value . "',option_value='" . str_replace("'","''",$fetch_question_id->option_value) . "'");
                } // End  if($value!=0) {
            ...
            if ($question_option_id1 != "") {
                ...
                foreach ($question_option_id1 as $key => $value) {
                    if ($value != "") {
                        $wpdb->query("INSERT INTO $dsp_question_details SET user_id = $user_id,profile_question_id ='$key' ,profile_question_option_id=0,option_value='" . str_replace("'","''",$value) . "'");
                    } // End if($value!="")
                } // End foreach($question_option_id1 as $key=>$value)
            }
...
if (isset($_GET['msg']) && $_GET['msg'] == 'ed') {
    ...
    <div class="success-message"><?php echo __('Please update Profile Before Add to friend.', 'wpdating') ?></div>
    <?php
}
...
if ($check_approve_profile_status->setting_status == 'Y') {
    if (isset($profile_updated) && $profile_updated == true) {
        ...
        ?>
        <div class="success-message"><?php echo __('Your profile has been updated!', 'wpdating') ?>
        </div>
        <?php
    }
} else {
        ...
        <form id="frmEdit">
            ...
            <div>
                ...
                <div class="btn-blue-wrap">
                    <input type="button" name="submit" class="mam_btn btn-blue"
                           ...
                           onclick="editProfileQuestion('true', '<?php echo __('Fields should not be empty.', 'wpdating'); ?>')"
                           value="<?php _e(__('Update', 'wpdating')); ?>"/>
                </div>
            </div>
            ...
            <div class="btn-blue-wrap">
                <button onclick="getPhoto(); return false;"
                        class="mam_btn btn-blue"><?php echo __('Upload Photo:', 'wpdating') ?></button>
            </div>
