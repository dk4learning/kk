<div role="banner" class="ui-header ui-bar-a" data-role="header">
    ...
    <h1 aria-level="1" role="heading" class="ui-title"><?php echo __('Notification', 'wpdating'); ?></h1>
...
<div class="ui-content" data-role="content">
    <div class="content-primary">	
            ...
            <div class="clearfix">                                    
                <div class="mam_reg_lf select-label"><?php echo __('Private messages', 'wpdating'); ?></div>
                    ...
                    <label data-role="fieldcontain" class="select-group">  
            <div class="clearfix">                                    
                <div class="mam_reg_lf select-label"><?php echo __('Friend requests', 'wpdating'); ?></div>
                        ...
                        <input onclick="viewSetting(0, 'post')" type="button" class="mam_btn btn-red" name="submit" value="<?php echo __('Submit', 'wpdating'); ?>"  /></div>
                    </div>
                    </fieldset>
                </form>
