...
<form id="frmEditQuestion" style="padding-top:10px">
    ...
    <ul class="edit-question">
        ...
        <li class="row"><span><?php echo __('About Me', 'wpdating') ?></span>
        ...
        <li>
            ...
            <input type="button" name="submit1" onclick="editProfileQuestion('true', '<?php echo __('Fields should not be empty.', 'wpdating'); ?>')" value="<?php _e(__('Update', 'wpdating')); ?>" />
        </li>
    </ul>
