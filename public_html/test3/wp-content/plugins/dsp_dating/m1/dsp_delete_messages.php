...
<div role="banner" class="ui-header ui-bar-a" data-role="header">
    ...
    <h1 aria-level="1" role="heading" class="ui-title"><?php echo __('Deleted', 'wpdating'); ?></h1>
...
// ------------------------------------------------End Paging code------------------------------------------------------ // 
     ...
     <img src='images/icons/next-1.png' />
                        ...
                        <li data-corners="false" data-shadow="false" class="ui-body ui-body-d ui-corner-all">
                            ...
                            <div class="checkbox-left"> <input type="checkbox" name="delmessage[]" value="<?php echo $message->sender_id ?>" /></div>
                                    ...
                                    <li>
                                        ...
                                        if ($check_couples_mode->setting_status == 'Y') {
                                            if ($message->gender == 'C') {
                                                ...
                                                <a onclick ="viewProfile('<?php echo $message->sender_id ?>', 'my_profile')" class="user-name">
                ...
                <div >
                    ...
                    <?php if ($my_messages) { ?>
                        <div class="btn-blue-wrap">
                            <input type="button" class="dsp_submit_button mam_btn btn-blue"  name="delmsg" value="<?php echo __('Delete Selected', 'wpdating') ?>" onclick="getDeleted('true', 0);"/></td>
                        </div>

                        <?php
                    } else {
                        echo '<div class="alert-message ">';
                        echo __('Empty', 'wpdating');
                        echo '</div>';
                    }
                    ?>
                </div>
