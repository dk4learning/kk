<div role="banner" class="ui-header ui-bar-a" data-role="header">
    ...
    <h1 aria-level="1" role="heading" class="ui-title"><?php echo __('Add Video', 'wpdating'); ?></h1>
...
if (isset($result) && $result != "") {
 ...
 <div class="ui-content" data-role="content">
    <div class="content-primary">
        ...
        <div class="heading-text text-center"><?php echo __('Add Video:', 'wpdating'); ?> Formats - .3GP, .MP4</div>
    </div>
    ...
    <label data-role="fieldcontain" class="form-group">  
        ...
        <span><input type="hidden" name="txtmode" id="txtmode" value="add"></span>
         <div class="btn-blue-wrap"><button onclick="uploadVideo();" class="mam_btn btn-blue"><?php echo __('Upload', 'wpdating') ?></button></div>
            ...
            <div class="iPhonePlayer" style="display:none;"> 
                ...
                <div class="AndroidPlayer" style="display:none;"> 
                    <a onclick="playMyVideo('<?php echo $video_path ?>')">
                        <img src="<?php echo get_bloginfo('url') ?>/wp-content/plugins/dsp_dating/m1/images/play.jpeg" style="width: 100px;  height: 100px">
                    </a>
                </div>


            </div>
            <span onclick="callVideo('Del', '<?php echo $video_file_id ?>')" style="cursor:pointer;display: block;text-align: center; text-decoration:underline;"><?php echo __('Delete', 'wpdating'); ?></span>
