...
<script>
    ...
    <div class="dsp-page-title">
        <h1><?php echo __('Search Results', 'wpdating'); ?></h1>
    </div>
<?php 
/*
        ...
        <div class="dsp_search_result_box_in">
            <div class="box-page">
                <div class="page-not-found">
                    ...
                    <span><a href="<?php echo $root_link . "guest_search" ?>"><?php echo __('Start a new Search', 'wpdating'); ?></a></span>
                </div>
            </div>
        </div>
    </div>
...
<div style="display:none">
    <div id="alert_dialog">
        <p><?php echo __('You must be logged in to use this feature.', 'wpdating'); ?></p>
    </div>
</div>