...
foreach ($search_members as $member1) {
    ...
    if ($msgcount == 0) {
        ...
        <div class="heading-submenu dsp-block" style="display:none"><?php echo __('Date Tracker', 'wpdating') ?></div>
                                                        ...
                                                        <li class="dsp_page_link"><strong>
                                                                ...
                                                                if ($check_couples_mode->setting_status == 'Y') {
                                                                    if ($s_gender == 'C') {
                                                                        ...
                                                                        <li  style="margin-top:6px; float:left;" class="btn-row"><input name="edit" class="dsp_submit_button dspdp-btn dspdp-btn-default btn-search" type="submit" value="Save" /></li>
                                                                        </ul>
                                                                        </form>
                                                                    <?php } else { ?>
                                                                        <ul class="date-traker">
                                                                            ...
                                                                            <li class="dsp_page_link"><strong>
                                                                                    ...
                                                                                    if ($check_couples_mode->setting_status == 'Y') {
                                                                                        ...
                                                                                        <div class="row-btn-traker">
                                                                                            <span class="dsp-none">
                                                                                                <a href="<?php echo $root_link . "extras/date_tracker/mode/edit/msg/" . $message->t_message_id . "/"; ?>"><?php echo __('edit', 'wpdating');?></a>
                                                                                            </span>
                                                                                            <span class="dsp-none">-</span>
                                                                                            <span>
                                                                                            <span class="dsp-none" onclick="popup_show('popup', 'popup_drag', 'popup_exit', 'screen-center', 0, 0);" style="color:#365490; cursor:pointer"><?php echo __('Delete', 'wpdating');?></span>

                                                                                            <span class="dsp-block" style="display:none">
                                                                                                
                                                                                                <a class="" href="<?php echo $root_link . "extras/date_tracker/mode/edit/msg/" . $message->t_message_id . "/"; ?>"><input type="button" class="btn btn-danger custom-edit-button" value="<?php echo __('Edit', 'wpdating'); ?>"></a>
                                                                                                <span onclick="popup_show('popup', 'popup_drag', 'popup_exit', 'screen-center', 0, 0);"><input type="button" class="btn btn-danger custom-delete-button" value="<?php echo __('Delete', 'wpdating');?>"></span>
                                                                                            </span>
                                                                                                <div class="sample_popup"     id="popup" style="display: none;">
                                                                                                    <div class="menu_form_body">
                                                                                                        <div style=" margin-top:10px; text-align:center;"><?php echo __('Are you sure you want to delete this user from your date tracker?', 'wpdating');?></div>
                                                                                                        <div style="margin-top:15px;">
                                                                                                            <div class="btn-row-date-traker">
                                                                                                                <span><input name="delete" type="button" value="Yes" style="width:85px;"  onclick="location.href = '<?php echo $root_link . "extras/date_tracker/mode/del_user/uid/" . $s_user_id . "/"; ?>';
                                                                                                                        return false;"/></span>
                                                                                                                <span><input name="deletenow" type="button" value="No" style="width:85px;" onclick="location.href = '<?php echo $root_link . "extras/date_tracker/mode/del/uid/" . $message->t_message_id . "/"; ?>';
                                                                                                                        return false;"/></span>
                                                                                                            </div>
                                                                                                        </div>
                                                                                                    </div>
