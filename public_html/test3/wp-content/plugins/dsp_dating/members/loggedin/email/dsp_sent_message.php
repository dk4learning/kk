            ...
            ?>
                <form name="frmdelmessages" action="" method="post"  class="dsp-form">
                    <div class="dsp_back_inbox dspdp-spacer">
                        <a class="dspdp-btn dspdp-btn-xs dspdp-btn-default" href="<?php echo $root_link . "email/inbox/"; ?>"><?php echo __('Back to Inbox', 'wpdating') ?></a>
                    </div>
                    ...
                    <li class="dspdp-clearfix">
                        ...
                        <div class="msg-info">
                            <ul>
                                ...
                                <li><?php echo __('Sent', 'wpdating'). ' : '.$message_date ?></li>
                                <li><?php echo __('Subject', 'wpdating'). ' : '.$message->subject ?></li>
                                <li><?php
                                ...
                                <?php if ($message->sender_id != $user_id) { ?>
                                    ...
                                    <li><a href="<?php echo $root_link . "email/compose/sender_ID/" . $message->sender_id . "/Act/Reply/"; ?>"><?php echo __('Reply', 'wpdating') ?></a></li>
                                <?php } //end if ?>
                            </ul>
                        </div>
                        <div class="read-message">
                            ...
                            if ($read_msg == 'Y') {
                                ...
                                <img src="<?php echo $pluginpath ?>/images/env_read.jpg" title="<?php echo __('Email has been Read', 'wpdating') ?>"  alt="env_read"/>
                            <?php } else { ?>
                                <img src="<?php echo $pluginpath ?>/images/env_unread.jpg" title="<?php echo __('Email is Unread', 'wpdating') ?>" alt="env_unread"/>
                            <?php } ?>
                        </div>
                    </li>
                </ul>
