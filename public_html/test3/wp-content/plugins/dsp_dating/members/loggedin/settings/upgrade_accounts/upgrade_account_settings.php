<div class=" "><div class="box-border"><div class="box-pedding clearfix">
            ...
            <div class="heading-submenu dsp-upgrade-heading">
                <strong>
                    <?php echo __('Upgrade Account', 'wpdating'); ?>
                </strong>
      ...
      <tr>
      <td><?php echo __('Upgrade now and enjoy double limits of regular members for the whole', 'wpdating');?>&nbsp;<?php echo $name?>!</td>
      </tr>
      </table><?php */ ?>
                                                    ...
                                                    if ($gateway->gateway_name == 'paypal' && $gateway->status == 1) {
                                                        ...
                                                        if ($gateway->recurring == 1) {
                                                            ...
                                                            if ($validity_of_membership_days['error'] == false && $already_in_use == false) {
                                                                ...
                                                                <form action="<?php echo $root_link . "setting/paypal_subscription"; ?>"
                                                                    ...
                                                                    <input title="<?php echo __('This is a recurring payment plan. You will be subscribed to this plan until you cancel it from your paypal account.', 'wpdating'); ?>"
                                                        ...
                                                        <div>
                                                            <input name="upgrade" title="Upgrade / Credit Card" type="button"
                                                                   value="<?php echo __('Upgrade / Credit Card', 'wpdating') ?>"
                                                        ...
                                                        <div>
                                                            <input name="upgrade" title="Upgrade / PayPal Pro" type="button"
                                                                   value="<?php echo __('Upgrade / PayPal Pro', 'wpdating') ?>"
                                                            ...
                                                            <div>
                                                                <form action="<?php echo $root_link . "setting/paypal_advance/"; ?>"
                                                                    ...
                                                                    <input class="subscribe  dspdp-btn dspdp-btn-default"
                                                                           ...
                                                                           value="<?php echo __('Upgrade/Paypal Advance', 'wpdating') ?>"/>
                                                                </form>
                                                        ...
                                                        <div>
                                                            <input name="upgrade" title="Upgrade / iDEAL" type="button"
                                                                   value="<?php echo __('Upgrade / iDEAL', 'wpdating') ?>"
                                                        ...
                                                        <div>
                                                            <input name="upgrade" title="Upgrade / Cheque payment" type="button"
                                                                   value="<?php echo __('Upgrade / Cheque payment', 'wpdating') ?>"
                                                    ...
                                                    if ($gateway_row->gateway_name == 'paypal') {
                                                        ...
                                                        if ($gateway_row->recurring == 1) {
                                                            ...
                                                            if ($validity_of_membership_days['error'] == false && $already_in_use == false) {
                                                                ?>
                                                                <form
                                                                    action="<?php echo $root_link . "setting/paypal_subscription"; ?>"
                                                                    method="post">
                                                                    <input type="hidden" name="membership_id"
                                                                           value="<?php echo $membership_id; ?>"/>
                                                                    <input type="hidden" name="id"
                                                                    ...
                                                                    <input
                                                                        title="This is a recurring payment plan. You will be subscribed to this plan until you cancel it from your paypal account."
                                                                        type="image" name="submit"
                                                                        src="https://www.paypalobjects.com/en_US/i/btn/btn_subscribe_LG.gif"
                                                                        alt="PayPal - The safer, easier way to pay online">
                                                                </form>
                                                        ...
                                                        ?>
                                                        <div>
                                                            <input name="upgrade" title="Upgrade / Credit Card"
                                                                   type="button"
                                                                   value="<?php echo __('Upgrade / Credit Card', 'wpdating') ?>"
                                                                   onclick="window.location = '<?php echo $root_link . "setting/auth_settings/item_name/$name/id/" . $membership_id . "/"; ?>'"
                                                        ...
                                                        ?>
                                                        <div>
                                                            <input name="upgrade" title="Upgrade / PayPal Pro"
                                                                   type="button"
                                                                   value="<?php echo __('Upgrade / PayPal Pro', 'wpdating') ?>"
                                                        ...
                                                        if ($recurringPaymentSatatus) {
                                                            ...
                                                            <div>
                                                                <form
                                                                    action="<?php echo $root_link . "setting/paypal_advance/"; ?>"
                                                                    method="post">
                                                                    <input type="hidden" name="item_name" id="item_name"
                                                                           value="<?php echo $name; ?>"/>
                                                                    ...
                                                                    <input
                                                                        class="subscribe  dspdp-btn dspdp-btn-default"
                                                                        name="btn_advance" type="submit"
                                                                        value="<?php echo __('Upgrade/Paypal Advance', 'wpdating') ?>"/>
                                                                </form>
