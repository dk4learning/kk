...
<?php if (isset($settings_updated) && $settings_updated == true) { ?>
    <div class="thanks">
        <p align="center" class="error"><?php echo __('Settings Updated.', 'wpdating'); ?></p>
    </div>
<?php } ?>
<?php //---------------------------------------START NOTIFICATION SETTINGS ------------------------------------//  ?>
    ...
    <div class="box-border">
        <div class="box-pedding">
            <div class="heading-submenu"><strong><?php echo __('Email Notification', 'wpdating'); ?></strong>
            </div>
            <span class="dsp-none"></br></br></span>
            <div class="dsp-form-container">
                <form name="frmpnotificationsettings" action="" method="post"
                      class="dspdp-form-horizontal dsp-form-horizontal">
                    <div class="setting-page-account">
                        <div class="dspdp-form-group dsp-form-group clearfix">
                            <p class="bold-text dspdp-control-label dsp-control-label dspdp-col-sm-3 dsp-sm-3">
                                <?php echo __('Premium membership expiration', 'wpdating'); ?>
                            </p>
                            <p class="dspdp-col-sm-6 dsp-sm-6">
                                <select name="premium_member_expiration" class="dspdp-form-control dsp-form-control">
                                    <?php
                                    if ( $member_notification_settings &&
                                        $member_notification_settings->premium_member_expiration == 'N' ) {
                                        ?>
                                        <option value="Y"><?php echo __('Yes', 'wpdating'); ?></option>
                                        <option value="N"
                                                selected="selected"><?php echo __('No', 'wpdating'); ?></option>
                                    <?php } else { ?>
                                        <option value="Y"
                                                selected="selected"><?php echo __('Yes', 'wpdating'); ?></option>
                        ...
                        <div class="dspdp-form-group dsp-form-group clearfix">
                            <p class="bold-text dspdp-control-label dsp-control-label dspdp-col-sm-3 dsp-sm-3">
                                <?php echo __('Payment Successful', 'wpdating'); ?>
                            </p>
                            <p class="dspdp-col-sm-6 dsp-sm-6">
                                <select name="payment_successful" class="dspdp-form-control dsp-form-control">
                                    <?php
                                    if ($member_notification_settings &&
                                        $member_notification_settings->payment_successful == 'N') {
                                        ?>
                                        <option value="Y"><?php echo __('Yes', 'wpdating'); ?></option>
                                        <option value="N"
                                                selected="selected"><?php echo __('No', 'wpdating'); ?></option>
                        ...
                        <div class="dspdp-form-group dsp-form-group clearfix">
                            <p class="bold-text dspdp-control-label dsp-control-label dspdp-col-sm-3 dsp-sm-3">
                                <?php echo __('Payment Failed', 'wpdating'); ?>
                            </p>
                            <p class="dspdp-col-sm-6 dsp-sm-6">
                                <select name="payment_failed" class="dspdp-form-control dsp-form-control">
                                    <?php
                                    if ($member_notification_settings &&
                                        $member_notification_settings->payment_failed == 'N') {
                                        ?>
                                        <option value="Y"><?php echo __('Yes', 'wpdating'); ?></option>
                                        <option value="N"
                                                selected="selected"><?php echo __('No', 'wpdating'); ?></option>
                        ...
                        <div class="dspdp-form-group dsp-form-group clearfix">
                            <p class="bold-text dspdp-control-label dsp-control-label dspdp-col-sm-3 dsp-sm-3">
                                <?php echo __('Payment Cancelled', 'wpdating'); ?>
                            </p>
                            <p class="dspdp-col-sm-6 dsp-sm-6">
                                <select name="payment_canceled" class="dspdp-form-control dsp-form-control">
                                    <?php
                                    if ($member_notification_settings &&
                                        $member_notification_settings->payment_canceled == 'N') {
                                        ?>
                                        <option value="Y"><?php echo __('Yes', 'wpdating'); ?></option>
                                        <option value="N"
                                                selected="selected"><?php echo __('No', 'wpdating'); ?></option>
                        ...
                        <div class="dspdp-form-group dsp-form-group clearfix">
                            <p class="bold-text dspdp-control-label dsp-control-label dspdp-col-sm-3 dsp-sm-3">
                                <?php echo __('Credit balance low', 'wpdating'); ?>
                            </p>
                            <p class="dspdp-col-sm-6 dsp-sm-6">
                                <select name="credit_balance_low" class="dspdp-form-control dsp-form-control">
                                    <?php
                                    if ($member_notification_settings &&
                                        $member_notification_settings->credit_balance_low == 'N') {
                                        ?>
                                        <option value="Y"><?php echo __('Yes', 'wpdating'); ?></option>
                                        <option value="N"
                                                selected="selected"><?php echo __('No', 'wpdating'); ?></option>
                        ...
                        <div class="dspdp-form-group dsp-form-group clearfix">
                            <p class="bold-text dspdp-control-label dsp-control-label dspdp-col-sm-3 dsp-sm-3">
                                <?php echo __('Credit Purchase', 'wpdating'); ?>
                            </p>
                            <p class="dspdp-col-sm-6 dsp-sm-6">
                                <select name="credit_purchase" class="dspdp-form-control dsp-form-control">
                                    <?php
                                    if ($member_notification_settings &&
                                        $member_notification_settings->credit_purchase == 'N') {
                                        ?>
                                        <option value="Y"><?php echo __('Yes', 'wpdating'); ?></option>
                                        <option value="N"
                                                selected="selected"><?php echo __('No', 'wpdating'); ?></option>
                        ...
                        <?php
                        if ($check_meet_me_mode->setting_status == 'Y') {
                            ?>
                            <div class="dspdp-form-group dsp-form-group clearfix">
                                <p class="bold-text dspdp-control-label dsp-control-label dspdp-col-sm-3 dsp-sm-3">
                                    <?php echo __('Meet me', 'wpdating'); ?>
                                </p>
                                <p class="dspdp-col-sm-6 dsp-sm-6">
                                    <select name="meet_me" class="dspdp-form-control dsp-form-control">
                                        <?php
                                        if ( $member_notification_settings &&
                                            $member_notification_settings->meet_me == 'N' ) {
                                            ?>
                                            <option value="Y"><?php echo __('Yes', 'wpdating'); ?></option>
                                            <option value="N"
                                                    selected="selected"><?php echo __('No', 'wpdating'); ?></option>
                        ...
                        <div class="dspdp-form-group dsp-form-group clearfix">
                            <p class="bold-text dspdp-control-label dsp-control-label dspdp-col-sm-3 dsp-sm-3">
                                <?php echo __('Reset password', 'wpdating'); ?>
                            </p>
                            <p class="dspdp-col-sm-6 dsp-sm-6">
                                <select name="reset_password" class="dspdp-form-control dsp-form-control">
                                    <?php
                                    if ( $member_notification_settings &&
                                        $member_notification_settings->reset_password == 'N' ) {
                                        ?>
                                        <option value="Y"><?php echo __('Yes', 'wpdating'); ?></option>
                                        <option value="N"
                                                selected="selected"><?php echo __('No', 'wpdating'); ?></option>
                        ...
                        if ($check_flirt_module->setting_status == 'Y') {
                            ...
                            <div class="dspdp-form-group dsp-form-group clearfix">
                                <p class="bold-text dspdp-control-label dsp-control-label dspdp-col-sm-3 dsp-sm-3">
                                    <?php echo __('Wink', 'wpdating'); ?>
                                </p>
                                <p class="dspdp-col-sm-6 dsp-sm-6">
                                    <select name="wink" class="dspdp-form-control dsp-form-control">
                                        <?php
                                        if ( $member_notification_settings &&
                                            $member_notification_settings->wink == 'N' ) {
                                            ?>
                                            <option value="Y"><?php echo __('Yes', 'wpdating'); ?></option>
                                            <option value="N"
                                                    selected="selected"><?php echo __('No', 'wpdating'); ?></option>
                        ...
                        <div class="dspdp-form-group dsp-form-group">
                            ...
                            <p class="dspdp-col-sm-6 dsp-sm-6">
                                <input type="submit" name="submit"
                                       ...
                                       class="dsp_submit_button dspdp-btn dspdp-btn-default"/>
                            </p>
                        </div>
                    </div>
                </form>
