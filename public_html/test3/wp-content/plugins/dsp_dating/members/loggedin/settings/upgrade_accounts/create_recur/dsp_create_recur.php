    ...
    if ($result == 0) {
        ...
        if (count($apiDetailsRes) > 0) {
            ...
            if ($PF_USER != "" && $PF_PWD != "") {
                ...
                <?php } else { ?>
                    <div class="dsp_search_result_box_in">
                        <div class="dsp_search_result_box_in">
                            ...
                            <?php echo __('Sorry Your subscription procedure has failed. Please try again!', 'wpdating') . '<br>' . $pfpro['RESPMSG']; ?>
                        </div>
                    </div>	
                <?php
                }
                ...
                <div class="dsp_search_result_box_in">
                    <div class="dsp_search_result_box_in">
                        <?php echo __('Sorry Your subscription procedure has failed. Please try again!', 'wpdating'); ?>
                    </div>
                </div>
                <?php
            }
        ...
        <div class="dsp_search_result_box_out">
            <div class="dsp_search_result_box_in">
                ...
                <?php echo __('Sorry your transaction could not completed successfully. Please try again!', 'wpdating'); ?>
            </div>
        </div>
        <?php
    }
