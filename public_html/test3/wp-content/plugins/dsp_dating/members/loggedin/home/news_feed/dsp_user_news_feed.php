...
<div class="box-border dsp-news-feed-container">
    <div class="box-pedding clearfix">
        <div class="heading-submenu dsp-none"><strong><?php echo __('News Feed', 'wpdating'); ?></strong></div>
        <div class="dsp-row">
            <div class="dsp-md-3">
                <div class="user-friends dsp-user-friends">
                    ...
                    <ul class="friends-list dspdp-nav dspdp-nav-tabs">
                        <li class="all"><a id="update_news_feed_box" href="All"><?php echo __('All', 'wpdating'); ?></a></li>
                        <?php
            ...
            <div class="dsp-md-9">
                <div class="news-box">
                    <h3 class="heading-feed margin-btm-2"><?php echo __('News Feed', 'wpdating'); ?></h3>
