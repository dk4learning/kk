        ...
        <div class="box-pedding  dspdp-row">
            <div class="dsp-row">
                ...
                <div class="dsp-md-9">                    
                        ...
                        <h3 class="heading-feed margin-btm-2"><?php echo __('My Matches', 'wpdating') ?></h3>
                                ...
                                <div style="width:100%; margin-bottom: 10px; text-align:center; float:left; ">
                                    <form action="" method="post"  class="dspdp-form-inline">
                                        <div class="dsp-md-4 dspdp-inline">
                                            <span class="dsp-label"><?php echo __('Gender:', 'wpdating') ?></span>
                                            <span>
                                        ...
                                        <div class="dsp-md-3 dspdp-inline">
                                            <span class="dsp-label"><?php echo __('Age:', 'wpdating') ?></span>&nbsp;
                                            <span>
                                        ...
                                        <div class="dsp-md-3 dspdp-inline">
                                        <span style="margin:0px 5px;" class="dsp-label"><?php echo __('to:', 'wpdating') ?></span>
                                        <span>
...
<?php } else { ?>
    <div class="box-page">
        <div class="page-not-found">
            <strong><?php echo __('No matches found!', 'wpdating'); ?></strong>
        </div>
    </div>
<?php } ?>
