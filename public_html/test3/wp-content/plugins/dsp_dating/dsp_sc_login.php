...
//        <!-- To hold validation results -->
    $output .= "<div class=\"dsp_login_main\">
                <form method=\"post\" action=\"" . get_bloginfo('url') . "/wp-login.php\"  class=\"dspdp-form-horizontal\" >
                    <div class=\"dspdp-form-group\"><div class=\"dsp_login_left dspdp-col-sm-3 dspdp-control-label\">" . __(__('Username: ', 'wpdating')) . "</div>
                    <div class=\"dsp_login_right dspdp-col-sm-6\"><input class=\"dspdp-form-control\" type=\"text\" name=\"log\" value=\"\" size=\"20\" id=\"user_login\" tabindex=\"11\" /></div></div>
                                    ...
                                    <div class=\"dspdp-form-group\"><div class=\"dsp_login_left dspdp-col-sm-3 dspdp-control-label\">" . __(__('Password: ', 'wpdating')) . "</div>
                    ...
                    <div class=\"dspdp-form-group\"><div class=\"dsp_login_right  dspdp-col-sm-offset-3  dspdp-col-sm-6\"><input type=\"checkbox\" name=\"rememberme\" value=\"forever\" checked=\"checked\" id=\"rememberme\" tabindex=\"13\" />" . __(__('Remember Me', 'wpdating')) .
                    "</div></div>
                    ...
                    <div class=\"dsp_login_right   dspdp-col-sm-offset-3  dspdp-col-sm-6\">" . do_action('login_form') .apply_filters('dsp_facebook_login','').
                        "<input type=\"submit\"  class=\"dspdp-btn dspdp-btn-default user-submit\" name=\"user-submit\" value=\"" . __(__('Login', 'wpdating')) . "\" tabindex=\"14\"  style=\"margin-left:10px\"/>
