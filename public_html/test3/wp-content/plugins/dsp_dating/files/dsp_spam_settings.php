...
<table cellpadding="0" cellspacing="0" border="0" width="100%">
    <tr>
        <td>
            <div id="general" class="postbox">
                <h3 class="hndle"><span><?php echo __('Spam Filter', 'wpdating'); ?></span></h3>
                    ...
                    <table cellpadding="6" cellspacing="0" border="0" class="dsp_thumbnails1">
                        ...
                        <tr valign="top">
                            ...
                            <td scope="row" class="form-field form-required"><label
                                    for="spamfilter"><?php _e(__('Spam Filter', 'wpdating')) ?></label></td>
                            ...
                            <td><span class="description"
                                      style="white-space:nowrap;"><?php _e(__('Select ON to activate the Spam Filter', 'wpdating')) ?></span>
                            </td>
    ...
    <tr>
        <td>
            <div id="general" class="postbox">
                <h3 class="hndle"><span><?php echo __('Spam Words', 'wpdating'); ?></span></h3>
                        ...
                        <td class="form-field form-required">
                            ...
                            <form name="frmspamwords" method="post">
                                <table border="0" cellpadding="0" cellspacing="0">
                                    <tr>
                                        <td><?php echo __('Spamword', 'wpdating'); ?></td>
                                        <td colspan="2">
