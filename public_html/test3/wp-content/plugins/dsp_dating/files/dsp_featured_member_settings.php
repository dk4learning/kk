...
<div>
    <div id="general" class="postbox">
        <h3 class="hndle"><span><?php echo __('Search User', 'wpdating'); ?></span></h3>
                            ...
                            ?>" >
                                <table width="100%" border="0"  style="border-bottom:1px solid #EEEEEE; border-top:1px solid #EEEEEE; padding-top:5px; padding-bottom:5px;  margin-bottom:-1px;">
                                    <tr style="line-height: 10px;">
                                        ...
                                        <td width="20%"><input name="days" type="text"  style="width:100%;"  onclick="this.value" placeholder="<?php echo __('Number of Days', 'wpdating'); ?>" /></td>
    ...
    <div>
        <div id="general" class="postbox" >
            <h3 class="hndle"><span><?php echo __('Featured Members', 'wpdating'); ?></span></h3>
            <div style="height:20px;"></div>
                ...
                <div>
                    <div style="height:20px;"></div>                                
                        <table width="100%" style="padding-left:10px;" >
                              <tr>
                                  <th><?php echo __('Order', 'wpdating'); ?></th>
                                  <th><?php echo __('Profile Picture', 'wpdating'); ?></th>
                                  <th><?php echo __('Name', 'wpdating'); ?></th>
                                  <th><?php echo __('Age:', 'wpdating'); ?></th>
                                  <th><?php echo __('Gender:', 'wpdating'); ?></th>
                                  <th><?php echo __('Login ID', 'wpdating'); ?></th>
                                  <th><?php echo __('Move', 'wpdating'); ?> &updownarrow;</th>
                                  <th><?php echo __('Expiration Date', 'wpdating'); ?> &updownarrow;</th>
                                  <th><?php echo __('Remove', 'wpdating'); ?> &updownarrow;</th>
                              </tr>    
                              <?php
