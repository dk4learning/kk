...
<div id="general" class="postbox credit-usage" >
    <h3 class="hndle"><span><?php echo __('Credits Usage', 'wpdating'); ?></span></h3>

    <div class="credit-usage-box">
        <div class="credit-usage-info-box"><div class="credit-usage-row"><div class="credit-usage-left"><?php echo __('Credits Purchased:', 'wpdating'); ?></div>  <div class="credit-usage-right"><span class="credit-purchased"><?php echo $credit_row->credits_purchased; ?></span>   <input type="button" value="<?php echo __('Reset', 'wpdating'); ?>" class="button"/ onclick="reset_credit();"></div></div>
            <div class="credit-usage-row"><div class="credit-usage-left"><?php echo __('Credits Used:', 'wpdating'); ?></div>   <div class="credit-usage-right"><?php echo $credit_row->credit_used; ?></div></div></div>

        <form method="get">
            <input type="hidden" name="page" value="dsp-admin-sub-page1" />
            <input type="hidden" name="pid" value="credits_usage" />
            <div class="credit-usage-username-search-box"> <div class="credit-usage-row"><div class="credit-usage-left"><?php echo __('Username: ', 'wpdating'); ?></div>  <div class="credit-usage-right"><input type="text" name="username" value="<?php if (isset($username)) echo $username; ?>" /> <input type="submit"  class="button" name="user_for_credit" value="<?php echo __('Search', 'wpdating'); ?>"/></div></div></div>
        </form>
