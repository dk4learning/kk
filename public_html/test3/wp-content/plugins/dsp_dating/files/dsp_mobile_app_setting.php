...
if (isset($_POST['btn_submit_logo'])) {
    ...
    if ($image_file) {
        ...
        if (($extension != "jpg") && ($extension != "jpeg") && ($extension != "png") && ($extension != "gif")) {
            ...
            $msg.= __('Image is too large please reduce flag image below ', 'wpdating') . ' ( ' . MAX_SIZE . ' KB ) ' . '<br>';
        } else if ($height > MAX_HEIGHT || $width > MAX_WIDTH) {
            $msg.=__('Maximum ', 'wpdating') . ' ' . MAX_WIDTH . 'X' . MAX_HEIGHT . ' ' . __(' Dimension is required for image.', 'wpdating') . '<br>';
        } else if ($height < HEIGHT || $width < WIDTH) {
            $msg.=__('Minimum ', 'wpdating') . ' ' . WIDTH . 'X' . HEIGHT . ' ' . __(' Dimension is required for image.', 'wpdating') . '<br>';
        } else {
            ...
            if (!$copied) {
                ...
                $update_img = $wpdb->query("select mobile_logo from $dsp_mobile_app_settings where setting_id=1");
                $my_img = $wpdb->query($update_img);
                ...
                $msg = __('Settings Updated.', 'wpdating');
            }
...
<div id="general" class="postbox">
    ...
    <h3 class="hndle"><span><?php echo __('Mobile Dating App Settings', 'wpdating'); ?></span></h3>
    ...
    <div class="dsp_thumbnails1" >
        ...
        <form action="" method="post" enctype="multipart/form-data">
            <table width="100%" border="0" cellpadding="6">
                ...
                <tr>
                    <td width="20%" style="text-align: right;padding-right: 10px;"><?php echo __('Mobile Logo (png)', 'wpdating'); ?>:</td>
        ...
        <form action="" method="post" >
            <table width="100%" border="0" cellpadding="6">
                ...
                <tr>
                    ...
                    <td width="20%"  style="text-align: right;padding-right: 10px;"><?php echo __('About Me Text', 'wpdating'); ?>:</td>
        ...
        <form action="" method="post">
            <table width="100%" border="0" cellpadding="6">
                ...
                <tr>
                    ...
                    <td width="20%"  style="text-align: right;padding-right: 10px;"><?php echo __('Terms Text', 'wpdating'); ?>:</td>
