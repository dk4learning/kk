...
<!--<tr><td ><strong><?php echo __('Members Profiles', 'wpdating') ?></strong></td></tr>-->
    <tr><td>
            <div id="navmenu" align="left">
                <ul>
                    <li <?php if (($profiles_page_url == "not_approve") && ($pageURL == "media_profiles")) { ?>class="dsp_tab1-active" <?php } else { ?> class="dsp_tab1"<?php } ?>>
                        <a href="<?php echo $root_link ?>/wp-admin/admin.php?page=dsp-admin-sub-page2&pid=media_profiles&dsp_page=not_approve"><?php echo __('Pending', 'wpdating') ?></a><span class="dsp_tab1_span">|</span></li>
                    <li <?php if ($profiles_page_url == "approved") { ?>class="dsp_tab1-active" <?php } else { ?> class="dsp_tab1"<?php } ?>>
                        <a href="<?php echo $root_link ?>/wp-admin/admin.php?page=dsp-admin-sub-page2&pid=media_profiles&dsp_page=approved"><?php echo __('Approved', 'wpdating') ?></a><span class="dsp_tab1_span">|</span></li>
                    <li <?php if ($profiles_page_url == "rejected") { ?>class="dsp_tab1-active" <?php } else { ?> class="dsp_tab1"<?php } ?>>
                        <a href="<?php echo $root_link ?>/wp-admin/admin.php?page=dsp-admin-sub-page2&pid=media_profiles&dsp_page=rejected"><?php echo __('Rejected', 'wpdating') ?></a><span class="dsp_tab1_span">|</span></li>

                    <li <?php if ($profiles_page_url == "deleted") { ?>class="dsp_tab1-active" <?php } else { ?> class="dsp_tab1"<?php } ?>>
                        <a href="<?php echo $root_link ?>/wp-admin/admin.php?page=dsp-admin-sub-page2&pid=media_profiles&dsp_page=deleted"><?php echo __('Deleted', 'wpdating') ?></a><span class="dsp_tab1_span">|</span></li>
