...
<div id="general" class="postbox report-all-user-statistics">
    <h3 class="hndle"><span><?php echo __('All User Statistics', 'wpdating') ?></span></h3>
            ...
            <tr>
                <td>
                    <table width="100%" border="0" cellspacing="0" cellpadding="2" style="padding-top:20x" class="user-statistics-first-column-table">
                        <tr>
                            <td style="font-weight:bold;"><?php echo __('Male', 'wpdating');?></td>
                            <td align="left" style="width:20px;color:#6D6D6D; font-weight:bold;"><?php echo $totalUserByGender[0]->count; ?></td>
                        </tr>
                        <tr>
                            <td style="font-weight:bold;"><?php echo __('Female', 'wpdating');?></td>
                        ...
                        <tr>
                        	<td style="font-weight:bold;"><?php echo __('Premium Member', 'wpdating');?></td>
                            <td style="color:#6D6D6D; font-weight:bold;"><?php echo $totalPremiumUsers[0]->total; ?></td>
                            
                        </tr>

                        <tr>
                        	<td style="font-weight:bold;" class="report-users-by-country"><?php echo __('Members By Country', 'wpdating');?></td>
                            <td>
