    ...
    <tr>
        <td>
            <div id="general" class="postbox">
                <h3 class="hndle"><span><?php echo __('Flirt Message', 'wpdating'); ?></span></h3>
                                ...
                                foreach ($myrows as $flirts) {
                                    ...
                                    <tr>
                                        ...
                                        <td class="form-field form-required">
                                            <span onclick="update_flirt_text(<?php echo $Flirt_ID ?>);" class="span_pointer"><?php echo __('edit', 'wpdating'); ?></span>/
                                            <span onclick="delete_flirt_text(<?php echo $Flirt_ID ?>);" class="span_pointer"><?php echo __('Delete', 'wpdating'); ?></span>
                                    </tr>
                                    <?php
                        ...
                        <td class="form-field form-required">
                            ...
                            <FORM  name="frmflirttext" method="post">
                                <table border="0" cellpadding="0" cellspacing="0" width="500px;">
                                    <tr>
                                        <td colspan="3" height="50"><?php echo __('Flirt Text:', 'wpdating'); ?></td>
                                    </tr>
                                    <?php
