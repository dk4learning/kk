...
if ($lastpage > 1) {
    ...
    //next button
    if ($page < $counter - 1)
        $pagination.= "<div><a style='color:#365490' href=\"" . $page_name . "&page1=$next\">".__('Next', 'wpdating')."</a></div>";
    else
        ...
        <div class="dsp_search_result_box_in">
            <div class="box-page">
                <div class="page-not-found">
                    <?php echo __('No record found for your search criteria.', 'wpdating'); ?><br /><br /><?php echo $if_record_not_found ?>
                    <span><a href="<?php echo $root_link ?>?pid=5&pagetitle=zipcode_search"><?php echo __('Start a new Search', 'wpdating'); ?></a></span>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="box-page">
                <ul class="search-result-page">
                    ...
                    <li class="user-detail-box">
                        <ul>
                            <li><span><?php echo __('Age:', 'wpdating'); ?></span> <?php echo $s_age ?></li>
                            <li><span><?php echo __('Gender:', 'wpdating'); ?></span> <?php echo $s_gender; ?></li>
                            <li><span><?php echo __('Seeking:', 'wpdating'); ?></span> <?php echo $s_seeking; ?></li>
                            <li><span><?php echo __('Location:', 'wpdating'); ?></span><?php echo $city_name->name; ?>, <?php echo $state_name->name; ?>, <?php echo $country_name->name; ?></li>
                                        ...
                                        <ul>
                                            ...
                                            <?php if ($check_skype_mode->setting_status == 'Y') { // Check Skype mode Activated or not  ?> 
                                                <li>
                                                            ...
                                                            if ($check_member_skype_status > 0) {
                                                                ...
                                                                if (($check_in_favourites > 0) || ($s_user_id == $user_id)) {
                                                                    ...
                                                                    <div class="dsp_fav_link_border_user">
                                                                        <a href="skype:<?php echo $skype_name->skype_name ?>"><img src="<?php echo $fav_icon_image_path ?>skype_icon.png" border="0" alt="Skype"/></a><a href="skype:<?php echo $skype_name->skype_name ?>"> <?php echo __('Skype Me', 'wpdating'); ?></a></div>
                                                                    <?php
                                                    ...
                                                    <?php } else { ?>
                                                        <div class="dsp_fav_link_border_user">
                                                            <a href="<?php echo wp_login_url(get_permalink()); ?>" title="Login"><img src="<?php echo $fav_icon_image_path ?>skype_icon.png" border="0" alt="Skype" /></a><a href="<?php echo wp_login_url(get_permalink()); ?>" title="Login"> <?php echo __('Skype Me', 'wpdating'); ?></a></div>
                                                    <?php } ?>
                                                </li> 
                                            ...
                                            if ($check_couples_mode->setting_status == 'Y') {
                                                if ($s_gender == 'C') {
                                                    ...
                                                    ?>">
                                                        ...
                                                        <?php echo __('View Profile', 'wpdating'); ?>
                                                                ...
                                                                <?php } else { ?>
                                                                    ...
                                                                    ?>" title="Edit Profile"><img src="<?php echo $fav_icon_image_path ?>friends.jpg" border="0" alt="friends"/></a><a style="text-decoration:underline;" href="<?php
                                                                       echo add_query_arg(array(
                                                                           'pid' => 2,
                                                                           'msg' => 'ed'), $root_link);
                                                                       ?>" title="Edit Profile"><?php echo __('Add to Friends', 'wpdating'); ?></a>  
                                                                       <?php } ?>
                                                                   <?php } else { ?>
                                                                <a href="<?php echo wp_login_url(get_permalink()); ?>" title="Login"><img src="<?php echo $fav_icon_image_path ?>friends.jpg" border="0" alt="friends" /></a><a style="text-decoration:underline;" href="<?php echo wp_login_url(get_permalink()); ?>" title="Login"><?php echo __('Add to Friends', 'wpdating'); ?></a>
                                                            <?php } ?>
                                                        </li>
                                                    ...
                                                    <li class="dsp_fav_link_border">
                                                        ...
                                                        if (is_user_logged_in()) {  // CHECK MEMBER LOGIN
                                                            ...
                                                            echo add_query_arg(array(
                                                                ...
                                                                'fav_userid' => $s_user_id), $root_link);
                                                            ?>" title="<?php echo __('Add to Favorites', 'wpdating'); ?>">
                                                                <?php echo __('Add to Favorites', 'wpdating'); ?></a>
                                                        <?php } else { ?>
                                                            <a href="<?php echo wp_login_url(get_permalink()); ?>" title="Login"><img src="<?php echo $fav_icon_image_path ?>star.jpg" border="0" alt="star"/></a><a style="text-decoration:underline;" href="<?php echo wp_login_url(get_permalink()); ?>" title="Login"><?php echo __('Add to Favorites', 'wpdating'); ?></a>
                                                        <?php } ?>
                                                    </li>
                                                    <li class="dsp_fav_link_border" >
                                                        <?php
                                                        if (is_user_logged_in()) {  // CHECK MEMBER LOGIN
                                                            if ($check_my_friends_list > 0) {
                                                                ...
                                                                echo add_query_arg(array(
                                                                    ...
                                                                    'frnd_id' => $s_user_id,
                                                                    'Act' => 'send_msg'), $root_link);
                                                                ?>" title="<?php echo __('Send Message', 'wpdating'); ?>"> <?php echo __('Send Message', 'wpdating'); ?></a>
                                                                                                                                          <?php } else { ?>
                                                                <a href="<?php
                                                                echo add_query_arg(array(
                                                                    'pid' => 14,
                                                                ...
                                                                ?>" title="<?php echo __('Send Message', 'wpdating'); ?>"> <?php echo __('Send Message', 'wpdating'); ?></a>
                                                                                                                                      ...
                                                                                                                                      <?php } else { ?>
                                                            <a href="<?php echo wp_login_url(get_permalink()); ?>" title="Login">  <img src="<?php echo $fav_icon_image_path ?>mail.jpg" border="0" /></a><a style="text-decoration:underline;" href="<?php echo wp_login_url(get_permalink()); ?>" title="Login"><?php echo __('Send Message', 'wpdating'); ?></a>
                                                        <?php } ?>
                                                    </li>
                                                                ...
                                                                if (is_user_logged_in()) {  // CHECK MEMBER LOGIN
                                                                    if ($check_user_profile_exist > 0) {  // check user dating profile exist or not
                                                                        ...
                                                                        echo add_query_arg(array(
                                                                            ...
                                                                            'pagetitle' => 'send_wink_msg',
                                                                            'receiver_id' => $s_user_id), $root_link);
                                                                        ?>' title="<?php echo __('Send Wink', 'wpdating'); ?>"><?php echo __('Send Wink', 'wpdating'); ?></a>
                                                                                                                                                  <?php } else { ?>
                                                                        <a href="<?php
                                                                        echo add_query_arg(array(
                                                                            'pid' => 2,
                                                                        ...
                                                                        ?>" title="Edit Profile"><img src="<?php echo $fav_icon_image_path ?>wink.jpg" border="0" /></a><a style="text-decoration:underline;" href="<?php
                                                                           echo add_query_arg(array(
                                                                               'pid' => 2,
                                                                               'msg' => 'ed'), $root_link);
                                                                           ?>" title="Edit Profile"> <?php echo __('Send Wink', 'wpdating'); ?></a>
                                                                           <?php } ?>
                                                                       <?php } else { ?>
                                                                    <a href="<?php echo wp_login_url(get_permalink()); ?>" title="Login">  <img src="<?php echo $fav_icon_image_path ?>wink.jpg" border="0" /></a><a style="text-decoration:underline;" href="<?php echo wp_login_url(get_permalink()); ?>" title="Login"> <?php echo __('Send Wink', 'wpdating'); ?></a>
                                                                <?php } ?>
                                                            </div>
                                                        </li>
                                                    <?php } // END My friends module Activation check condition        ?> 
