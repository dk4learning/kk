...
// ------------------------------------START BLOCKED MEMBER -------------------------------------//
    ...
    if (($blocked_event == "blocked") && ($user_id != $member_id) && ($user_id != "")) {
        ...
        if ($check_block_mem_exist <= 0) {
            ...
            $msg_blocked = __('Member Blocked.', 'wpdating');
        } else {
            if ($user_id != "") {
                $msg_blocked = __('Already Exists in your blocked list.', 'wpdating');
            }
        }
    }
        ...
        if ($check_my_friends_list <= 0) {   // check member is not in my friend list
            ...
            <div class="box-border">
                <div class="box-pedding">
                    <div align="center"><?php echo __('You are not a friend of this member so you can&rsquo;t view this members profile.', 'wpdating'); ?></div>
                </div>
            </div>
            <?php
            ...
            <div class="box-border">
                <div class="box-pedding  dspdp-clearfix dspdp-spacer-hg">
                        ...
                        <div class="menus-profile">
                            <ul class="box-4  dspdp-clearfix">
                                    ...
                                    <li>  <div class="fav_icons_border">
                                            ...
                                            if (is_user_logged_in()) {  // CHECK MEMBER LOGIN
                                                if ($check_user_profile_exist > 0) {  // check user dating profile exist or not
                                                    ?>
                                                    <a href="<?php echo $root_link . "add_friend/user_id/" . $user_id . "/frnd_userid/" . $member_id . "/"; ?>" title="<?php echo __('Add to Friends', 'wpdating') ?>">
                                                        <span class="fa fa-plus-square"></span></a>
                                                <?php } else { ?>
                                                    <a href="<?php echo $root_link . "edit/"; ?>" title="<?php echo __('Add to Friends', 'wpdating') ?>"><span class="fa fa-plus-square"></span></a>
                                                <?php } ?>
                                            <?php } else { ?>
                                                <a onClick="javascript:not_loggedin_message();" title="<?php echo __('Login', 'wpdating'); ?>"><span class="fa fa-plus-square"></span></a>
                                            <?php } ?>
                                        </div>  </li>
                                ...
                                <li><div class="fav_icons_border">
                                        ...
                                        if (is_user_logged_in()) {  // CHECK MEMBER LOGIN
                                            ?>
                                            <a href="<?php echo $root_link . "add_favorites/user_id/" . $user_id . "/fav_userid/" . $member_id . "/"; ?>" title="<?php echo __('Add to Favorites', 'wpdating'); ?>">
                                ...
                                <li><div class="fav_icons_border">
                                        ...
                                        if (is_user_logged_in()) {  // CHECK MEMBER LOGIN
                                            if ($check_my_friends_list > 0) {
                                                ...
                                                if (!$result) {
                                                    ?> href="javascript:void(0);" onclick="javascript:show_contact_message();" <?php } else { ?> href="<?php echo $root_link . "email/compose/frnd_id/" . $member_id . "/Act/send_msg/"; ?>"  <?php } ?> title="<?php echo __('Send Message', 'wpdating'); ?>">
                                                   <span class="fa fa-envelope-o"></span></a>
                                            <?php } else { ?>
                                                <a <?php
                                                $result = check_contact_permissions($member_id);
                                                if (!$result) {
                                                    ?> href="javascript:void(0);" onclick="javascript:show_contact_message();" <?php } else { ?> href="<?php echo $root_link . "email/compose/receive_id/" . $member_id . "/"; ?>"  <?php } ?> title="<?php echo __('Send Message', 'wpdating'); ?>">
                                                    <span class="fa fa-envelope-o"></span></a>
                                            <?php } //if($check_my_friends_list>0)    ?>
                                        <?php } else { ?>
                                            <script type="text/javascript">
                                            </script>
                                            <a onClick="javascript:not_loggedin_message();" title="<?php echo __('Login', 'wpdating'); ?>"><span class="fa fa-envelope-o"></span></a>
                                        <?php } ?>
                                    </div></li>
                                <?php if ($check_flirt_module->setting_status == 'Y') { // Check FLIRT (WINK) module Activated or not  ?>
                                    <li> <div class="fav_icons_border">
                                            ...
                                            if (is_user_logged_in()) {  // CHECK MEMBER LOGIN
                                                if ($check_user_profile_exist > 0) {  // check user dating profile exist or not
                                                    ?>
                                                    <a href='<?php echo $root_link . "view/send_wink_msg/receiver_id/" . $member_id . "/"; ?>' title="<?php echo __('Send Wink', 'wpdating'); ?>">
                                                        <span class="fa fa-smile-o"></span></a>
                                                <?php } else { ?>
                                                    <a href="<?php echo $root_link . "edit"; ?>" title="Edit Profile"><span class="fa fa-smile-o"></span></a></a>
                                                <?php } ?>
                                            <?php } else { ?>
                                                <a onClick="javascript:not_loggedin_message();" title="<?php echo __('Login', 'wpdating'); ?>"><span class="fa fa-smile-o"></span></a>
                                            <?php } ?>
                                        </div></li>
                                <?php } // END My friends module Activation check condition    ?>
                                <li><div class="fav_icons_border">
                                    ...
                                    if ($check_skype_mode->setting_status == 'Y') { // Check Skype mode Activated or not
                                        if ($check_member_skype_exist > 0) {
                                            ...
                                            <li> <div class="fav_icons_border">
                                                    ...
                                                    <?php } else { ?>
                                                        <div class="dsp_fav_link_border_user">
                                                            <a onClick="javascript:not_loggedin_message();" title="<?php echo __('Login', 'wpdating'); ?>"><span class="fa fa-skype"></span></a></div>
                                                    <?php } ?>
                                                </div> </li>
                                            <?php
                                        }
                                    ...
                                    if (is_user_logged_in()) {
                                        if ($member_id != $user_id) {
                                            ...
                                            if ($check_online_user > 0) {
                                                ?>
                                                <li><div class="fav_icons_border">
                                                        <a href="<?php echo $root_link . "view/one_on_one_chat/mem_id/" . $member_id . "/action/send_request/"; ?>" title="<?php echo __('Send Chat Request', 'wpdating'); ?>"><span class="fa  fa-comment"></span></a>
                                                    </div></li>
                                                <?php
                                            }
                                        }
                                ...
                                <?php if ($check_userplane_instant_messenger_mode->setting_status == 'Y') { // Check Skype mode Activated or not    ?>
                                    ...
                                    if ($check_online_user > 0) {
                                        ...
                                        <script type="text/javascript">
                                            ...
                                            {
                                                alert('<?php echo __('Only premium member can access this feature, Please upgrade your account', 'wpdating'); ?>');
                                            }
                                            function expired()
                                            {
                                                alert('<?php echo __('Your Premimum Account has been expired, Please upgrade your account', 'wpdating'); ?>');
                                            }
                                            function RecipientOnlypremiumaccess()
                                            {
                                                alert('<?php echo __('Recipient member is not a premium member.', 'wpdating'); ?>');
                                            }
                                            function Recipientexpired()
                                            {
                                                alert('<?php echo __('Recipients Premimum Account has been expired.', 'wpdating'); ?>');
                                            }
                                        </script>
                                        <?php if ($check_free_mode->setting_status == "Y" && $_SESSION['free_member']) { ?>
                    ...
                    <div class="profle-detail">
                            ...
                            <div class="linkright-view-profile-page dspdp-pull-right dspdp-spacer-md">
                                ...
                                if (is_user_logged_in()) {  // CHECK MEMBER LOGIN 
                                    ...
                                    <?php if ($check_date_tracker_mode->setting_status == 'Y') { // Check Skype mode Activated or not    ?>
                                        <span onclick="date_tracker('<?php echo $member_id ?>');"  class="dsp_span_pointer dspdp-btn dspdp-btn-primary dspdp-btn-xs dsp-btn"><?php echo __('Date Tracker', 'wpdating'); ?></span>
                                    <?php } ?>
                                    <span onclick="report_member('<?php echo $member_id ?>');"  class="dsp_span_pointer  dspdp-btn dspdp-btn-warining dsp-btn"><?php echo __('Report User', 'wpdating'); ?></span>
                                    <span onclick="update_blocked_member();"  class="dsp_span_pointer  dspdp-btn dspdp-btn-danger  dsp-btn margin-top-1"><?php echo __('Block User', 'wpdating'); ?></span>
                        ...
                        <div class="my-status">
                            <ul>
                                <li class="title"><?php echo __('My Status:', 'wpdating'); ?></li>
                        ...
                        <ul class="profile-user-info dspdp-col-sm-6 dspdp-list dsp-user-detail-info">
                            ...
                            <?php if ($exist_profile_details->state_id != 0) { ?>
                                <li>
                                    <span><?php echo __('State:', 'wpdating'); ?></span>
                                    <?php
                            ...
                            <?php if ($exist_profile_details->city_id != 0) { ?>
                                <li>
                                    <span><?php echo __('City:', 'wpdating'); ?></span>
                                    <?php
                            ...
                            <?php if ($check_zipcode_mode->setting_status == 'Y') { ?>
                                <li>
                                    <span><?php echo __('Zip:', 'wpdating'); ?></span>
                    ...
                    <div class="other-details">
                        <div class="heading-row"><div class="heading-profile"><?php echo $displayed_member_name->display_name ?> <?php echo __('other details', 'wpdating');?></div> </div>
                        <ul>
                            <?php
                            ...
                            <li class="li-fullwidth">
                                <span><?php echo __('About Me', 'wpdating'); ?>:</span>
                            ...
                            ?>
                            <li  class="li-fullwidth">
                                <span><?php echo __('My Interests', 'wpdating'); ?>:</span>
                        ...
                        if ($check_astrological_signs_mode->setting_status == 'Y') {
                            ...
                            ?>
                            <div class="zodic-sign"><h4>Zodiac</h4><img title="<?php echo ucfirst(substr($zodiac_sign, 0, strpos($zodiac_sign, '.'))); ?>" src="<?php echo $pluginpath . "images/zodiac-sign/" . $zodiac_sign; ?>" alt="<?php echo $zodiac_sign;?>" /> </div>
                        <?php } ?>
                        <?php
                    ...
                    <div class="fullwidth">
                        <?php if ($check_comments_mode->setting_status == 'Y') { ?>
                            <div class="heading-row dsp-section-title"><div class="heading-profile"><?php echo __('Comments', 'wpdating') ?></div></div>
                            ...
                            <div class="add-comment"><span><?php echo __('Add comment', 'wpdating') ?>:</span>
                                <?php
                                if (is_user_logged_in()) {
                                    if ($check_free_mode->setting_status == "N" ) {  // free mode is off
                                        ...
                                        if ($check_free_trail_mode->setting_status == "N") {
                                            ...
                                            if ($check_membership_msg == "Expired") {
                                                ?>
                                                <p class="error"><?php echo __('Your Premimum Account has been expired.', 'wpdating') ?> <a href="<?php echo $root_link . "setting/upgrade_account/"; ?>" class="error  dspdp-btn dspdp-btn-default" style="text-decoration:underline;"><?php echo __('Upgrade Here.', 'wpdating') ?></a></p>
                                            <?php } else if ($check_membership_msg == "Onlypremiumaccess") { ?>
                                                <p class="error"><?php echo __('You must be a premium member to comment.', 'wpdating') ?> <a href="<?php echo $root_link . "setting/upgrade_account/"; ?>"  class="error  dspdp-btn dspdp-btn-default" style="text-decoration:underline;"><?php echo __('Upgrade Here.', 'wpdating') ?></a></p>
                                            <?php } else if ($check_membership_msg == "Access") {
                                                ?>
                                                <form method="post">
                                                    <input name="new_comment" maxlength="100" type="text" /> <input class="btn-add" value="<?php echo __('Add', 'wpdating') ?>" name="add_comment" type="submit" />
                                                </form>
                                                <?php
                                            }
                                        } else {
                                    ...
                                    ?>
                                    <p class="error"><?php echo __('You must be logged in to comment', 'wpdating'); ?></p>
                                <?php } ?>
                            </div>
                        <?php } ?>
                        <?php
                        if ($check_virtual_gifts_mode->setting_status == 'Y') {
                            ...
                            <div class="virtual-gifts">
                                <div class="heading-row"><div class="heading-profile"><?php echo __('Virtual Gifts', 'wpdating'); ?></div></div>
                                <ul class="virtual-gift-list">
                                    ...
                                    foreach ($user_virtual_gifts as $row_gift) {
                                        ...
                                        ?>
                                        <li><img title="<?php echo __('Sent by', 'wpdating'); ?> <?php echo $gift_sendername ?>" alt="<?php echo $gift_sendername ?>" src="<?php echo get_bloginfo('url') . "/wp-content/uploads/dsp_media/gifts/" . $row_gift->gift_image; ?>" style="width:67px; height:67px;"/></li>
                                    <?php } ?>
                                </ul>
                            </div>
                            <style>
                                                    ...
                                                    <?php } else if ($check_membership_msg == "Access") {
                                                        ...
                                                        if ($check_max_gifts < $check_virtual_gifts_mode->setting_value) {
                                                            ...
                                                            <form method="post">
                                                                ...
                                                                <input type="submit"   class="dspdp-btn dspdp-btn-default" value="<?php echo __('Submit', 'wpdating'); ?>" />
                                                            </form>
                                                        <?php } else { ?>
			...
			<div class="dsp-row dspdp-clearfix dspdp-spacer-hg">
                ...
                if ($Action == 'report') {
                    ...
                    foreach ($report_member_table as $report_member) {
                        ...
                        $message = __('A user has reported the following profile. Please check the profile. ', 'wpdating');
                            ...
                            <li><div class="fav_icons_border">
                                    ...
                                    if (is_user_logged_in()) {  // CHECK MEMBER LOGIN
                                        ...
                                        <a href="<?php echo $root_link . "add_favorites/user_id/" . $user_id . "/fav_userid/" . $member_id . "/"; ?>" title="<?php echo __('Add to Favorites', 'wpdating'); ?>">
                                            <span class="fa fa-heart"></span></a>
                                    <?php } else { ?>
                                        <a onClick="javascript:not_loggedin_message();" title="<?php echo __('Login', 'wpdating'); ?>"><img src="<?php echo $fav_icon_image_path ?>star.jpg" border="0" alt="Star"/></a>
                                    <?php } ?>
                                </div>  </li>
                            <li><div class="fav_icons_border">
                                    <?php
                                ...
                                if (is_user_logged_in()) {
                                    if ($member_id != $user_id) {
                                        ...
                                        if ($check_online_user > 0) {
                                            ?>
                                            <li><div class="fav_icons_border">
                                                    <a href="<?php echo $root_link . "view/one_on_one_chat/mem_id/" . $member_id . "/action/send_request/"; ?>" title="<?php echo __('Send Chat Request', 'wpdating'); ?>"><img src="<?php echo $fav_icon_image_path ?>chat-request.jpg" title="" border="0" /></a>
                                                </div></li>
                                            <?php
                                        }
                                    }
                ...
                <div class="profle-detail dsp-profle-detail dsp-sm-8 dsp-md-offset-1">
                    <div class="heading-row"><div class="heading-profile dspdp-h3 dspdp-box-title dspdp-pull-left"><?php echo $displayed_member_name->display_name ?></div>
                        <div class="linkright-view-profile-page dspdp-pull-right dspdp-spacer-md">
                            ...
                            if (is_user_logged_in()) {  // CHECK MEMBER LOGIN 
                                ?>
                                <?php if ($check_date_tracker_mode->setting_status == 'Y') { // Check Skype mode Activated or not   ?>
                                    <span onclick="date_tracker('<?php echo $member_id ?>');"  class="dsp_span_pointer  dspdp-btn dspdp-btn-primary dspdp-btn-xs dspdp-sm-block dspdp-spacer-xs"><?php echo __('Date Tracker', 'wpdating'); ?></span>
                                <?php } ?>
                                <span onclick="report_member('<?php echo $member_id ?>');"  class="dsp_span_pointer  dspdp-btn dspdp-btn-warning dspdp-btn-xs  dspdp-sm-block dspdp-spacer-xs"><?php echo __('Report User', 'wpdating'); ?></span>
                                <span onclick="update_blocked_member();"  class="dsp_span_pointer  dspdp-btn dspdp-btn-danger dspdp-btn-xs  dspdp-sm-block dspdp-spacer-xs"><?php echo __('Block User', 'wpdating'); ?></span>
                                <form name="block_memberfrm" method="post">
                                    <input type="hidden" name="block_event" id="block_event" value="" />
                                </form>
                            <?php } else { ?>
                                <a href="<?php echo get_site_url(); ?>" title="Login" ><img src="<?php echo $ImagePath; ?>report.png" title="Login" border="0" style="float:right;" alt="Report"/></a>
                                <?php /* ?><a href="<?php echo get_site_url(); ?>" title="Login" ><?php echo __('Block member', 'wpdating');?></a><?php */ ?>
                            <?php } ?>
                        </div></div>
                    ...
                    <div class="dspdp-row dspdp-list-sign"><ul class="profile-user-info dspdp-col-sm-6 dspdp-list dsp-user-detail-info">
                        <li>
                            <span class="dspdp-bold"><?php echo __('I am:', 'wpdating'); ?></span>
                            <?php echo get_gender($exist_profile_details->gender); ?>
                        </li>
                        <li>
                            <span class="dspdp-bold"><?php echo __('Seeking a:', 'wpdating'); ?></span>
                            <?php echo get_gender($exist_profile_details->seeking); ?>
                        </li>
                        <li>
                            <span class="dspdp-bold"><?php echo __('Age:', 'wpdating'); ?></span>
                            <?php echo GetAge($exist_profile_details->age); ?>
                        </li>
                        <?php if ($exist_profile_details->country_id != 0) { ?>
                            <li>
                                <span class="dspdp-bold"><?php echo __('Country:', 'wpdating'); ?></span>
                                <?php
                                $country = $wpdb->get_row("SELECT * FROM $dsp_country_table where country_id=$exist_profile_details->country_id");
                                echo $country->name;
                                ?>
                        ...
                        <?php if ($exist_profile_details->state_id != 0) { ?>
                            <li>
                                <span class="dspdp-bold"><?php echo __('State:', 'wpdating'); ?></span>
                                <?php
                                $state_name = $wpdb->get_row("SELECT * FROM $dsp_state_table where state_id=$exist_profile_details->state_id");
                                echo $state_name->name;
                                ?>
                        ...
                        <?php if ($exist_profile_details->city_id != 0) { ?>
                            <li>
                                <span class="dspdp-bold"><?php echo __('City:', 'wpdating'); ?></span>
                                <?php
                                // echo $exist_profile_details->city;
                                $city_name = $wpdb->get_row("SELECT * FROM $dsp_city_table where city_id=$exist_profile_details->city_id");
                                echo $city_name->name;
                        ...
                        <?php } ?>
                        <?php if ($check_zipcode_mode->setting_status == 'Y') { ?>
                          <?php if ($exist_profile_details->zipcode != 0) { ?>
                            <li>
                                <span class="dspdp-bold"><?php echo __('Zip:', 'wpdating'); ?></span>
                                <?php echo $exist_profile_details->zipcode ?>
                            </li>
                          <?php } ?>
                        <?php } ?>
                    ...
                    if ($current_user->ID != '') {
                        if ($check_rate_profile_mode->setting_status == 'Y') {
                            ...
                            if (($check_member_exist > 0)) {
                                ...
                                ?>
                                <div class="title"><strong><?php echo __('Rate Results', 'wpdating') ?></strong></div>
                                <ul class="rating-box">
                                    <li><?php echo __('You Rated', 'wpdating') ?></li>
                                    <li>
                                        <?php
                                        if ($avg == '') {
                                            for ($j = 1; $j <= 5; $j++) {
                                    ...
                                    <li><?php echo __('Highest Score', 'wpdating') ?></li>
                                    <li>
                                        <?php
                                        if ($max_rate == '') {
                                            for ($j = 1; $j <= 5; $j++) {
                                ...
                                <ul style="border-top:none;" class="rating-box">
                                    <li><?php echo __('Average Score', 'wpdating') ?></li>
                                    <li><?php
                                        if ($avg == '')
                                            echo '0';
                                        else
                                            echo $avgr;
                                        ?></li>
                                    <li><?php echo __('Votes', 'wpdating') ?></li>
...
// if member
                                if ($mem_id == $user_id) {
                                    ...
                                    <form action="" method="post">
                                        <div class="title-rating"><strong><?php echo __('Rate Profile', 'wpdating') ?></strong></div>
                                        <ul class="rating-box">
                        ...
                        if ($check_rate_profile_mode->setting_status == 'Y') {
                            ...
                            <?php } else { ?>
                                ...
                                <ul class="empty-rate"  style="margin-top:10px;">
                                    <li><?php echo __('Rating', 'wpdating') ?></li>
                                    <li>
                                        <?php
                                        for ($j = 1; $j <= 5; $j++) {
                                            ?>	<img src="<?php echo $pluginpath . "images/blankstar.png" ?>" alt="blank star" />  <?php
                                    ...
                                    <li><?php echo __('Average Score', 'wpdating') ?><span><?php
                                            if ($avg == '')
                                                echo '0';
                                            else
                                                echo $avgr;
                                            ?></span></li>
                                    <li><?php echo __('Votes', 'wpdating') ?><span><?php if ($count_user == '') echo '0'; ?></span></li>
                                </ul>
                                <?php
                            }
                        }
    ...
    <div class="dsp_box-out">
        <div class="dsp_box-in">
            <div style="text-align:center;color:#FF0000;" class="box-page">
                <div align="center"><?php echo __('No Profile Exists.', 'wpdating'); ?></div>
            </div>
        </div>
    </div>
    <?php
        ...
        <div class="dsp_box-in">
            <div style="text-align:center;color:#FF0000;" class="box-page">
                <?php if ($member_id == $user_id) { ?>
                    <div align="center"><?php echo __('Your profile has not been approved yet. Please wait for 24 hours or write to the admin.', 'wpdating'); ?><?php echo $profile_deleted ?></div>
                <?php } else { ?>
                    <div align="center"><?php echo __('No Profile Exists.', 'wpdating'); ?></div>
                <?php } ?>
            </div>
                        ...
                        <?php } else if ($check_membership_msg == "Access") {
                            ...
                            if ($check_max_gifts < $check_virtual_gifts_mode->setting_value) {
                                ...
                                <form method="post">
                                    ...
                                    <input type="submit" value="<?php echo __('Submit', 'wpdating'); ?>" />
                                </form>
                            <?php } else { ?>
                                <p class="error"><?php echo __('User has received the maximum number of virtual gifts.', 'wpdating'); ?></p>
                            <?php } ?>
