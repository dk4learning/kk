...
/*
=================================================
This is Slider Settings For Lavish-date Theme
@package lavish-date
=================================================
*/
if (!class_exists('lavish_date_slider')):
    class lavish_date_slider {
            ...
            <div class="row tab_content_gallery">
                ...
                <ul class="socialmedia">
                    ...
                    if (!empty($slider_image_url)) {
                        ...
                        $slider_buttonfloat = $slider_data['bpslider_buttonfloat'];
                        ...
                        for ($i = 0; $i < count($slider_image_url); $i++) { ?>
                            ...
                            <li>
                                ...
                                <div class="banner-admin-right">
                                    ...
                                    <input type="text" name="bpslider_link[]" value="<?php echo __($slider_link[$i]); ?>"
                                           class="bpslider_link"/>
                                    ...
                                    <input type="text" name="bpslider_text[]" value="<?php echo __($slider_text[$i]); ?>"
                                           class="bpslider_text"/>
                                    ...
                                    <label class="banner-admin-right-label">Banner Caption Float</label>

                                    <input type="text" name="bpslider_buttonfloat[]"
                                           value="<?php echo $slider_buttonfloat[$i]; ?>" class="bpslider_buttonfloat"/>
            ...
            if (!empty($slider_image_url)) {
                ...
                for ($i = 0; $i < count($slider_image_url); $i++) {
                    ...
                    if ($slider_buttontext[$i] == "") {
                        echo "<div data-src='{$image_url}'><div class='camera_caption " . $slider_buttonfloat[$i] . " fadeFromBottom'><h3>" . __($slider_link[$i]) . "</h3><p>" . __($slider_text[$i]) . "</p>
				<a href='" . $slider_button[$i] . "'>" . $slider_buttontext[$i] . "</a></div></div>";
                    } else {
                        echo "<div data-src='{$image_url}'><div class='camera_caption " . $slider_buttonfloat[$i] . " fadeFromBottom' id='box'><h3>" . __($slider_link[$i]) . "</h3><p>" . __($slider_text[$i]) . "</p>

				<a class='btn' href='" . $slider_button[$i] . "'>" . __($slider_buttontext[$i]) . "</a></div></div>";
                    }
                }
                echo '</div>';
            }
