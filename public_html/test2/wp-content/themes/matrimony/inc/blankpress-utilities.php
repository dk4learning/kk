...
if (!function_exists('meta_cb')){
	...
	function meta_cb(){
		...
		echo "<meta name='author' content='Digital Product Labs, Inc.'>\n";
...
function blankpress_post_meta() {
	...
	$author = '<li class="post-meta-item"><i class="fa fa-user"></i><span class="icon-text icon-agent"><a href="' . esc_url( $author_url ) . '" rel="author">' . esc_html( $author_name ) . '</a></span></li>';
  ...
  if(!is_page()){
    ...
    $categories = '<li class="post-meta-item"><i class="fa fa-th-large"></i><span class="icon-text icon-category">';
...
function lavish_date_numeric_posts_nav() {
