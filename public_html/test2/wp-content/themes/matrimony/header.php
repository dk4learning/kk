...
if (!empty($userData) && array_key_exists('user_login',$userData) && array_key_exists('user_password',$userData)) {
    ...
    if ($username != '' && $password != '') {
        ...
        if (is_wp_error($user))
            ...
            $error = language_code('DSP_INVALID_USER_EMAIL_TEXT');
        ...
        $error = language_code('DSP_PLEASE_ENTER_USER_NAME').' '.language_code('DSP_ENTER_PASSWORD');
    }
