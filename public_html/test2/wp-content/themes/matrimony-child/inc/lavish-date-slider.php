            ...
            if (!empty($slider_image_url)) {
                ...
                for ($i = 0; $i < count($slider_image_url); $i++) {
                    ...
                    if ($slider_buttontext[$i] == "") {
                        echo "<div data-src='{$image_url}'><div class='camera_caption " . $slider_buttonfloat[$i] . " fadeFromBottom'><h3>" . $slider_link[$i] . "</h3><p>" . $slider_text[$i] . "</p>
				<a href='" . $slider_button[$i] . "'>" . $slider_buttontext[$i] . "</a></div></div>";
                    } else {
                        echo "<div data-src='{$image_url}'><div class='camera_caption " . $slider_buttonfloat[$i] . " fadeFromBottom' id='box'><h3>" . $slider_link[$i] . "</h3><p>" . $slider_text[$i] . "</p>

				<a class='btn' href='" . $slider_button[$i] . "'>" . $slider_buttontext[$i] . "</a></div></div>";
                    }
                }
                echo '</div>';
            }
