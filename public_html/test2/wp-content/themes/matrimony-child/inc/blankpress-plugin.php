...
/**
 *  This function is used to get facebook login setting
 */
...
/**
 *  This function is used to get facebook login url
 */

if(!function_exists('wpdate_get_login_user_fb')){
    function wpdate_get_login_user_fb(){
        ...
        if ($version < 4841) {
            if (file_exists(WP_PLUGIN_DIR . '/dsp_dating/incl/fb.php')) {
                include_once(WP_PLUGIN_DIR . '/dsp_dating/incl/fb.php');
            }
        } else {
            if (file_exists(WP_PLUGIN_DIR . '/dsp_dating/external-lib/fb/fb.php')) {
                include_once(WP_PLUGIN_DIR . '/dsp_dating/external-lib/fb/fb.php');
            }
        }
...
/**
 *  This function is check for facebook login status
 */

if(!function_exists('wpdate_check_facebook_button_display_status')){
    function dsp_check_facebook_button_display_status(){
        ...
        return ($isFacebookLoginSettingOn && $facebookCredentials) ? true : false;
    }
}

/**
 * This function is used to get default country set  by admin
 */
