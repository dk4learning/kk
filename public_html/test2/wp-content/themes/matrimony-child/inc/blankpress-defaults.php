...
if(! defined('THEME_NAME'))	define('THEME_NAME', 'WP Dating '); // theme name
if(! defined('THEME_SLUG'))	define('THEME_SLUG', 'BP'); // theme name
if(! defined('BP_DOMAIN'))  define('BP_DOMAIN', 'wp-dating'); // theme textdomain
...
if(! defined('WPDATING_DOMAIN'))    define('WPDATING_DOMAIN','WPDATING_DOMAIN'); // inc dir path
