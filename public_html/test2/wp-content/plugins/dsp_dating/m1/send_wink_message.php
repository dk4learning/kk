...
if ($mode == "sent") {
    ...
    if (trim($cmbwinktext) == 0) {
        $message_sent = __('You forgot to select Wink text.', 'wpdating');
    ...
    <div role="banner" class="ui-header ui-bar-a" data-role="header">
     ...
     <h1 aria-level="1" role="heading" class="ui-title"><?php echo __('Send Wink', 'wpdating'); ?></h1>
        ...
        <label class="select-group">  
            ...
            <div data-role="fieldcontain">
                <div class="btn-blue-wrap">
                    <input type="button" id="send_flirt" class="mam_btn btn-blue" name="send_flirt" value="<?php echo __('Send Wink', 'wpdating'); ?>" >
                </div>
            </div>
  </fieldset>
        </form>
