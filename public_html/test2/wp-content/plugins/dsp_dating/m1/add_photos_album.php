<div role="banner" class="ui-header ui-bar-a" data-role="header">
    ...
    <h1 aria-level="1" role="heading" class="ui-title"><?php echo __('Create Album', 'wpdating'); ?></h1>
        ...
        <form name="createalbum" id="frmCreate">
            <fieldset>
                <label data-role="fieldcontain" class="form-group">  
                    <div class="clearfix">                                    
                        <div class="mam_reg_lf form-label"><?php echo __('Add Album:', 'wpdating') ?></div>

                        <input type="text" name="add_album" value="<?php if (isset($dsp_updates)) echo $dsp_updates->album_name; ?>" placeholder="<?php echo __('Album name', 'wpdating') ?>">
                    </div>
                </label>
                ...
                <label data-role="fieldcontain" class="form-group">  
                    <div class="clearfix">                                    
                        <div class="mam_reg_lf form-label">
                            ...
                            <?php echo __('Private:', 'wpdating') ?></div>
                    ...
                    <div class="btn-blue-wrap">
                        <input type="button" name="submit" class="mam_btn btn-blue" value="<?php echo __('Add Album', 'wpdating') ?>" onClick="callPhoto('album', 'post');">  </span>
                    </div>
                </fieldset>
            </form>
            ...
            $i = 0;
            if($exists_album){ ?>
            <div class="heading-text"><strong>My Albums<?php echo __('My Album', 'wpdating'); ?></strong></div>
            <div class="col-row">
                        <?php 
                        foreach ($exists_album as $user_album) {
                            ...
                            <div class="col-2  spacer-bottom-sm">
                                ...
                                <a onclick="callPhoto('manage_photos',<?php echo $album_id; ?>)" >
                                                    ...
                                                    <span class="button-edit spacer-bottom-xs" onClick="callPhoto('edit', '<?php echo $album_id ?>');" ><?php echo __('edit', 'wpdating'); ?></span>     
                                                    <span class="button-delete spacer-bottom-xs spacer-top-xs" onClick="callPhoto('delete', '<?php echo $album_id ?>');"><?php echo __('Delete', 'wpdating'); ?></span>    
