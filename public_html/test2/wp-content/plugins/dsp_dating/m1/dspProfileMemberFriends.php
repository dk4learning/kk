                    ...
                    <li style="float:left;margin-right:16px;width:85px;">
                        ...
                        <div class="">
                            ...
                            <div >
                                ...
                                ?>"> 
                                    <img src="<?php echo display_members_photo($member_friends->friend_uid, $imagepath); ?>" class="dsp_img3"  border="0"  style="width:85px; height:85px;" alt="<?php echo $displayed_member_name; ?>"/></a>
                            </div>
                        ...
                        <div>
                            ...
                            <?php if ($user_id == '') {
                                ...
                                <a onclick="viewMemberProfile('<?php echo $member_friends->friend_uid; ?>', 'my_profile')">
                                    <img src="<?php echo display_members_photo($member_friends->friend_uid, $imagepath); ?>"  border="0"  class="dsp_img3" style="width:85px; height:85px;"  alt="<?php echo $displayed_member_name; ?>" /></a>
                                        ...
                                        if ($member_friends->make_private == 'Y') {
                                            ...
                                            if (!in_array($user_id, $favt_mem)) {
                                                ...
                                                <a onclick="viewMemberProfile('<?php echo $member_friends->friend_uid; ?>', 'my_profile')">				
                                                    ...
                                                    <img src="<?php echo display_members_photo($member_friends->friend_uid, $imagepath); ?>"  border="0"    class="dsp_img3" width="75" height="75" alt="<?php echo $displayed_member_name; ?>" /></a>                
                                            ...
                                            <a onclick="viewMemberProfile('<?php echo $member_friends->friend_uid; ?>', 'my_profile')"> 
                                                ...
                                                <img src="<?php echo display_members_photo($member_friends->friend_uid, $imagepath); ?>"  border="0" class="dsp_img3" style="width:85px; height:85px;" alt="<?php echo $displayed_member_name; ?>" />
                                        ...
                                        if ($member_friends->make_private == 'Y') {
                                            ...
                                            if (!in_array($user_id, $favt_mem)) {
                                                ...
                                                <a onclick="viewMemberProfile('<?php echo $member_friends->friend_uid; ?>', 'my_profile')">				
                                                    ...
                                                    <img src="<?php echo display_members_photo($member_friends->friend_uid, $imagepath); ?>"  border="0"    class="dsp_img3 iviewed-img" alt="<?php echo $displayed_member_name; ?>" />
                                                </a>                
                                    ...
                                    <?php if ($member_friends->make_private == 'Y') { ?>
                                        ...
                                        <?php } else {
                                            ...
                                            <a onclick="viewMemberProfile('<?php echo $member_friends->friend_uid; ?>', 'my_profile')">				
                                                ...
                                                <img src="<?php echo display_members_photo($member_friends->friend_uid, $imagepath); ?>"   border="0"   class="dsp_img3 iviewed-img" alt="<?php echo $displayed_member_name; ?>" /></a>                
                        ...
                        <div >
                            ...
                            <div >
                                <?php if ($user_id == $member_id) { // display delete button only when member view his frnd list 
                                    ?>
                                    <span class="delete-icon dsp_slide_pointer" title="<?php echo __('Delete', 'wpdating'); ?>" onclick="deleteFriends('<?php echo $member_friends->friend_uid; ?>', '<?php echo __('Are you sure you want to Delete the selected Member?', 'wpdating'); ?>', '<?php echo $profileView ?>');"></span> 
                                <?php } ?>
                            </div>
