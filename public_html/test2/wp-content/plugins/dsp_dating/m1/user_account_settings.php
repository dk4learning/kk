<div role="banner" class="ui-header ui-bar-a" data-role="header">
 <a class="ui-btn-left ui-btn-corner-all ui-icon-back ui-btn-icon-notext ui-shadow"  onclick="viewSetting(0, 'setting')" href="#" >
    ...
    <h1 aria-level="1" role="heading" class="ui-title"><?php echo __('Account', 'wpdating'); ?></h1>
...
if (isset($updated) && $updated == true) {
    ...
    <div class="thanks success-message">
       ...
       <?php echo __('You Account Settings has been updated.', 'wpdating'); ?>
    </div>
            ...
            <form id="dspAccount" >
                <fieldset>
                 <label data-role="fieldcontain" class="form-group">  
                        <div class="clearfix">                                    
                            <div class="mam_reg_lf form-label"> <?php echo __('Username', 'wpdating').' : '.$user_account_details->user_login."  "; ?></div>
                            <span style="color:red; font-size: 12px;">&nbsp;&nbsp;&nbsp;<?php echo __('Can&rsquo;t Change', 'wpdating') ?></span>
                    </div>
                </label>

                 <label data-role="fieldcontain" class="form-group">  
                        <div class="clearfix">                                    
                            <div class="mam_reg_lf form-label"> <?php echo __('Password: ', 'wpdating') ?></div>
                    ...
                    <label data-role="fieldcontain" class="form-group">  
                        <div class="clearfix">                                    
                            <div class="mam_reg_lf form-label"><?php echo __('Confirm Password', 'wpdating') ?></div>
                        ...
                        <label data-role="fieldcontain" class="form-group">  
                        <div class="clearfix">                                    
                            <div class="mam_reg_lf form-label"> <?php echo __('Email', 'wpdating') ?></div>
                        ...
                        <div class="btn-row">
                            ...
                            <input type="button" class="mam_btn btn-red" onclick="viewSetting(0, 'post')" name="change_account" value="<?php echo __('Submit', 'wpdating') ?>" class="reply-btn" />
                            </div>
                        </div>
                    ...
                    if (count($recurring_profile_res) > 0) {
                        ...
                        if ($recurring_profile_id) {
                            ...
                            <div style="padding-top: 32px; float: right; padding-right: 10px;">
                                <a onclick="return confirmAction('<?php echo __('Are you sure you want to cancel the membership', 'wpdating'); ?>?');" href="<?php
