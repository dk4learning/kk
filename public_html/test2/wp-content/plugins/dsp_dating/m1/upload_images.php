        ...
        if (isset($_GET['Action']) && $_GET['Action'] == 'update_img') {
            ...
            $mode = 'add';
                    ...
                    <label data-role="fieldcontain" class="select-group">  
                        <div class="clearfix">                                    
                            <div class="mam_reg_lf select-label"><?php echo __('Select Album', 'wpdating'); ?></div>
                            <select name="album_id" onchange="saveAlbumId(this.value)">
                                <option value="0"><?php echo __('Select Album', 'wpdating'); ?></option>
                                <?php
                        ...
                        <!--<div><?php echo __('Upload Photo:', 'wpdating') ?>&nbsp;</div>-->

                        <input type="hidden" name="txtmode" id="txtmode" value="<?php echo $mode ?>">
                        <div class="btn-blue-wrap">
                            <input type="button"  name="submit" class="mam_btn btn-blue" value="<?php echo __('Add Photo', 'wpdating') ?>" onClick="getMediaPhoto();">
                        </div>
...
$i = 0;
if($exists_photos){ ?>
<div class="heading-text"><strong><?php echo __('Photos', 'wpdating'); ?></strong></div>
