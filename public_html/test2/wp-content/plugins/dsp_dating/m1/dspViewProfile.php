...
$dsp_reported_user = $wpdb->prefix . dsp_reported_user;
...
if ($Action == 'report') {
    ...
    foreach ($report_member_table as $report_member) {
        ...
        $wpdb->query("INSERT INTO $dsp_reported_user SET reported_by = '$user_id', reported_to = '$member_id', reason = '$reported_reason'");

        $message = __('A user has reported the following profile. Please check the profile. ', 'wpdating') . '<br>';
    ...
    <div role="banner" class="ui-header ui-bar-a" data-role="header">
        ...
        <div  class="ui-btn-right" >
           ...
           <!-- <a  >
                ...
                <?php echo __('Add Friend', 'wpdating'); ?>
            </a> -->
            <?php } ?>
        </div>
    </div>
                                    ...
                                    <div class="profile_img_view">
                                                    ...
                                                    <div class="dsp_on_lf_view">
                                                        <ul>
                                                            ...
                                                            <li class="dsp_prof_view">
                                                                ...
                                                                <div>
                                                                    <a onclick="addFavourite('<?php echo $member_id; ?>')" title="<?php echo __('Add to Favorites', 'wpdating'); ?>">
                                                                ...
                                                                <div> 
                                                                    ...
                                                                    if (isset($check_my_friends_list) && $check_my_friends_list > 0) {
                                                                        ?>
                                                                        <a onclick="composeMessage('<?php echo $member_id ?>', 0)" title="<?php echo __('Send Message', 'wpdating'); ?>">
                                            ...
                                            <?php if ($check_flirt_module->setting_status == 'Y') { // Check FLIRT (WINK) module Activated or not 
                                                ...
                                                <div>
                                                    ...
                                                    if ($check_user_profile_exist > 0) {  // check user dating profile exist or not           
                                                        ?>
                                                        <a onclick="sendWink('<?php echo $member_id; ?>')" title="<?php echo __('Send Wink', 'wpdating'); ?>">
                                                            <img style="width:20px;height:20px" src="<?php echo $fav_icon_image_path ?>wink.jpg" border="0" />
                                                        </a>
                                                        <?php
                                                    } else {
                                                        ?>
                                                        <a onclick="redirectEditProfile('<?php echo __('Please update Profile Before Send a wink.', 'wpdating') ?>');" title="Edit Profile">
                                                            <img style="width:20px;height:20px" src="<?php echo $fav_icon_image_path ?>wink.jpg" border="0" />
                                                        </a>
                                        ...
                                        <li class="dsp_prof_view">
                                            <?php if ($check_date_tracker_mode->setting_status == 'Y') { // Check Skype mode Activated or not 
                                                ?> 
                                                <div>
                                                    <a onclick="viewMemberProfile(<?php echo $member_id ?>, 'date_tracker#<?php echo __('Have you gone on a date with this person?', 'wpdating') ?>');">
                                                        <img style="width:20px;height:20px" src="<?php echo $fav_icon_image_path ?>date_tracker.png" border="0" />
                                                    </a>
                                                </div>
                                                <?php } ?>
                                                <div>
                                                    <a onclick="viewMemberProfile(<?php echo $member_id ?>, 'report#<?php echo __('Are you sure you want to report this profile?', 'wpdating'); ?>'); reportUser(<?php echo $member_id ?>,<?php echo $user_id ?>, '<?php echo __('Are you sure you want to report this profile?', 'wpdating'); ?>');">
                                                        <img style="width:20px;height:20px" src="<?php echo $fav_icon_image_path ?>report.png" border="0" />
                                                    </a>
                                                </div>
                                                <div>
                                                    <a onclick="viewMemberProfile(<?php echo $member_id ?>, 'blocked#<?php echo __('Are you sure you want to block this member?', 'wpdating'); ?>');">
                        ...
                        <ul id="iGallery" data-divider-theme="d" data-theme="d" data-inset="true" data-role="listview" class="ui-listview ui-listview-inset ui-corner-all dsp_ul accordion-item">
                            ...
                            <a   onclick="slide_me('div_info')" >
                                <li  data-corners="false" data-shadow="false"  data-wrapperels="div" class="ui-body ui-body-d ui-corner-all accordion-item">
                                    <?php echo __('Profile Info', 'wpdating'); ?>
                            ...
                            <ul id="iGallery" data-divider-theme="d" data-theme="d" data-inset="true" data-role="listview" class="ui-listview ui-listview-inset ui-corner-all dsp_ul accordion-item">
                                ...
                                <a  onclick="<?php if ($totalFriends > 0) { ?>slide_me('div_frnd')<?php } ?>">
                                    <li data-corners="false" data-shadow="false"  data-wrapperels="div" class="ui-body ui-body-d ui-corner-all">
                                        <?php echo __('Friends', 'wpdating') . " (" . $totalFriends . ")"; ?>
                                    </li>
                                </a>
                            </ul>
                            <ul id="iGallery" data-divider-theme="d" data-theme="d" data-inset="true" data-role="listview" class="ui-listview ui-listview-inset ui-corner-all dsp_ul accordion-item">
                            ...
                            if ($gallerySetting == 'Y') {
                                ...
                                <ul id="iGallery" data-divider-theme="d" data-theme="d" data-inset="true" data-role="listview" class="ui-listview ui-listview-inset ui-corner-all dsp_ul accordion-item">
                                    ...
                                    <a onclick="<?php if ($totalPhotos > 0) { ?>slide_me('div_photos')<?php } ?>"  >
                                        <li data-corners="false" data-shadow="false"  data-wrapperels="div" class="ui-body ui-body-d ui-corner-all">
                                            <?php echo __('Photos', 'wpdating') . " (" . $totalPhotos . ")"; ?>
                                        </li>
                                    </a>
                                </ul>
                                <ul id="iGallery" data-divider-theme="d" data-theme="d" data-inset="true" data-role="listview" class="ui-listview ui-listview-inset ui-corner-all dsp_ul accordion-item">
                                ...
                                if ($videSetting == 'Y') {
                                    ...
                                    <ul id="iGallery" data-divider-theme="d" data-theme="d" data-inset="true" data-role="listview" class="ui-listview ui-listview-inset ui-corner-all dsp_ul accordion-item">
                                        ...
                                        <a  onclick="<?php if ($totalVideo > 0) { ?>slide_me('div_video')<?php } ?>">
                                            <li data-corners="false" data-shadow="false"  data-wrapperels="div" class="ui-body ui-body-d ui-corner-all">
                                                <?php echo __('Videos', 'wpdating') . " (" . $totalVideo . ")"; ?>
                                            </li>
                                        </a>
                                    </ul>
                                    <ul id="iGallery" data-divider-theme="d" data-theme="d" data-inset="true" data-role="listview" class="ui-listview ui-listview-inset ui-corner-all dsp_ul accordion-item">
                                    ...
                                    if ($audioSetting == 'Y') {
                                        ...
                                        <ul id="iGallery" data-divider-theme="d" data-theme="d" data-inset="true" data-role="listview" class="ui-listview ui-listview-inset ui-corner-all dsp_ul accordion-item">
                                            ...
                                            <a   href="<?php if ($totalSounds > 0) { ?>dsp_profile_audio.html<?php } ?>">
                                                <li data-corners="false" data-shadow="false"  data-wrapperels="div" class="ui-body ui-body-d ui-corner-all">
                                                    <?php echo __('Sound', 'wpdating') . " (" . $totalSounds . ")"; ?>
                                                </li>
                                            </a>
                                        </ul>
                                        <?php } 
                                        if ($blogSetting == 'Y') {
                                            ...
                                            <ul id="iGallery" data-divider-theme="d" data-theme="d" data-inset="true" data-role="listview" class="ui-listview ui-listview-inset ui-corner-all dsp_ul accordion-item">
                                                ...
                                                <a  onclick="<?php if ($totalBlogs > 0) { ?>slide_me('div_blog')<?php } ?>">
                                                    <li data-corners="false" data-shadow="false"  data-wrapperels="div" class="ui-body ui-body-d ui-corner-all">
                                                        <?php echo __('Blogs', 'wpdating') . " (" . $totalBlogs . ")"; ?>
                                                    </li>
                                                </a>
                                            </ul>
                                            <ul id="iGallery" data-divider-theme="d" data-theme="d" data-inset="true" data-role="listview" class="ui-listview ui-listview-inset ui-corner-all dsp_ul accordion-item">
