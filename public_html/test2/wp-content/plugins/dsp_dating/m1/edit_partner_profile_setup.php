<div role="banner" class="ui-header ui-bar-a" data-role="header">
 ...
 <h1 aria-level="1" role="heading" class="ui-title"><?php echo __('Edit Profile', 'wpdating'); ?></h1>
        ...
        <ul class="ui-grid-duo ui-grid-a">
            <li class="ui-block-a">
                <a href="dsp_edit_profile.html" data-corners="false" data-shadow="false" data-iconshadow="true" data-wrapperels="span" data-theme="a" data-inline="true" class="ui-btn ui-btn-inline ui-btn-up-a  <?php if ($edit_profile_pageurl == "") echo "ui-btn-active"; ?>">
                    <span class="ui-btn-inner"><span class="ui-btn-text"><?php echo __('My Profile', 'wpdating'); ?></span></span>
                </a>
            </li>
            <li class="ui-block-b">
                <a href="dsp_edit_partner_profile.html" data-corners="false" data-shadow="false" data-iconshadow="true" data-wrapperels="span" data-theme="a" data-inline="true" class="ui-btn ui-btn-inline ui-btn-up-a <?php if ($edit_profile_pageurl == "partner_profile") echo "ui-btn-active"; ?>">
                    <span class="ui-btn-inner"><span class="ui-btn-text"><?php echo __('Partner Profile', 'wpdating'); ?></span></span>
                </a>
            </li>
...
// ************************* INSERT PROFILE QUESTION OPTION INFORMATION *****************************//
            ...
            foreach ($question_option_id as $key => $value) {
                if ($value != 0) {
                    ...
                    $wpdb->query("INSERT INTO $dsp_partner_profile_question_details_table SET user_id = $user_id,profile_question_id = '$key',profile_question_option_id='" . $value . "',option_value='" . str_replace("'","''",$fetch_question_id->option_value) . "'");
                } // End  if($value!=0) {
                ...
                if ($question_option_id1 != "") {
                    ...
                    foreach ($question_option_id1 as $key => $value) {
                        ...
                        if ($value != "") {
                            ...
                            $wpdb->query("INSERT INTO $dsp_partner_profile_question_details_table SET user_id = $user_id,profile_question_id ='$key' ,profile_question_option_id=0,option_value='" . str_replace("'","''",$value) . "'");
                    } // End if($value!="")
                } // End foreach($question_option_id1 as $key=>$value)
            }
...
if (isset($_GET['msg']) && $_GET['msg'] == 'ed') {
    ...
    <div class="heading-text"><?php echo __('Please update Profile Before Add to friend.', 'wpdating') ?>
    </div>
...
if ($check_approve_profile_status->setting_status == 'Y') {
    if (isset($profile_updated) && $profile_updated == true) {
        ?>
        <div class="heading-text"><?php echo __('Your profile has been updated!', 'wpdating') ?>
        </div>
    ...
    $mon = array(1 => 'January', 'February', 'March', 'April',
        ...
        <div class="col-cont clearfix">
            ...
            <label data-role="fieldcontain" class="form-group">  
                <div class="clearfix">                                    
                    <div class="mam_reg_lf form-label"><?php echo __('Zip:', 'wpdating'); ?></div>
            ...
            <div class="heading-text"><strong><?php echo __('Profile Questions', 'wpdating') ?></strong></div>
            <?php
            ...
            ?>
                ...
                foreach ($myrows as $profile_questions) {
                    ...
                    $i++;
                        ...
                        <div class="heading-text"><strong><?php echo __('About Me', 'wpdating') ?></strong></div>
                        ...
                        <div class="heading-text"><strong><?php echo __('My Interests', 'wpdating'); ?></strong></div>
                        ...
                        <div>
                            ...
                            <input type="button" class="mam_btn btn-blue" onclick="editPartnerQuestion('true', '<?php echo __('Fields should not be empty.', 'wpdating'); ?>')" name="submit"  value="<?php _e(__('Update', 'wpdating')); ?>" />
                            </div>
                        ...
                        <li class="dsp_img3"> 
                                    <img src="<?php echo display_members_partner_photo($user_partner_profile_id, $imagepath); ?>" style="width: 30%;height: auto;display: inline-block;padding: 10px;vertical-align: middle;"  class="dsp_img3" />
                                        ...
                                        if ($exist_profile_details->make_private == 'Y')
                                            ...
                                            echo 'N';
                                        ?>" id="chkPrivate" name="private"><?php echo __('Make Private', 'wpdating') ?>
                                    
                                    </li>
                                    </ul>
                                    <div class="btn-blue-wrap">
                                        <button onclick="getPartnerPhoto(); return false;" class="mam_btn btn-blue"><?php echo __('Upload Photo:', 'wpdating') ?></button>
                                    </div>
