...
<div role="banner" class="ui-header ui-bar-a" data-role="header">
    ...
    <h1 aria-level="1" role="heading" class="ui-title"><?php echo __('My Favorites', 'wpdating'); ?></h1>
                            ...
                            <div class="dsp_pro_full_view">
                                            ...
                                            if ($favourites->make_private == 'Y') {
                                                if ($user_id != $fav_user_id) {
                                                    ...
                                                    <?php } else {
                                                        ?>
                                                        <a onclick="viewProfile('<?php echo $fav_user_id; ?>', 'my_profile')" >				
                                                            <img src="<?php echo display_members_photo($fav_user_id, $imagepath); ?>"   border="0" class="dsp_img3" style="width:100px; height:100px;"/></a>                
                                                        <?php
                                                    }
                                                } else {
                                                    ?>
                                                ...
                                                ?>                
                                                <a onclick="viewProfile('<?php echo $fav_user_id; ?>', 'my_profile')" >				
                                                    <img src="<?php echo display_members_photo($fav_user_id, $imagepath); ?>"  border="0"  class="dsp_img3" style="width:100px; height:100px;"/>
                                                </a>
                                            <?php } ?>
                                            <?php
                                        } else {
                                ...
                                <div class="dsp_on_lf_view">
                                          ...
                                          <div class="user-name spacer-bottom-xs spacer-top-sm"> <?php echo $displayed_member_name; ?></div>
                                            ...
                                            <span class="button-delete" onclick="myFavorite('<?php echo $favourite_id ?>', '<?php echo __('Are you sure you want to Delete this email?', 'wpdating') ?>');" title="<?php echo __('Delete', 'wpdating') ?>"><?php echo __('Delete', 'wpdating') ?></span>
