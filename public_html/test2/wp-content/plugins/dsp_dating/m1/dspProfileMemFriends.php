                    ...
                    <li data-corners="false" data-shadow="false" class="ui-body ui-body-d ui-corner-all">
                        ...
                        <div class="dsp_pro_full_view">
                            ...
                            <div class="dsp_on_lf_view">
                                        ...
                                        <span class="button-delete" title="<?php echo __('Delete', 'wpdating'); ?>" onclick="viewUserFriends('<?php echo $member_friends->friend_uid; ?>', '<?php echo __('Are you sure you want to Delete the selected Member?', 'wpdating'); ?>');"><?php echo __('Delete', 'wpdating'); ?></span> 
