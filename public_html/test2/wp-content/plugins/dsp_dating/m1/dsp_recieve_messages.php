...
// ------------------------------------------------End Paging code------------------------------------------------------ // 
			...
			<img src='images/icons/next-all.png' />
                    ...
                    <li data-corners="false" data-shadow="false" class="ui-body ui-body-d ui-corner-all">
                        ...
                        <div class="checkbox-left"><input type="checkbox" name="sender_ID[]" value="<?php echo $message->sender_id ?>" /></div>
                        <div class="image"> <?php
                            if ($check_couples_mode->setting_status == 'Y') {
            ...
            <div>
                ...
                <input onclick="getInbox(0, 'true')" class="mam_btn btn-blue" type="button" name="delmsg" value="<?php echo __('Delete Selected', 'wpdating') ?>" />
               </div>
                <?php }else{
