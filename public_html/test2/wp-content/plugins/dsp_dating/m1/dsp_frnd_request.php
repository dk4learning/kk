                ...
                foreach ($frnd_request_members as $request_mem) {
                    ...
                    <li class="ivew-list">
                        ...
                        if ($check_couples_mode->setting_status == 'Y') {
                            ...
                            <?php } ?>
                        <?php } ?>
                            <span onclick="showAlertPage('alert', 'approve', '<?php echo $request_mem->friend_id ?>')" class="button-edit spacer-bottom-xs approve-friend" ><?php echo __('Approve', 'wpdating') ?></span>
                            <span onclick="showAlertPage('alert', 'reject', '<?php echo $request_mem->friend_id ?>')" class="button-delete spacer-bottom-xs approve-friend" ><?php echo __('Reject', 'wpdating') ?></span>
                    </li>
                    <?php
                    $i++;
                }
