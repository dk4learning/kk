...
<div role="banner" class="ui-header ui-bar-a" data-role="header">
    ...
    <h1 aria-level="1" role="heading" class="ui-title"><?php echo __('Alerts', 'wpdating'); ?></h1>
                ...
                <a  onclick="slide_me('div_frnd_req')">
                 <img  src="images/icons/aproovefriends.png" />
                    ...
                    if ($count_friends_request > 0) {
                        echo __('Approve', 'wpdating') . ' ' . __('Friends', 'wpdating') . ' (' . $count_friends_request . ')';
                    } else {
                        echo __('Approve', 'wpdating') . ' ' . __('Friends', 'wpdating');
                    }
                    ?>
                    </a>
                </li>
                ...
                <li data-corners="false" data-shadow="false"  data-wrapperels="div" class="ui-body ui-body-d ui-corner-all">
                   <a onclick="slide_me('div_comment')">
                    ...
                    if ($count_friends_comments > 0) {
                        echo __('Approve', 'wpdating') . ' ' . __('Comments', 'wpdating') . ' (' . $count_friends_comments . ')';
                    } else {
                        echo __('Approve', 'wpdating') . ' ' . __('Comments', 'wpdating');
                    }
                    ?>
                     </a>
                </li>
           ...
           <ul data-divider-theme="d" data-theme="d" data-inset="true" data-role="listview" class="ui-listview ui-listview-inset ui-corner-all dsp_ul alert-list">
                ...
                <li data-corners="false" data-shadow="false"  data-wrapperels="div" class="ui-body ui-body-d ui-corner-all">
                    ...
                    if ($count_friends_virtual_gifts > 0) {
                        echo __('Approve', 'wpdating') . ' ' . __('Virtual Gifts', 'wpdating') . ' (' . $count_friends_virtual_gifts . ')';
                    } else {
                        echo __('Approve', 'wpdating') . ' ' . __('Virtual Gifts', 'wpdating');
                    }
                    ?>
           ...
           <ul data-divider-theme="d" data-theme="d" data-inset="true" data-role="listview" class="ui-listview ui-listview-inset ui-corner-all dsp_ul alert-list">
                ...
                <li data-corners="false" data-shadow="false"  data-wrapperels="div" class="ui-body ui-body-d ui-corner-all">
                    ...
                    if ($count_wink_messages > 0) {
                        echo __('Wink Received', 'wpdating') . ' (' . $count_wink_messages . ')';
                    } else {
                        echo __('Wink Received', 'wpdating');
                    }
                    ?>
                     </a>
                </li>
