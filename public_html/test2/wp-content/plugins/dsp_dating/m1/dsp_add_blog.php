<div role="banner" class="ui-header ui-bar-a" data-role="header">
 ...
 <h1 aria-level="1" role="heading" class="ui-title">
    ...
    if (isset($_REQUEST['mode']) && $_REQUEST['mode'] == 'edit') {
        echo __('Edit', 'wpdating');
    } else {
        echo __('Add Blogs', 'wpdating');
    }
    ?></h1>
            ...
            <form id="dsp_trending" >
                <fieldset>
                  <div data-role="fieldcontain">
                    <input type="text" name="title" class="input-control" id="blog-title" placeholder="<?php echo __('Title', 'wpdating') ?>" value="<?php echo $my_blog_table->blog_title; ?>" />
                </div>
                <div data-role="fieldcontain">
                    <textarea name="blog_content" id="blog-content" placeholder="<?php echo __('Blog', 'wpdating') ?>" class="textarea-box"  ><?php echo $my_blog_table->blog_content; ?></textarea>
                </div>
                <div data-role="fieldcontain">
                 <input type="text" class="input-control" placeholder="<?php echo __('Tags', 'wpdating') ?>" name="tag" id="blog-tag" value="<?php echo $my_blog_table->tag; ?>" />
             </div>
        ...
        <div class="content-primary">	
            ...
            if (isset($updated)) {
                ...
                <form id="dsp_trending" >
                    <fieldset>
                        <div data-role="fieldcontain">
                            <input type="text" name="title" id="blog-title" class="input-control" placeholder="<?php echo __('Title', 'wpdating') ?>" value="" />
                        </div>
                        <div data-role="fieldcontain">
                            <textarea name="blog_content" placeholder="<?php echo __('Blog', 'wpdating') ?>" id="blog-content" class="textarea-box"></textarea>
                        </div>
                        <div data-role="fieldcontain">
                            <input type="text" name="tag" class="input-control" id="blog-tag" value="" placeholder="<?php echo __('Tags', 'wpdating') ?>" />
                        </div>
                        <input type="hidden" name="pagetitle" value="blogs" />
                        ...
                        <input type="hidden" name="user_id" value="<?php echo $user_id; ?>" />
                        <div class="btn-blue-wrap">
                            <input type="button" class="mam_btn btn-blue"  name="submit" class="blog-add" onclick="viewExtra(0, 'post')" value="<?php echo __('Add', 'wpdating') ?>"   />
                        </div>
                    </fieldset>
