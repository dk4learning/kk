...
if ($user_image != "") {
        ...
        <div class="meet-to-info">
            ...
            <div class="btn-row-meet">
                ...
                <form id="dsp_yes">
                    ...
                    <input type="hidden" name="action" value="<?php echo __('Yes', 'wpdating') ?>" />
                    <input type="hidden" name="user_id" value="<?php echo $user_id; ?>" />
                    <input type="hidden" name="pagetitle" value="meet_me" />
                    <input class="button yes"  onclick="ExtraLoad('div_meetme', 'yes')"   type="button" value="<?php echo __('Yes', 'wpdating') ?>"  />
                </form>
                <form id="dsp_no">
                    <input id="dsp_meet_me_user" name="member_id" type="hidden" value="<?php echo $profile_row->user_id; ?>"  />
                    <input type="hidden" name="user_id" value="<?php echo $user_id; ?>" />
                    <input type="hidden" name="pagetitle" value="meet_me" />
                    <input type="hidden" name="action" value="<?php echo __('No', 'wpdating') ?>" />
                    <input class="button no"  onclick="ExtraLoad('div_meetme', 'no')" type="button" value="<?php echo __('No', 'wpdating') ?>" />
                </form>
    ...
    <div class="thanks-note"><p class="error" style="text-align: center"><?php echo __('No more members available to meet', 'wpdating') ?></p>
        <a href="dsp_main_search.html"><?php echo __('Start a new Search', 'wpdating'); ?></a>
