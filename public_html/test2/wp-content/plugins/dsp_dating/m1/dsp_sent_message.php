...
<div role="banner" class="ui-header ui-bar-a" data-role="header">
    ...
    <h1 aria-level="1" role="heading" class="ui-title"><?php echo __('Sent', 'wpdating');?></h1>
...
//$my_messages= $wpdb->get_results("SELECT * FROM $dsp_user_emails_table where sender_id=$user_id Order by thread_id desc");
			...
			<img src='images/icons/next-all.png' />
                                    ...
                                    <?php if ($message->sender_id != $user_id) {
                                        ...
                                        <li><a href="<?php
                                            echo add_query_arg(array('pid' => 14,
                                                ...
                                                'Act' => 'Reply'), $root_link);
                                            ?>"><?php echo __('Reply', 'wpdating') ?></a></li>
                                        <?php } //end if      ?>
                                </ul>
                            </div>
                    ...
                    <div>
                        ...
                        <input onclick="getSent('true', 0)" type="button" class="mam_btn btn-blue" name="delmsg" value="<?php echo __('Delete Selected', 'wpdating') ?>" />
                         </div>
                    <?php
                            } else {
