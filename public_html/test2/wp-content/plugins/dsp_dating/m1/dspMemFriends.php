...
<!--<div role="banner" class="ui-header ui-bar-a" data-role="header">
                ...
                <h1 aria-level="1" role="heading" class="ui-title"><?php echo __('Friends', 'wpdating'); ?></h1>
                ...
                <li data-corners="false" data-shadow="false" class="ui-body ui-body-d ui-corner-all">
                    ...
                    <div class="dsp_pro_full">
                        ...
                        <div style="width: 50%;float: left;">
                            ...
                            ?>"> 
                                <img src="<?php echo display_members_photo($member_friends->friend_uid, $imagepath); ?>" class="dsp_img3" border="0" style="width:100px; height:100px;"/></a>
                        </div>
                                    ...
                                    if ($member_friends->make_private == 'Y') {
                                        ...
                                        if (!in_array($user_id, $favt_mem)) {
                                            ...
                                            <a onclick="viewProfile('<?php echo $member_friends->friend_uid; ?>', 'my_profile')">				
                                                ...
                                                <img src="<?php echo display_members_photo($member_friends->friend_uid, $imagepath); ?>"  border="0"   class="dsp_img3" width="100" height="100"/></a>                
                                        ...
                                        <a onclick="viewProfile('<?php echo $member_friends->friend_uid; ?>', 'my_profile')"> 
                                            ...
                                            <img src="<?php echo display_members_photo($member_friends->friend_uid, $imagepath); ?>" border="0"  class="dsp_img3" style="width:100px; height:100px;"/>
                                    ...
                                    if ($member_friends->make_private == 'Y') {
                                        ...
                                        if (!in_array($user_id, $favt_mem)) {
                                            ...
                                            <a onclick="viewProfile('<?php echo $member_friends->friend_uid; ?>', 'my_profile')">				
                                                ...
                                                <img src="<?php echo display_members_photo($member_friends->friend_uid, $imagepath); ?>" border="0"  class="dsp_img3" width="100" height="100"/>
                                            </a>                
                        ...
                        <ul>
                            ...
                            <li>
                                <?php if ($user_id == $member_id) { // display delete button only when member view his frnd list 
                                    ?>
                                    <span class="delete-icon dsp_span_pointer" title="<?php echo __('Delete', 'wpdating'); ?>" onclick="viewUserFriends('<?php echo $member_friends->friend_uid; ?>', '<?php echo __('Are you sure you want to Delete the selected Member?', 'wpdating'); ?>');"></span> 
                                <?php } ?>
                            </li>
                        </ul>
