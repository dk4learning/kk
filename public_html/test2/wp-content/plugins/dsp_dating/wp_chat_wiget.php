        ...
        if ($check_free_mode->setting_status == "N"){  // free mode is off 
            ...
            if ($check_free_trail_mode->setting_status == "N") {
                ...
                if ($check_membership_msg == "Expired") {
                    ...
                    <p><?php echo __('Your Premimum Account has been expired.', 'wpdating'); ?> <a href="<?php echo $root_link . "setting/upgrade_account/"; ?>" class="textlink dspdp-btn dspdp-btn-default"><?php echo __('Upgrade Here.', 'wpdating'); ?></a></p>

                <?php } else if ($check_membership_msg == "Onlypremiumaccess") { ?>

                    <p><?php echo __('You must be a premium member to use the chat feature.', 'wpdating'); ?> <a href="<?php echo $root_link . "setting/upgrade_account/"; ?>"  class="textlink dspdp-btn dspdp-btn-default"><?php echo __('Upgrade Here.', 'wpdating'); ?></a></p>
                        ...
                        <div id="wrapper" class="dspdp-panel dspdp-panel-default">
                            ...
                            <div class="dspdp-input-group">
                                ...
                                <span class="dspdp-input-group-btn"> 
                                 <input class="dspdp-btn dspdp-btn-default" name="submitmsg" type="submit"  id="submitmsg" value="<?php echo __('Send', 'wpdating');?>" />
                                </span>
                            </div>
                            </form>
                        </div>
                ...
                if ($check_member_trial_msg == "Expired") {
                    ?>
                    <p><?php echo __('Your Premimum Account has been expired.', 'wpdating'); ?> 
                        <a href="<?php echo $root_link . "setting/upgrade_account/"; ?>" class="textlink dspdp-btn dspdp-btn-default"><?php echo __('Upgrade Here.', 'wpdating'); ?></a>
                    </p>
                <?php } else if ($check_member_trial_msg == "Onlypremiumaccess") { ?>
                    <p><?php echo __('You must be a premium member to use the chat feature.', 'wpdating'); ?> <a href="<?php echo $root_link . "setting/upgrade_account/"; ?>"  class="textlink"<?php echo __('Upgrade Here.', 'wpdating'); ?></a></p>
...
<?php } else { ?>
    ...
    <div style="height:300px; text-align:center; vertical-align:middle; line-height:300px; font-weight:bold;"><?php echo __('You must be logged in to chat', 'wpdating') ?></div>
