    ...
    if ($check_my_friends_list <= 0) {   // check member is not in my friend list
        ...
        <div class="box-border">
            <div class="box-pedding">
                <div align="center"><?php echo __('You can&rsquo;t view member Videos.', 'wpdating'); ?></div>
            </div>
        </div>
...
// -------------------------------- END OF PRINT PAGING LINKS ------------------------------------- //
                    ...
                    <?php }else{?>
                    <tr> <td>
                            <span class="dsp_span_pointer"><?php echo __('The user has not uploaded any videos.', 'wpdating'); ?></span><br />
                        </td>
                    </tr>
                    <?php } ?>
                </table>
