    ...
    <div class="dsp_box-in" style="overflow:scroll;overflow-x:hidden; height:150px;scrollbar-arrow-color: #000000;">
        ...
        if ($count_added_friends > 0) {
            ...
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr><td><strong><?php echo __('My Friends', 'wpdating'); ?></strong></td></tr>
                <tr><td>&nbsp;</td></tr>
                <tr><td>
                                        ...
                                        <table cellpadding="0" cellspacing="0" border="0">
                                            ...
                                            <tr>
                                                <td class="dsp_name" align="center">
                                                    ...
                                                    <span onclick="delete_friend_from_list('<?php echo $friend->friend_id ?>');" class="dsp_span_pointer"><?php echo __('Delete', 'wpdating'); ?></span> 
                                                </td>
                                            </tr>
                                        </table>
                                    </td>
        ...
        <?php } else { ?>
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr><td><strong><?php echo __('No Friends!', 'wpdating'); ?></strong></td></tr>
                <tr><td>&nbsp;</td></tr>
            </table>
        <?php } ?>
    </div>
