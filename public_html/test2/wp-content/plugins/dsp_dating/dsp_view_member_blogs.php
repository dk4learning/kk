...
if ($user_id != $member_id) {
    ...
    <?php } else {   // -----------------------------else Check member is in my friend list ---------------------------- // 
        ...
        <form name="" method="GET" action="">
            ...
            <div class="box-border">
                <div class="box-pedding">
                    <div class="heading-text dsp-clearfix"><strong><?php echo __('Blogs', 'wpdating'); ?></strong></div>
                    <ul class="blog-page-heading dsp-clearfix">
                        <li><span style="float: left;width:17%; font-weight:bold;"><?php echo __('Title', 'wpdating'); ?></span> <span style="float: left;width:17%; font-weight:bold;"><?php echo __('Date', 'wpdating'); ?></span>
                            <span style="float: left;width:55%; font-weight:bold;"><?php echo __('Blog', 'wpdating'); ?></span></li></ul>
                    <?php
