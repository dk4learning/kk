...
?>
    <div class="line">
        <div <?php if (($profile_pageurl == "account_settings")) { ?>class="dsp_tab1-active"
            ...
            <a href="<?php echo $root_link . "setting/account_settings/"; ?>"><?php echo __('Account', 'wpdating'); ?></a>
        </div>
       ...
       <div <?php if (($profile_pageurl == "match_alert")) { ?>class="dsp_tab1-active" <?php } else { ?>class="dsp_tab1" <?php } ?>>
           <a href="<?php echo $root_link . "setting/match_alert/"; ?>"><?php echo __('Match alerts', 'wpdating'); ?></a></div>
   <?php } ?> -->
        <div <?php if ($profile_pageurl == "blocked") { ?>class="dsp_tab1-active"
             <?php } else { ?>class="dsp_tab1" <?php } ?>>
            <a href="<?php echo $root_link . "setting/blocked/"; ?>"><?php echo __('Blocked', 'wpdating'); ?></a>
        </div>
        <div <?php if ($profile_pageurl == "notification") { ?>class="dsp_tab1-active"
             <?php } else { ?>class="dsp_tab1" <?php } ?>>
            <a href="<?php echo $root_link . "setting/notification/"; ?>"><?php echo __('Notification', 'wpdating'); ?></a>
        </div>
        <div <?php if (($profile_pageurl == "privacy_settings")) { ?>class="dsp_tab1-active"
             <?php } else { ?>class="dsp_tab1" <?php } ?>>
            <a href="<?php echo $root_link . "setting/privacy_settings/"; ?>"><?php echo __('Privacy', 'wpdating'); ?></a>
        </div>
        <?php if ($check_skype_mode->setting_status == 'Y') { // Check Skype mode Activated or not  ?>
            <div <?php if (($profile_pageurl == "skype_settings")) { ?>class="dsp_tab1-active"
                 <?php } else { ?>class="dsp_tab1" <?php } ?>>
                <a href="<?php echo $root_link . "setting/skype_settings/"; ?>"><?php echo __('Skype', 'wpdating'); ?></a>
            </div>
        <?php } // END Skype mode Activation check condition  ?>
        <div <?php if (($profile_pageurl == "upgrade_account")) { ?>class="dsp_tab1-active"
             <?php } else { ?>class="dsp_tab1" <?php } ?>>
            <a href="<?php echo $root_link . "setting/upgrade_account/"; ?>"><?php echo __('Upgrade Account', 'wpdating'); ?></a>
        </div>
        <!-- Credits Plan Menu -->
        <?php if($check_credit_mode->setting_status == 'Y'): ?>
        <div <?php if (($profile_pageurl == "upgrade_credits")) { ?>class="dsp_tab1-active"
             <?php } else { ?>class="dsp_tab1" <?php } ?>>
            <a href="<?php echo $root_link . "setting/upgrade_credits/"; ?>"><?php echo __('Credits Plan', 'wpdating'); ?></a>
        </div>
        <?php endif; ?>
        <div <?php if (($profile_pageurl == "delete_account")) { ?>class="dsp_tab1-active"
             <?php } else { ?>class="dsp_tab1" <?php } ?>>
            <a href="<?php echo $root_link . "setting/delete_account/"; ?>"><?php echo __('Delete Account','wpdating');?></a>
        </div>
        <div class="clr"></div>
    </div></div>
...
}else if ($profile_pageurl == "delete_account") {
    include_once(WP_DSP_ABSPATH . "members/loggedin/settings/delete_account.php");
...
} else if ($profile_pageurl == "wpdm_mollie") {
    include_once(WP_DSP_ABSPATH . "members/loggedin/settings/upgrade_accounts/discounts/mollie_discount.php");
} else if ($profile_pageurl == "upgrade_credits") {
    include_once(WP_DSP_ABSPATH . "members/loggedin/settings/upgrade_accounts/upgrade_credits_plan_settings.php");
}
...
}else if ($profile_pageurl == "dsp_initialize_payment") {
    include_once(WP_CONTENT_DIR . "/plugins/wpdating-micropayment-addon/public/partials/payment-pages/initialize_payment.php");
}
