...
// check help tab is Activated or not.
$check_help_tab = $wpdb->get_row("SELECT * FROM $dsp_general_settings_table WHERE setting_name = 'help_tab'");
...
$check_stealth_option = $wpdb->get_row( "SELECT * FROM $dsp_general_settings_table WHERE setting_name = 'stealth_mode'");