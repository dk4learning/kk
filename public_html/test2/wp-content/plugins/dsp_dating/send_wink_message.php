    ...
    <div class="dsp_box-out">
        <div class="dsp_box-in">
            <?php if (isset($winktext_Error)) { ?>
                <div>
                    ...
                    <p style="text-align:center;">
                        <a href="<?php echo $root_link . get_username($get_receiver_id) . "/"; ?>" class="dspdp-btn dspdp-btn-info"><?php echo __('Back to Profile', 'wpdating') ?>
                        </a>
                    </p>  
                </div>
                <?php
            ...
            if (isset($message_sent) && $message_sent == true) {
                ?>
                <div>
                    <p class="dspdp-text-success" style="padding-left:30px;"><?php echo __('Wink Sent Sucessfully.', 'wpdating'); ?></p>
                    <p style="text-align:center;">
                        <a href="<?php echo $root_link . get_username($get_receiver_id) . "/"; ?>" class="dspdp-btn dspdp-btn-info"><?php echo __('Back to Profile', 'wpdating') ?>
                        </a>
                    </p>  
            ...
            <?php } else { ?>
                <form name="sendwinkfrm" action="" method="post" class=" dspdp-form-inline">
                    ...
                    <div class="box-page box-border">
                        <div class="dspdp-spacer-sm"><strong><?php echo __('Send Wink', 'wpdating'); ?></strong></div>
                        <div class="msg"><select  name="cmbwinktext_id" class="dspdp-form-control">
                            ...
                            <input type="button"  class="dspdp-btn dspdp-btn-default" name="send_flirt" value="<?php echo __('Send Wink', 'wpdating'); ?>" onclick="send_wink_message();">
                        </div>
                    </div>
                </form>
            <?php } ?>
