            ...
            <tr>
                <td>
                    <table border="0" cellspacing="1" cellpadding="0">
                        ...
                        <tr>
                            <td><?php echo __('I am:', 'wpdating'); ?></td>
                        ...
                        <tr>
                            <td><?php echo __('Seeking a:', 'wpdating'); ?></td>
        ...
        <?php if ($check_zipcode_mode->setting_status == 'Y') {
            ...
            <tr>
                <td>
                    <table width="100%" border="0" cellspacing="0" cellpadding="3">
                        <tr>
                            <td colspan="4" align="left" class="dsp_mb_header"><?php echo __('Location:', 'wpdating'); ?></td>
                        </tr>
                        <tr>
                            <td colspan="4">
                                <table border="0" cellspacing="1" cellpadding="0">
                                    ...
                                    <tr>
                                        <td><input type="checkbox" name="Online_only" value="Y">
                                            <?php echo __('Online Only', 'wpdating') ?>
                                            <br>
                    ...
                    <tr>
                        <td colspan="2" align="center">
                            <input type="submit" name="submit" class="dsp_submit_button" value="<?php echo __('Search', 'wpdating'); ?>" onclick="search_by_quick_widget();" />
                        </td>
                    </tr>
                </table>
            </td>
