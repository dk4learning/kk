...
$button_text=__('Add Album', 'wpdating');
...
<form name="createalbum"  class="dspdp-box-border" action="" method="post">
    <ul class="album-upload">
        <li>
<!--                    <span class="txt"><?php echo __('Add Album:', 'wpdating') ?>&nbsp;</span>        -->
            <span class="upload-box dspdp-form">

                <span class="dspdp-form-group dspdp-block"><input type="text" placeholder="<?php echo __('Album name', 'wpdating') ?>" class="dspdp-form-control" name="add_album" value="<?php if (isset($dsp_updates)) echo $dsp_updates->album_name; ?>"></span>

                <span class="dspdp-form-group dspdp-block"><label class="dspdp-horiz-spacer"><?php echo __('Private:', 'wpdating') ?> <input name="private" type="checkbox" value="Y" <?php $make_private = isset($dsp_updates->private_album) ? $dsp_updates->private_album: ''; if ($make_private == 'Y') { ?> checked="checked"  <?php } ?>/> </label></span>
...
<div class="box-border">
    <div class="box-pedding">
        <div class="heading-submenu"><strong><?php echo __('List Of Albums', 'wpdating');?></strong></div>
