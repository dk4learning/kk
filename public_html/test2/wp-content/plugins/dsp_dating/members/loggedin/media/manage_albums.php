...
// Delete Album Directory.
        rmdir($directory);
        if ($get_album_id != "") {
            $Errormessge = __('Album has been deleted.', 'wpdating');
        }
    } else {
        if ($get_album_id != "") {
            $Errormessge = __('Album could not be deleted, Please Delete Photos of this Album before Deleting this Album', 'wpdating');
        }
    }
}
// IF Error then print //
        ...
        <div>  
            <form name="albumfrm" action="" method="post">
                <table cellpadding="0" cellspacing="0" border="0" width="98%">
                    <tr>
                        <th width="50%" align="left" style="padding-left:30px;" colspan="2"><?php echo __('Album', 'wpdating') ?></th>
                        <th width="20%"><?php echo __('Edit', 'wpdating') ?></th>
                        <th width="20%"><?php echo __('Delete', 'wpdating') ?></th>
                    </tr>
