...
if (($senderIds != "") && ($del_mode == "delete")) {
    for ($i = 0; $i < sizeof($senderIds); $i++) {
        ...
        $message_sent = __('Message deleted Sucessfully.', 'wpdating');
    } // End for loop
} // End if 
...
// ------------------------------------------------End Paging code------------------------------------------------------ // 
                ...
                <div class="heading-submenu"><strong><?php echo __('Delete', 'wpdating'); ?></strong></div>
                <form name="frmdelmessages" action="" method="post" class="dsp-form">
                    <div class="gray-title-head dspdp-row">
                        <div class="dspdp-col-xs-6"><div class="heading-top "><strong><?php echo __('Sender', 'wpdating') ?></strong></div></div>
                        <strong class="dspdp-col-xs-6 dspdp-text-right"><?php echo __('Subject', 'wpdating') ?></strong>
                    </div>
                ...
                // -------------------------------- END OF PRINT PAGING LINKS ------------------------------------- //
                    ...
                    <div class="btn-delete">
                        ...
                        <input type="button" class="dsp_submit_button dspdp-btn dspdp-btn-sm dspdp-btn-warning" name="delmsg" value="<?php echo __('Delete Selected', 'wpdating') ?>" onclick="delete_dsp_emails();"/></td>
                    </div>
                </form>
               <?php else: ?>
