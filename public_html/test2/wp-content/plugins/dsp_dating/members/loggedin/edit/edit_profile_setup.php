...
// ************************************ UPLOAD_IMAGE *****************************************//
                ...
                if ($image_file) {
                    ...
                    if (($extension != "jpg") && ($extension != "jpeg") && ($extension != "png") && ($extension != "gif")) {
                        ...
                        if ( ! $copied) {
                            echo '<h5>' . __('Copy unsuccessfull!', 'wpdating') . '</h5>';
                            $errors = 1;
                        } else {
                            ...
                            if ($check_approve_photos_status->setting_status == 'Y') {  // if photo approve status is Y then photos Automatically Approved.
                                ...
                                dsp_delete_news_feed($current_user->ID, 'profile_photo');
...
$please_select = __('Please Select ', 'wpdating');
$country_select = __('You forgot to select your country.', 'wpdating');
$about_me_select = __('You forgot to enter About Me.', 'wpdating');
$please_enter = __('Please enter ', 'wpdating');
    ...
    <div class="box-border">
        <div class="box-pedding">
            <div class="heading-submenu dsp-block"
                 style="display:none"><?php echo __( 'Edit Profile', 'wpdating' ); ?></div>
            ...
            <div class="dsp-box-container dsp-form-container dsp-space">
                        ...
                        <li class=" dsp-form-group dspdp-form-group">
                            ...
                            <div class="dsp-sm-6 dspdp-col-sm-6">
                                <select class="dspdp-form-control dsp-form-control" name="gender"
                                    <?php echo ( $exist_profile_details && $exist_profile_details->edited == 'Y' ) ?
                                    '' : "disabled='disabled'"; ?>>
                                    <?php echo $genderList; ?>
                                </select>
                            </div>
                ...
                <?php
                    ...
                    if ( ! empty( $genderList ) ) : ?>
                        <li class="dsp-form-group dspdp-form-group">
                                <span class="dsp-sm-3 dsp-control-label dspdp-col-sm-3 dspdp-control-label">
                                <?php echo __('Seeking a:', 'wpdating'); ?></span>
                            <div class="dsp-sm-6 dspdp-col-sm-6">
                ...
                <?php
                    ...
                    if (isset($exist_profile_details) && $exist_profile_details->age != "") {
                        ...
                        $split_age[0] = isset($month) ? $month : '';
                        $split_age[1] = isset($day) ? $day : '';
                        $split_age[2] = isset($year) ? $year : '';
                    } ?>
                        <li class="dsp-form-group dspdp-form-group">
                            ...
                            ?>
                            <div class="dspdp-col-sm-3 dsp-sm-3 dspdp-xs-form-group">
                                <select name="dsp_mon" class="dspdp-form-control dsp-form-control ">
                                    <?php foreach ( $mon as $key => $value ) : ?>
                                            <option value="<?php echo $key; ?>"
                                                <?php echo ( $split_age[0] == $key ) ? 'selected' : ''; ?>>
                                                <?php echo $value; ?>
                                            </option>
                                    <?php endforeach; ?>
                                </select>
                            </div>
                            <div class="dspdp-col-sm-1 dsp-sm-1 dspdp-xs-form-group">
                                <select name="dsp_day" class="dspdp-form-control dsp-form-control ">
                                    <?php for ( $dsp_day = 1; $dsp_day <= 31; $dsp_day++ ) : ?>
                                        <option value="<?php echo $dsp_day ?>"
                                                <?php echo ( $split_age[1] == $dsp_day ) ? 'selected' : '';?>>
                                            <?php echo $dsp_day ?>
                                        </option>
                                    <?php endfor; ?>
                                </select>
                                ...
                                <select name="dsp_year" class="dspdp-form-control dsp-form-control">
                                    ...
                                    for ( $dsp_year = $start_dsp_year; $dsp_year <= $end_dsp_year; $dsp_year++) : ?>
                                            <option value="<?php echo $dsp_year ?>"
                                                    <?php echo ( $split_age[2] == $dsp_year ) ? 'selected' : ''; ?>>
                                                <?php echo $dsp_year; ?>
                                            </option>
                                    <?php
                                    endfor; ?>
                    ...
                    <li class="dsp-form-group dspdp-form-group">
						<span
                                class="dsp-control-label dsp-sm-3 dspdp-col-sm-3 dspdp-control-label"><?php echo __('State:', 'wpdating') ?></span>
                    ...
                    <li class="dsp-form-group dspdp-form-group">
						<span
                                class="dsp-control-label dsp-sm-3 dspdp-control-label dspdp-col-sm-3 "><?php echo __('City:', 'wpdating') ?></span>
                        <!--onChange="Show_state(this.value);"-->
...
//                                    $strCities = apply_filters('dsp_get_all_States_Or_City', $selectedCountryId, true);
                                ...
                                $userCity = ( $exist_profile_details && $exist_profile_details->city_id != "" ) ?
                                    $exist_profile_details->city_id : 0;
                    ...
                    <?php if ($check_zipcode_mode->setting_status == 'Y') { ?>
                        <li class="dsp-form-group dspdp-form-group">
							<span
                                    class="dsp-control-label dsp-sm-3 dspdp-control-label dspdp-col-sm-3 "><?php echo __('Zip:', 'wpdating'); ?></span>
                            <span class="dsp-sm-6 dspdp-col-sm-6">
                                <input type="text" name="zip" class="dsp-form-control dspdp-form-control"
                                       value="<?php echo ( $exist_profile_details && $exist_profile_details->zipcode != " ") ?
                                           $exist_profile_details->zipcode : $zipcode; ?>"/>
            ...
            <div class="dsp-box-container">
                ...
                <ul>
                    ...
                    <li class="dsp-row dsp-form-group dspdp-form-group">
						<span
                                class="dsp-sm-3 dsp-control-label dspdp-control-label dspdp-col-sm-3 "><?php echo __('About Me', 'wpdating') ?>
                            :</span>
                    ...
                    <li class="dsp-row dsp-form-group dspdp-form-group">
						<span
                                class="dsp-sm-3 dsp-control-label  dspdp-control-label dspdp-col-sm-3 "><?php echo __('My Interests', 'wpdating'); ?>
                            :</span>
                        <span class="dsp-sm-6 dspdp-col-sm-9">
                    ...
                    <li class="dsp-row dsp-form-group dspdp-form-group">
						<span
                                class="dsp-sm-3 dsp-control-label  dspdp-control-label dspdp-col-sm-3 "></span>
                        <span class="dsp-sm-6 dspdp-col-sm-9">
						<input name="make_private_profile" type='checkbox' id="make_private_profile"
                               ...
                               <?php echo __('Make these profile questions private', 'wpdating'); ?> 
						</span>
                    </li>
                </ul>
            </div>
    ...
    <style>   
        @media (min-width: 768px){
         .edit-profile .dspdp-col-sm-1.dsp-sm-1.dspdp-xs-form-group {
                padding: 0;
            }
        }
    </style>
                ...
                <ul class="image-edit-profile dsp-form-container dspdp-row row">
                        ...
                        <?php if (apply_filters('dsp_is_make_private_on', '')) : ?>
                            <span>
                                <input name="private" type="checkbox"
                                       value="Y" <?php if (isset($exist_profile_details) && $exist_profile_details->make_private == 'Y') { ?> checked="checked"  <?php } ?>/>&nbsp; <?php echo __('Make your profile picture Private', 'wpdating'); ?>
                            </span>
                        <?php endif; ?>
                    </li>
                    <li class="dspdp-col-sm-4 dsp-none">
                        ...
                        <input type="submit" name="submit1" class="dsp_submit_button dspdp-btn dspdp-btn-default"
                               value="<?php _e(__('Update', 'wpdating')); ?>"/>
                    </li>
                </ul>
