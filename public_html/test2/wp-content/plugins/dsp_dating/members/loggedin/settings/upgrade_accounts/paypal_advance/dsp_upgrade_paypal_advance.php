...
//echo $postData;
            ...
            if (!$httpResponse) {
                ...
                <div class="dsp_search_result_box_out">
                    <div class="dsp_search_result_box_in">
                        <?php echo __('Please try again!', 'wpdating') ?>
            ...
            ?>
            <html>
                <head><title><?php echo __('Processing Payment...', 'wpdating') ?></title></head>
                <body onLoad="document.forms['frm1_adv'].submit();" >
                <center><h2><?php echo __('Please wait,Your membership plan is being processed and', 'wpdating') ?></body></html> <?php echo __('and', 'wpdating') ?> <br> <?php echo __('You will be redirected to the paypal website.', 'wpdating') ?></h2></center>
                <form name="frm1_adv" method="post" action="https://payflowlink.paypal.com">
                    ...
                    <center><br/><br/><?php echo __('If you are not automatically redirected to paypal within 5 seconds...', 'wpdating') ?><br/><br/>
