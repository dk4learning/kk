...
class paypal_class {
    ...
    function submit_paypal_post() {
        ...
        echo "<center><h2>'" . __('Your membership plan is being processed and you will now be redirected to PayPal.', 'wpdating') . "'</h2></center>\n";
        echo "<form method=\"post\" name=\"paypal_form\" ";
        echo "action=\"" . $this->paypal_url . "\">\n";
        foreach ($this->fields as $name => $value) {
            echo "<input type=\"hidden\" name=\"$name\" value=\"$value\"/>\n";
        }
        echo "<center><br/><br/>" . __('If you are not automatically redirected to paypal within 5 seconds...', 'wpdating');
        echo "<br/><br/>\n";
        echo "<input type=\"submit\" class=\"dsp_span_pointer  dspdp-btn dspdp-btn-default\" value=\"Click Here\"></center>\n";
    ...
    function log_ipn_results($success) {
        ...
        $text = '[' . current_time("$dateFormat $timeFormat") . '] - ';
