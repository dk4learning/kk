    ...
    if ($recurring_profile_id) {
        ...
        if (count($apiDetailsRes) > 0) {
            ...
            if ($PF_USER != "" && $PF_PWD != "") {
                ...
                if (isset($pfpro['RESULT']) && $pfpro['RESULT'] == 0) {
                    ...
                    <div class="dsp_search_result_box_out">
                        <div class="dsp_search_result_box_in">
                            ...
                            <?php echo __('Your membership is canceled successfully.', 'wpdating');  //echo '<br>'.$pfpro['RESPMSG'] ; ?>
                    ...
                    <div class="dsp_search_result_box_out">
                        <div class="dsp_search_result_box_in">
                            ...
                            <?php echo __('Sorry Your membership could not be canceled successfully.Please try later.', 'wpdating') . '<br>' . $pfpro['RESPMSG']; ?>
                ...
                <div class="dsp_search_result_box_out">
                    <div class="dsp_search_result_box_in">
                        <?php echo __('Sorry Your membership could not be canceled successfully.Please try later.', 'wpdating'); ?>
        ...
        <div class="dsp_search_result_box_out">
            <div class="dsp_search_result_box_in">
                <?php echo __('You do not have any active membership.', 'wpdating'); ?>
