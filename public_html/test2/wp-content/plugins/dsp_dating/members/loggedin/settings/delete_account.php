...
<form action="" method="post">
    <div class="btn-blue-wrap">
        <input type="submit" name="submit" onclick="alert( '<?php echo __('Are you sure you want to delete your account permanently?','wpdating'); ?>')" class="dspdp-btn dspdp-btn-danger" value="<?php echo __('Delete Account Permanently', 'wpdating') ?>"/>
    </div>
</form>
</div>
</div>