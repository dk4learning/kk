...
<div class="heading-submenu dsp-block" style="display:none"><?php echo __('Interest Cloud', 'wpdating') ?></div>
            <div class="box-border">
                    ...
                    <div class="content-search dsp-gutter-sm">
                        <form action="" method="post" class="dspdp-form-inline dspdp-spacer">
                            <div class="dsp-form-group">
                                <div align="center">
                                    <span class="dsp-sm-1 dsp-control-label"><?php echo __('Gender:', 'wpdating') ?>&nbsp;</span>
                                    <span class="dsp-sm-2">
                                        <select class="dspdp-form-control dsp-form-control" name="gender">
                                            ...
                                            <?php 
                                                $gender = ( ! empty( $gender ) ) ? $gender : ( $userProfileDetailsExist ? $userProfileDetails->gender: '' );
                                   ...
                                   &nbsp;&nbsp;
                                   <span class="dsp-sm-1 dsp-control-label"><?php echo __('to:', 'wpdating') ?> </span>
                                   <span class="dsp-sm-2">
                ...
                <?php
                $strQuery = "SELECT user_id, my_interest FROM {$dsp_user_profiles_table}";
                ...
                if ( $wpdb->num_rows > 0 ) {
                    ...
                    $interst .= "'";
                    $condition[] = "my_interest IN ($interst)";
                }

                if ($age_from >= 18) {
                    $conditions[] = "((year(CURDATE())-year(age)) > '" . $age_from . "') AND ((year(CURDATE())-year(age)) < '" . $age_to . "')";
                }
                ...
                ?>
                        ...
                        <div class="page-not-found">
                             <?php echo __('No result found !', 'wpdating'); ?>
                            <br/>
                            <br/>
