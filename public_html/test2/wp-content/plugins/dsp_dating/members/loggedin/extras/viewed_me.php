 ...
 */
?>
<div class="heading-submenu dsp-block" style="display:none"><strong><?php echo __('Viewed Me', 'wpdating'); ?></strong></div>
<?php
// ----------------------------------------------- Start Paging code------------------------------------------------------ //  
if (get('page'))
    $page = get('page');
...
// ----------------------------------------------- Start Paging code------------------------------------------------------ //
$page_name = $root_link . "extras/viewed_me/";
    ...
    <div class="box-border">
        <div class="box-pedding">  
            <div class="page-not-found">
                <?php echo __('Noone view your profile till now', 'wpdating'); ?><br /><br />
            </div>
        </div>
    </div>
    <?php
                            ...
                            <li class="dspdp-col-xs-3">
                                <div class="dsp_fav_link_border">
                                    ...
                                    if (is_user_logged_in()) {  // CHECK MEMBER LOGIN
                                        if ($check_user_profile_exist > 0) {  // check user dating profile exist or not
                                            ?>
                                            <a href='<?php echo $root_link . "view/send_wink_msg/receiver_id/" . $s_user_id . "/"; ?>' title="<?php echo __('Send Wink', 'wpdating'); ?>"><span class="fa fa-smile-o"></span></a>
                                        <?php } else { ?>
