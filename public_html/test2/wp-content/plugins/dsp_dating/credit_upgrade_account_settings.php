...
<script>
    function change_credit(val) {
        var credits_text    = "<?php echo ' ' . __( 'Credits', 'wpdating' ) ?>";
        ...
        if (jQuery.trim(val) != "") {
            ...
            <?php if (is_plugin_active('dsp_payment_addons/dsp_stripe_payment_addon.php')){ ?>
                data = {
                    action: 'stripe_ajax',
                    post_var: val
                };
            ...
            <?php if (is_plugin_active('wpdating-ccbill/wpdating-ccbill.php')){ ?>
                /**
                 * For CCBILL
                 */
                data = {
            ...
            <div class="setting-page__disable">
                <ul class="dspdp-row dsp-row dspdp-xs-text-center">
                    <li class="dspdp-col-sm-3 dsp-sm-12">
                        <div
                                class="purchase-credit-heading dspdp-text-center dspdp-spacer"><?php echo __( 'Purchase Credits', 'wpdating' ); ?></div>
                    ...
                    <li class="dspdp-col-sm-5 dsp-sm-12">
                        ...
                        <?php echo $credit_row->price_per_credit . ' Credits Per'; ?>
                    ...
                    <li class="dspdp-col-sm-4 dspdp-text-center dsp-sm-12 dsp-text-center">
                        ...
                        foreach ( $gateway_table as $gateway ) {
                            ...
                            if ( $gateway->gateway_name == 'paypal' && $gateway->status == 1 ) {
                                ...
                                <div>
                                    <form name="paymentfrm"
                                        ...
                                        <span style="font-size:13px; font-weight:bold;"
                                              class="credit_price_change"><?php echo $credit_row->price_per_credit; ?> <?php echo ' ' . language_code( 'DSP_CREDIT_MODE' ) ?></span>
                                        <br/>
                                    </form>
                                </div>
                                ...
                                <?php echo $credit_row->price_per_credit; ?><?php echo ' ' . language_code( 'DSP_CREDIT_MODE' ) ?>
                            </span>
                                </div>
