        ...
        <div class="dsp-join-searchbox">
            <div class="container">
                <div class="dsp-row wp_dating_search_form">
                    <div class="registration-wrap" onclick="closeDialogLogin()">
                        <div class="close-wrap"><img src="<?php echo WPDATE_URL . '/images/cancel.png' ?>"></div>
                        <div class="login-wrap">
                            <input class="login-btn" type="submit"
                                   value="<?php echo strtoupper( __( 'Login', 'wpdating' ) ); ?>" name="submit">
                        </div>

                        <div class="reg-wrap">
                            <input class="reg_popoup" type="submit"
                                   value="<?php echo __( 'JOIN', 'wpdating'); ?>"
                                   name="submit">
                        </div>
						<?php } ?>
						<?php if ( ! is_user_logged_in() ) { ?>
