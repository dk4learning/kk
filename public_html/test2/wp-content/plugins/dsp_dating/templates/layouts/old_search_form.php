            ...
            <div class="dspdp-row">
                <div class="dspdp-col-sm-2 dspdp-temp-nrw">
                    <div class="dspdp-form-group">
                        <span class="dspdp-control-label "><?php echo __('I am:', 'wpdating'); ?></span>
                        <div class="">
                ...
                <div class="dspdp-col-sm-2 dspdp-temp-nrw">
                    <div class="dspdp-form-group"><span class="dspdp-control-label"><?php echo __('Seeking a:', 'wpdating'); ?></span>
                        <div class="">
                        ...
                        <div class="">
                            <div class="dspdp-row">
                                <div class="dspdp-col-sm-6">
                                    <span class="dspdp-control-label"><?php echo __('Age:', 'wpdating'); ?></span>
                                ...
                                <div class="dspdp-col-sm-6">
                                    <span class="dspdp-control-label"><?php echo __('to:', 'wpdating'); ?></span>
                ...
                <?php if ($searchFormSettings != 'nn') : ?>
                    <div class="dspdp-col-sm-2 dspdp-temp-nrw">
                        <div class="dspdp-form-group"><span class="dspdp-control-label "><?php echo __('Country:', 'wpdating'); ?></span>
                            <div class="">
                    ...
                    <div class="dspdp-col-sm-2 dspdp-temp-nrw" id="searchform_username">
                        <div class="dspdp-form-group">
                            <span class="dspdp-control-label"><?php echo __('Username: ', 'wpdating'); ?></span>
                            <div  class="">
                        ...
                        <div class="dspdp-col-sm-2">
                            <div class="" style="">
                                ...
                                <a href="<?php echo $loginUrl ?>" class="dspdp-btn dspdp-btn-primary" onclick="window.open('<?php echo $loginUrl ?>', 'Authenticate', 'width=650, height=350');
                                        return false">
                                       <?php echo __('Facebook Login', 'wpdating'); ?>
                                </a>
                            </div>
                        </div>      
                    <?php } ?>
