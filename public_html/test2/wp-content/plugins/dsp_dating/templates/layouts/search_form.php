	...
	<form name="frmquicksearch" id="frmquicksearch" method="GET" action="<?php echo ROOT_LINK . 'g_search_result/' ?>">
		...
		<div class="dspdp-form-horizontal dsp-form-horizontal">
			<div class="dspdp-row dsp-row">
				...
				?>
					<div class="dspdp-col-sm-6 dspdp-col-md-12">
						<div class="dspdp-form-group">
							<span class="dspdp-control-label dspdp-col-sm-4"><?php echo __('Seeking a:', 'wpdating'); ?></span>
				...
				<div class="dspdp-col-sm-6 dspdp-col-md-12">
					<div class="dspdp-form-group">
						<span class="dspdp-control-label dspdp-col-sm-4"><?php echo __('Age:', 'wpdating'); ?></span>
						<div class="dspdp-col-sm-8">
							<div class="dspdp-row">
								...
								<div class="dspdp-col-sm-2 dspdp-control-label"><?php echo __('to:', 'wpdating'); ?></div>
								<div class="dspdp-col-sm-5">
				...
				<div class="dspdp-col-sm-6 dspdp-col-md-12">
					<?php if($isDistanceModeOn): ?>
						<div class="dspdp-form-group">
							<span class="dspdp-control-label dspdp-col-sm-4"><?php echo __('Distance', 'wpdating'); ?></span>
							<div  class="dspdp-col-sm-8">
								<input name="distance" type="text" class="dspdp-form-control" />
							</div>
						</div>
						<div class="dspdp-form-group">
							<span class="dspdp-control-label dspdp-col-sm-4"><?php echo __('Unit', 'wpdating'); ?></span>
							<div  class="dspdp-col-sm-8">
					...
					<?php endif; ?>
					<div class="dspdp-form-group">
						<span class="dspdp-control-label dspdp-col-sm-4"><?php echo __('Country:', 'wpdating'); ?></span>
						<?php $placeholder = $isDistanceModeOn ? __('PlaceipcodeCountry', 'wpdating') : __('Country:', 'wpdating'); ?>  
						<div  class="dspdp-col-sm-8">
				...
				<div class="dspdp-row dspdp-form-group">
						<div class="dspdp-col-sm-offset-4 dspdp-col-sm-8">
							<input name="submit" type="submit" class="dsp_submit_button dspdp-btn" value="<?php echo __('Search', 'wpdating'); ?>" style="background: <?php //echo $temp_color;    ?>;"/>
							<?php if (!is_user_logged_in()) { ?>
								<input class="login-btn dsp_submit_button dspdp-btn" type="button" value="<?php echo strtoupper(__('Login', 'wpdating')); ?>" style="  background: <?php //echo $temp_color;            ?>;  " />
