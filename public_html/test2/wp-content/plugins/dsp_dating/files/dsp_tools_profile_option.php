    ...
    <div id="general" class="postbox">
        ...
        <table cellpadding="6" cellspacing="0" border="0" style="padding-left:20px;">
            ...
            <tr>
                ...
                <td width="100px">&nbsp;</td>
                <td align="left"><h4><?php echo __('Order:', 'wpdating'); ?></h4></td>
                <td width="40px">&nbsp;</td>
                <td>&nbsp;</td>
            </tr>
            <?php
            ...
            foreach ($myrows as $profile_questions_options) {
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <span onclick="update_profile_question_option(<?php echo $profile_option_id ?>);" class="span_pointer"><?php echo __('edit', 'wpdating'); ?></span> /
                        <span onclick="delete_profile_question_option(<?php echo $profile_option_id ?>);" class="span_pointer"><?php echo __('Delete', 'wpdating'); ?></span>
                    </td>
                </tr>
                <?php
            }
    ...
    <FORM  name="frmaddoptions" method="post">
        <table cellpadding="0" cellspacing="0" border="0"  class="widefat">
            <tr>
                ...
                <th scope="col"><?php echo __('Option value', 'wpdating'); ?></th>
            ...
            <tr>
                ...
                <td><input type="button" name="submit1" class="button" value="<?php echo __('Add', 'wpdating'); ?>" onclick="add_profile_question_option();"/></td>
            </tr>
        </table>
    </FORM>
</div>
