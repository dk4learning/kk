        ...
        dsp(document).on('click', '#dsp_edit_gender', function() {
            ...
            dsp.ajax({
                ...
                success: function(html) {
                    ...
                    dsp('#add_text').html('<?php echo __('Update', 'wpdating'); ?>:');
                    dsp('input[name="add_new_gender"]').val('<?php echo __('Update', 'wpdating'); ?>');
...
<div style="float:left; width:100%;" id="general" class="postbox">
    <h3 class="hndle"><span><?php echo __('Gender:', 'wpdating'); ?></span></h3>
    <br />
            ...
            <div>
                <ul id="gender_list" class="gender_list">
                    ...
                    foreach ($gender_list as $gender_row) {
                        ...
                        <?php } else { ?>
                            <li id="list_<?php echo $gender_row->id; ?>"><span class="title-name"><?php echo $gender_row->gender; ?></span><span class="links-edit"><a class="edit" href="<?php echo $gender_row->id; ?>" id="dsp_edit_gender"><?php echo __('Edit', 'wpdating'); ?></a> - <a href="<?php echo $gender_row->id; ?>" id="dsp_delete_gender"><?php echo __('Delete', 'wpdating'); ?></a></span></li>
                            <?php
                        }
                    }
                    ?>
                ...
                <ul class="gender_list">
                    <li><form>
                            <div class="dsp-row"><span class="title-name" id="add_text"><?php echo __('Add', 'wpdating'); ?>:</span>
                                <input type="text" name="new_gender" value="" /><input type="submit" name="add_new_gender" value="<?php echo __('Add', 'wpdating'); ?>" />
