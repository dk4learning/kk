...
//reads the name of the file the user submitted for uploading
        ...
        if ($default_image) {
            ...
            if (($extension != "jpg") && ($extension != "jpeg") && ($extension != "png") && ($extension != "gif")) {
                $msg.=__('Unknown extension for image!', 'wpdating') . '<br>';
                $invalidEntry = 1;
                $errors = 1;
                $default_image = "";
            } else {
                ...
                if ($sizekb > MAX_SIZE * 1024) {
                    $msg.=__('Image is too large please reduce flag image below ', 'wpdating') . MAX_SIZE . DSP_USER_KB . '<br>';
                    $errors = 1;
                    $default_image = "";
                    $invalidEntry = 1;
                }
                ...
                if ($height < MIN_HEIGHT || $width < MIN_WIDTH) {
                    $msg.=__('Minimum ', 'wpdating') . MIN_HEIGHT . 'x' . MIN_WIDTH . __(' Dimension is required for image.', 'wpdating') . '<br>';
                    $errors = 1;
                    $default_image = "";
                    $invalidEntry = 1;
                }
        ...
        $msg = __('Language name already exist!', 'wpdating');
        $invalidEntry = 1;
    }
}
?>