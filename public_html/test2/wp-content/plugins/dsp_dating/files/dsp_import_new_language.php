 ...
 class DspImportNewLanguage{
 	...
 	public function createTable($languageTable){
 		...
 		if ($wpdb->get_var("show tables like '$languageTable'") == $languageTable ){
			$this->errors[] =  str_replace("<#LANGNAME#>", $this->_avialLanguagePacks[$this->_langName], __('You have to first delete <#LANGNAME#> language to import this language pack', 'wpdating'));
			return false;
		}
	...
	/**
 	...
 	public function dspView(){ 
 		...
 		<div id="general" class="postbox">
    		...
    		<h3 class="hndle"><span><?php echo __('Import Language Pack', 'wpdating'); ?></span></h3>
	 		 <form action="" method="post" enctype="multipart/form-data" id="import-lang" >
	            <table width="100%">
	                ...
	                <tr>
	                    ...
	                    <td> <?php echo __('Select language that pack needed to import', 'wpdating'); ?></td>
	                    <td>&nbsp;</td>                     
	                </tr>
	                <tr>
	                    <td><?php echo __('Language Pack', 'wpdating'); ?>:</td>
	                    <td><input id="language_pack" type="file" name="language_pack" size="18"  value="<?php echo $this->fileName;?>" accept="application/sql" /></td>
	                    <td> <?php echo __('Select language pack need to import', 'wpdating'); ?></td>
	                    <td>&nbsp;</td>   
	                </tr>
	                <tr>
	                ...
	                <tr>
	                    ...
	                    <td>
	                       ...
	                       <input type="submit" class="import"  value="<?php echo __('Import Language Pack', 'wpdating'); ?>" name="import_lang" />
	                    </td>
	                </tr>
	            </table>
	        </form>
