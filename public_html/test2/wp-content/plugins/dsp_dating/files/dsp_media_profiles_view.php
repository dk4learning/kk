...
if (isset($_FILES['edit_image']['name'])){
    ...
    //get user data using profile id
    $user = $wpdb->get_row("SELECT * FROM $dsp_user_profiles_table WHERE user_profile_id = {$get_profile_id}");
    ...
    $filename  = stripslashes($_FILES['edit_image']['name']);
    ...
    if (($extension != "jpg") && ($extension != "jpeg") && ($extension != "png") && ($extension != "gif")) {
        ...
        $size     = getimagesize($_FILES['edit_image']['tmp_name']);
        $sizekb   = filesize($_FILES['edit_image']['tmp_name']);
        $img_name = basename($image_name);
        $new_name = $user_id . '_'. $img_name;
        $newname1 = ABSPATH . "wp-content/uploads/dsp_media/user_photos/user_" . $user_id . "/" . $new_name;
        $copied  = copy($_FILES['edit_image']['tmp_name'], $newname1);

        if ( ! $copied) {
            echo '<h3>' . __('Copy unsuccessfull!', 'wpdating') . '</h3>';
        } else {
            //get user image to replace it
            $dsp_members_photos = $wpdb->prefix . DSP_MEMBERS_PHOTOS_TABLE;
            ...
            if ("" != $old_img) {
                $wpdb->update($dsp_members_photos, array('picture' => $new_name), array('user_id' => $user_id));
                unlink($del_img_path);
                unlink($del_thumb_img_path);
                unlink($del_thumb1_img_path);
            }else{
                $wpdb->insert($dsp_members_photos, array(
                        'user_id' => $user_id,
                        'picture' => $new_name,
                        'status_id'  => 1
                ));
...
//$wpdb->query("UPDATE $dsp_user_partner_profiles_table SET country_id = $country_id,state_id=$state_id,city_id = $city_id ,gender = '$gender',seeking = '$seeking',zipcode = '$zipcode',age='$age',status_id='$status_id',reason_for_status='$reason_for_status',last_update_date='$last_update_date',about_me='$aboutme' , my_interest='$my_interest' WHERE user_id  = '$uid'");
            ...
            if ($status_id == 1) {
                dsp_delete_news_feed($uid,'status');
...
// ************************************************************************************************//
        ...
        $_SESSION['message'] = __('Your profile has been updated!', 'wpdating') ;
    } // End if(!isset($hasError))
}   // End if isset(submit) condition
if (isset($profile_updated) && $profile_updated == true) {
    ?>
    <div id="message" class="updated fade"><strong><?php echo __('Your profile has been updated!', 'wpdating'); ?></strong></div>
<?php } ?>
...
<div><a href="<?php echo $_SERVER['HTTP_REFERER'];?>"><?php echo __('Back', 'wpdating'); ?></a></div>
                            ...
                            <table cellpadding="0" cellspacing="0" border="0" width="100%">
                                ...
                                <tr><td>
                                        <div id="general" class="postbox" >
                                            <h3 class="hndle"><span><?php echo __('General', 'wpdating') ?></span></h3>
                                                    ...
                                                    <td>
                                                        <table border="0" cellspacing="1" cellpadding="0" style="margin:15px;" >
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td class="media-head"><?php echo __('Gender:', 'wpdating') ?></td>
                                                                ...
                                                                <td>
                                                                    ...
                                                                    </select>       </td><td><?php echo __('Seeking:', 'wpdating') ?></td>
...
<!--                                                                    --><?php //echo $Mem_Image_path; ?>
                                                                    ...
                                                                    <div onclick="delete_images('<?php echo $exist_profile_details->user_id ?>')" class="span_pointer col-4" style="font-size:12px; margin-left: 55px; text-align: center">delete</div>

                                                                    <div onclick="edit_image()" class="span_pointer col-4" style="font-size:12px; margin-left: 55px; text-align: center">edit</div>

                                                                </td>
                                                                <td rowspan="6" valign="top">
                                                                    <div class="dsp-status-update"><b><?php echo __('Current Status', 'wpdating'); ?></b> <span><b><?php echo stripslashes($exist_profile_details->my_status); ?></b></span></div>
                                                                </td>
                                                            </tr>
                                                            ...
                                                            <tr>
                                                                <td>    <?php echo __('Date of Birth:', 'wpdating'); ?>    </td>
                                                                <td colspan="3">
...
//array to store the months
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td><?php echo __('Country:', 'wpdating') ?></td>
...
<!--<select name="cmbCountry" id="cmbCountry_id1" style="width:190px;">-->
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td><?php echo __('State:', 'wpdating'); ?></td>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td><?php echo __('City:', 'wpdating') ?></td>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td><?php echo __('Zip:', 'wpdating') ?></td>
                                ...
                                <tr><td>
                                        <div id="general" class="postbox" >
                                            <h3 class="hndle"><span><?php echo __('Profile Questions', 'wpdating') ?></span></h3>
                                            <table width="100%" border="0" cellspacing="0" cellpadding="3" style="padding-left:20px;">
                                                ...
                                                <tr>
                                                    <td align="left"><?php echo __('My Interests', 'wpdating'); ?></td>
                                                ...
                                                <tr>
                                                    <td align="left"><?php echo __('Make this profile questions private', 'wpdating'); ?></td>
                                            ...
                                            <?php if (@$_GET['Action'] != 'partner') { ?>   
                                                ...
                                                <table width="100%" border="0" cellspacing="0" cellpadding="3" style="padding-left:20px;">
                                                    ...
                                                    <tr><td colspan="4" class="submit" align="center"><input type="hidden" name="profilemode"  value="update"/>
                                                            <input type="submit" name="submit1" value="<?php echo __('Submit', 'wpdating') ?>" />
                                                        </td></tr>
                                                </table>
                                            <?php } ?>
                                        </div>
            ...
            <form action="" method="POST" id="myForm" enctype="multipart/form-data" >
                <input type="file" name="edit_image" id="edit_image" class="edit_image" style="display: none"/>
                <input type="submit" name="dsp_submit" id="dsp_submit" style="display: none">
            </form>
        </td></tr>
</td></tr>
</table>
...
<script>
  ...
  jQuery("#cmbCountry_id").change(function() {
    ...
    jQuery("#cmbState_id").change(function() {
  ...
  function edit_image() {
      if (confirm("Are you sure you want to edit this Image?")) {
          jQuery('.edit_image').focus().trigger('click');
      }
  } // End edit_images()

  jQuery(document).ready(function ($) {
      $('.edit_image').change(function(e){
          document.getElementById("dsp_submit").click();
      });
  });
</script>