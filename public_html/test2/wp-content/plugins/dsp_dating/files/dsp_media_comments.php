...
// -------------------------------- END OF PRINT PAGING LINKS ------------------------------------- //
                    ...
                    <td  align="right">
                        <select name="action_status_id">
                            ...
                            <option value="1"><?php echo __('Approve', 'wpdating') ?></option>
                            <option value="2"><?php echo __('Delete', 'wpdating') ?></option>
                        </select>
                    </td></tr>
                <tr><td colspan="2" align="right">
                        <input class="button" type="submit" name="submit" value="<?php echo __('Update', 'wpdating') ?>" style="float:right; margin-top:7px;" /></td>
                </tr>
                </form>
            </table>
        </td></tr>
