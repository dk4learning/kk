    ...
    <div id="navmenu" align="left">
        ...
        <ul>
            ...
            <li <?php if (($pageURL == "media_profiles") || ($pageURL == "")) { ?>class="dsp_tab1-active" <?php } else { ?> class="dsp_tab1"<?php } ?>>
                ...
                <a href="<?php echo $root_link ?>/wp-admin/admin.php?page=dsp-admin-sub-page2&pid=media_profiles" title="<?php echo __('Profiles', 'wpdating') ?>">

                    <?php echo __('Profiles', 'wpdating') ?></a><span class="dsp_tab1_span">|</span></li>

            <li <?php if ($pageURL == "gallery_photos") { ?>class="dsp_tab1-active" <?php } else { ?> class="dsp_tab1"<?php } ?>>

                <a href="<?php echo $root_link ?>/wp-admin/admin.php?page=dsp-admin-sub-page2&pid=gallery_photos&status=0" title="<?php echo __('Galleries Photos', 'wpdating') ?>">

                    <?php echo __('Galleries Photos', 'wpdating') ?></a><span class="dsp_tab1_span">|</span></li>

            <li <?php if ($pageURL == "Profile_photos") { ?>class="dsp_tab1-active" <?php } else { ?> class="dsp_tab1"<?php } ?>>

                <a href="<?php echo $root_link ?>/wp-admin/admin.php?page=dsp-admin-sub-page2&pid=Profile_photos&status=0" title="<?php echo __('Members Photos', 'wpdating') ?>"><?php echo __('Members Photos', 'wpdating') ?></a><span class="dsp_tab1_span">|</span></li>

            <li <?php if ($pageURL == "partner_profile_photos") { ?>class="dsp_tab1-active" <?php } else { ?> class="dsp_tab1"<?php } ?>>

                <a href="<?php echo $root_link ?>/wp-admin/admin.php?page=dsp-admin-sub-page2&pid=partner_profile_photos&status=0" title="<?php echo __('Partners Members Photos', 'wpdating') ?>"><?php echo __('Partners Members Photos', 'wpdating') ?></a><span class="dsp_tab1_span">|</span></li>

            <li <?php if ($pageURL == "media_audios") { ?>class="dsp_tab1-active" <?php } else { ?> class="dsp_tab1"<?php } ?>>

                <a href="<?php echo $root_link ?>/wp-admin/admin.php?page=dsp-admin-sub-page2&pid=media_audios" title="<?php echo __('Audios', 'wpdating') ?>">

                    <?php echo __('Audios', 'wpdating') ?></a><span class="dsp_tab1_span">|</span></li>

            <li <?php if ($pageURL == "media_comments") { ?>class="dsp_tab1-active" <?php } else { ?> class="dsp_tab1"<?php } ?>>

                <a href="<?php echo $root_link ?>/wp-admin/admin.php?page=dsp-admin-sub-page2&pid=media_comments" title="<?php echo __('Comments', 'wpdating') ?>">

                    <?php echo __('Comments', 'wpdating') ?></a><span class="dsp_tab1_span">|</span></li>

            <li <?php if ($pageURL == "media_videos") { ?>class="dsp_tab1-active" <?php } else { ?> class="dsp_tab1"<?php } ?>>

                <a href="<?php echo $root_link ?>/wp-admin/admin.php?page=dsp-admin-sub-page2&pid=media_videos" title="<?php echo __('Videos', 'wpdating') ?>">

                    <?php echo __('Videos', 'wpdating') ?></a><span class="dsp_tab1_span">|</span></li>

            <li  <?php if ($pageURL == "admin_mails") { ?>class="dsp_tab1-active" <?php } else { ?> class="dsp_tab1"<?php } ?>>

                <a href="<?php echo $root_link ?>/wp-admin/admin.php?page=dsp-admin-sub-page2&pid=admin_mails" title="<?php echo __('Emails', 'wpdating') ?>">

                    <?php echo __('Emails', 'wpdating') ?></a><span class="dsp_tab1_span">|</span></li>

            <li  <?php if ($pageURL == "admin_blogs") { ?>class="dsp_tab1-active" <?php } else { ?> class="dsp_tab1"<?php } ?>>
                <a href="<?php echo $root_link ?>/wp-admin/admin.php?page=dsp-admin-sub-page2&pid=admin_blogs" title="<?php echo __('Blogs', 'wpdating') ?>">
                    <?php echo __('Blogs', 'wpdating') ?>
                </a>
                <span class="dsp_tab1_span">|</span>
            </li>
            <li  <?php if ($pageURL == "template_images") { ?>class="dsp_tab1-active" <?php } else { ?> class="dsp_tab1"<?php } ?>>
                <a href="<?php echo $root_link ?>/wp-admin/admin.php?page=dsp-admin-sub-page2&pid=template_images" title="<?php echo __('Template Images', 'wpdating') ?>">
                    <?php echo __('Template Images', 'wpdating') ?>
                </a>
            </li>
...
}else if ($pageURL == "partner_profile_photos") {

    include_once( WP_DSP_ABSPATH . 'files/includes/dsp_media_partner_member_subheader.php');
}
else {
