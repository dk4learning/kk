            ...
            <div id="navmenu" align="left">
                <ul>
                    <li <?php if (($profiles_page_url == "search") && ($pageURL == "tools_language")) { ?>class="dsp_tab1-active" <?php } else { ?> class="dsp_tab1"<?php } ?>>
                        <a href="admin.php?page=dsp-admin-sub-page3&pid=tools_language&dsp_page=search"><?php echo __('Search', 'wpdating'); ?></a><span class="dsp_tab1_span">|</span></li>
                    <li <?php if (($profiles_page_url == "add_text")) { ?>class="dsp_tab1-active" <?php } else { ?> class="dsp_tab1"<?php } ?>>
                        <a href="admin.php?page=dsp-admin-sub-page3&pid=tools_language&dsp_page=add_text"><?php echo __('Add Text', 'wpdating'); ?></a><span class="dsp_tab1_span">|</span></li>
                    <li <?php if (($profiles_page_url == "add_language")) { ?>class="dsp_tab1-active" <?php } else { ?> class="dsp_tab1"<?php } ?>>
                        <a href="admin.php?page=dsp-admin-sub-page3&pid=tools_language&dsp_page=add_language"><?php echo __('Add Language', 'wpdating'); ?></a> |</li>
                    <li <?php if (($profiles_page_url == "import_language")) { ?>class="dsp_tab1-active" <?php } else { ?> class="dsp_tab1"<?php } ?>>
                    <a href="admin.php?page=dsp-admin-sub-page3&pid=tools_language&dsp_page=import_language_file"><?php echo __('Import Language Pack', 'wpdating'); ?></a></li>
                </ul>
            </div>
        </td></tr>
</table>
