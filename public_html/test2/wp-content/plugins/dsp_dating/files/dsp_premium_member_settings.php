...
<div>
    <div id="general" class="postbox">
        <h3 class="hndle"><span><?php echo __('Search Premium Members', 'wpdating'); ?></span></h3>
...
//$user_profiles_table = $wpdb->get_results("SELECT pay_user_id ,DATEDIFF(expiration_date,CURDATE()) as days FROM wp_dsp_payments ");
    ...
    <div>
        <div id="general" class="postbox" >
            <h3 class="hndle"><span><?php echo __('Grant Premium Membership', 'wpdating'); ?></span></h3>
            <div style="height:20px;"></div>
                            ...
                            ?>" >
                                <table width="100%" border="0"  style="border-bottom:1px solid #EEEEEE; border-top:1px solid #EEEEEE; padding-top:5px; padding-bottom:5px; margin-bottom:-1px;">
                                    <tr >
                                        ...
                                        <td style="width:20%;"><input name="days" type="text"  style="width:100%"  onclick="this.value"  placeholder="<?php echo __('Number of Days', 'wpdating'); ?>" /></td>
