...
if (isset($dsp_mode) && $dsp_mode == 'add') {
    ...
    echo __('New Gateways Updated!!!!', 'wpdating');

?>
<div id="general" class="postbox" >
    <h3 class="hndle">
        <span><?php echo __('Gateways', 'wpdating'); ?></span>
    </h3>
        ...
        <tr>
            <td class="form-field form-required" style="padding-left:20px;"> 
                <form name="admin.php?page=dsp-admin-sub-page1&pid=gateways_settings" method="post">
                    <?php echo __('Select Payment Gateway', 'wpdating') ?><span style=" margin-left:105px;">
                ...
                <form name="" method="post">
                    <table cellpadding="0" cellspacing="0" border="0" class="dsp_thumbnails1">
                        ...
                        if (isset($_REQUEST['payment_method']) && $_REQUEST['payment_method'] == 'paypal') {
                            ...
                            <tr valign="top">
                                <td width="27%" scope="row" class="form-field form-required"><label for="gatewayaddress"><?php _e(__('Paypal Address', 'wpdating')) ?></label></td>
                            ...
                            <tr valign="top">
                                ...
                                <td width="27%" scope="row" class="form-field form-required"><label for="gatewayapiuname"><?php echo __('API User Name', 'wpdating') . ' (' . __('for mobile app', 'wpdating') . ')' ?></label></td>
                            ...
                            <tr valign="top">
                                ...
                                <td scope="row" class="form-field form-required"><label for="gatewayaddress"><?php echo __('API Password', 'wpdating') . ' (' . __('for mobile app', 'wpdating') . ')' ?></label></td>
                            ...
                            <tr valign="top">
                                ...
                                <td scope="row" class="form-field form-required"><label for="gatewayapisignature"><?php echo __('API Signature', 'wpdating') . ' (' . __('for mobile app', 'wpdating') . ')' ?></label></td>
                            ...
                            <tr valign="top">
                                ...
                                <td scope="row" class="form-field form-required"><label for="gatewayaddress"><?php echo __('Client Id', 'wpdating') . ' (' . __('for mobile app', 'wpdating') . ')' ?></label></td>
                            ...
                            <tr valign="top">
                                ...
                                <td scope="row" class="form-field form-required"><label for="gatewayapisignature"><?php echo __('Secret', 'wpdating') . ' (' . __('for mobile app', 'wpdating') . ')' ?></label></td>
                        ...
                        <?php } else if (isset($_REQUEST['payment_method']) && $_REQUEST['payment_method'] == 'authorize') { ?>
                            ...
                            <tr><td><br></td></tr>
                            <tr valign="top">
                                <td width="27%" scope="row" class="form-field form-required"><label for="gatewayaddress"><?php echo __('Login ID', 'wpdating') ?></label></td>
                                <td><input type="text" name="login_id" value="<?php echo $gateway_rows->login_id; ?>" class="regular-text"  /></td>
                            </tr>
                            <tr valign="top">
                                <td scope="row" class="form-field form-required"><label for="gatewayaddress"><?php echo __('Transaction ID', 'wpdating') ?></label></td>
                                <td><input type="text" name="transaction_id" value="<?php echo $gateway_rows->transaction_id; ?>" class="regular-text"  /></td>
                            </tr>
                            <tr valign="top">
                                <td scope="row" class="form-field form-required"><label for="gatewayaddress"><?php echo __('MD5 Hash', 'wpdating') ?></label></td>
                        ...
                        <?php } else if (isset($_REQUEST['payment_method']) && $_REQUEST['payment_method'] == 'paypal pro') {
                            ?>
                            <tr valign="top">
                                <td width="27%" scope="row" class="form-field form-required"><label for="gatewayapiuname"><?php echo __('API User Name', 'wpdating') ?></label></td>
                                <td><input type="text" name="api_uname" value="<?php echo $gateway_rows->pro_api_username; ?>" class="regular-text"  /></td>
                            </tr>
                            <tr valign="top">
                                <td scope="row" class="form-field form-required"><label for="gatewayaddress"><?php echo __('API Password', 'wpdating') ?></label></td>
                                <td><input type="text" name="api_password" value="<?php echo $gateway_rows->pro_api_password; ?>" class="regular-text"  /></td>
                            </tr>
                            <tr valign="top">
                                <td scope="row" class="form-field form-required"><label for="gatewayapisignature"><?php echo __('API Signature', 'wpdating') ?></label></td>
                        ...
                        <?php } else if (isset($_REQUEST['payment_method']) && $_REQUEST['payment_method'] == 'paypal advance') {
                            ...
                            <tr  valign="top">
                                <td scope="row" colspan="2" style="color: red;">
                                    <?php echo __('This gateway will provide recurring billing with paypal advance.', 'wpdating'); ?>
                                </td>
                            </tr>
                            <tr  valign="top">
                                <td scope="row" colspan="2" style="color: red;">&nbsp;
                            ...
                            <tr valign="top">
                                <td width="27%" scope="row" class="form-field form-required"><label for="gatewayapiuname"><?php echo __('Paypal Advance User Name', 'wpdating') ?></label></td>
                                <td><input type="text" name="adv_username" value="<?php echo $gateway_rows->paypal_adv_username; ?>" class="regular-text"  /></td>
                            </tr>
                            <tr valign="top">
                                <td scope="row" class="form-field form-required"><label for="gatewayaddress"><?php echo __('Paypal Advance Password', 'wpdating') ?></label></td>
                        ...
                        <?php } else if (isset($_REQUEST['payment_method']) && $_REQUEST['payment_method'] == 'iDEAL') { ?>
                            ...
                            <tr valign="top">
                                <td scope="row" class="form-field form-required"><label for="gatewayaddress"><?php echo __('Layout Number', 'wpdating') ?></label></td>
                                <td><input type="text" name="rtlo" value="<?php echo $gateway_rows->rtlo; ?>" class="regular-text"  /></td>
                            </tr>
                            <tr valign="top">
                                <td scope="row" class="form-field form-required"><label for="gatewayaddress"><?php echo __('Bank List Language', 'wpdating') ?></label></td>
                        ...
                        ?>
                            ...
                            <tr  valign="top">
                                <td scope="row">
                                    <?php echo __('Instruction', 'wpdating'); ?>
                                </td>
                        ...
                        <?php } ?>
                        <tr valign="top">
                            <td scope="row" class="form-field form-required"><label for="gatewayaddress"><?php _e(__('Currency', 'wpdating')) ?></label></td>
                            <td><input type="text" name="currency" value="<?php echo $gateway_rows->currency; ?>" class="regular-text"  /></td>
                        </tr>
                        <tr valign="top">
                            <td scope="row" class="form-field form-required"><label for="gatewayaddress"><?php _e(__('Currency Symbol', 'wpdating')) ?></label></td>
                            <td><input type="text" name="currency_symbol" value="<?php echo $gateway_rows->currency_symbol; ?>" maxlength="2" class="regular-text"  /></td>
                        </tr>
                        <tr valign="top">
                            <td scope="row" class="form-field form-required"><label for="gatewayaddress"><?php _e(__('Active', 'wpdating')) ?></label></td>
