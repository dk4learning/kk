...
<div>
    <div id="general" class="postbox" >
        <h3 class="hndle"><span><?php echo __('Search Users', 'wpdating'); ?></span></h3>
        <div style="height:20px;"></div>
        <div class="dsp_thumbnails1" >
            <div style="width:320px;">
                <div style="width:95px; font-weight:bold; letter-spacing:0.5px; float:left;"><?php echo __('Username/IP', 'wpdating'); ?></div>
                <form name="search" method="post"  action="">
                    <div style="float:none;" >
                        <input style="float:left; margin-right:20px;" name="nameorip" type="text" />
                        &nbsp;
                        <input name="search" type="submit" value="<?php echo __('Search', 'wpdating'); ?>"  class="button"  /></div>
                </form>
            </div>
            <div>
                <div style="height:20px;"></div>
    ...
    <div>
        <div id="general" class="postbox">
            <h3 class="hndle"><span><?php echo __('Add IP to blacklist', 'wpdating'); ?></span></h3>
            <div style="height:20px;"></div>
            <div class="dsp_thumbnails1" >
                <div style="width:320px;">
                    <div>
                        ...
                        <form name="ipblacklist" method="post"  action="">
                            <input style="float:left; margin-right:20px;" name="ipaddress" type="text" />&nbsp;<input  class="button"  name="addip" type="submit" value="<?php echo __('Add', 'wpdating'); ?>" />
                        </form>
                    </div>
                </div>
            </div>
        ...
        <div>
            <div id="general" class="postbox">
                <h3 class="hndle"><span><?php echo __("Blacklisted IP's", 'wpdating'); ?></span></h3>
                <div style="height:20px;"></div>
                <div class="dsp_thumbnails1" >
                    <div style="width:320px;">
                        <table width="450" border="0" cellpadding="6">
                            <tr>
                                <th align="left" width="30%"><?php echo __('Users', 'wpdating'); ?></th>
                                <th align="left" width="30%"><?php echo __('IP Address', 'wpdating'); ?></th>
                                <th align="left" ><?php echo __('Status', 'wpdating'); ?></th>
                                <th align="left" ><?php echo __('Actions', 'wpdating'); ?></th>
