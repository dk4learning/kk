...
switch ($dsp_action) {
    case 'add':    // ADD PROFILE QUESTION
        if (!empty($profile_question) && $cmbfieldtype != '') {
            ...
            <div class="updated">
                <p>
                    <strong><?php echo __('New profile Question added!', 'wpdating'); ?></strong>
                </p>
            </div>
        <?php
    ...
    case 'update':    // UPDATE PROFILE QUESTION
        ...
        <div class="updated">
            <p>
                <strong><?php echo __('Profile Question updated!', 'wpdating'); ?></strong>
            </p>
        </div>
        <?php
        break;
...
//##################################################################################################### //
?>
<!--<div class="profile_headind" ><?php echo __('Profile Setup', 'wpdating'); ?></div>-->
<div style="height:8px;"></div>
<!-- ************************************* EXISTING PROFILE QUESTIONS LIST **************************************** -->
<div>
    <div id="general" class="postbox">
        <h3 class="hndle"><span><?php echo __('Existing Profile Questions:', 'wpdating'); ?></span></h3>
        <table cellpadding="6" cellspacing="0" border="0" style="padding-left:20px;">
            ...
            <tr>
                ...
                <td width="100px">&nbsp;</td>
                <td><h4><?php echo __('Type:', 'wpdating'); ?></h4></td>
                <td width="40px">&nbsp;</td>
            ...
            foreach ($myrows as $profile_questions) {
                ...
                ?>
                <tr>
                    <?php /* ?><?php if($profile_ques_type->field_id==__('2', 'wpdating')) { ?>
                    ...
                    <td>
                        ...
                        <span onclick="update_profile_question(<?php echo $profile_que_id ?>);"
                              class="span_pointer"><?php echo __('edit', 'wpdating'); ?></span> /
                        <span onclick="delete_profile_question(<?php echo $profile_que_id ?>);"
                              class="span_pointer"><?php echo __('Delete', 'wpdating'); ?></span>
                    </td>
                </tr>
            <?php
            }
...
<div class="profile_headind"><?php echo __('Add New Profile Question:', 'wpdating'); ?></div>
<div style="height:8px;"></div>
<div>
    <?php
    ...
    <form name="frmaddquestions" method="post">
        <table cellpadding="0" cellspacing="0" border="0" width="100%" class="widefat">
            <tr>
                <th scope="col"><?php echo __('Question', 'wpdating'); ?></th>
                <th scope="col"><?php echo __('Type:', 'wpdating'); ?></th>
                <th scope="col"><?php echo __('Order:', 'wpdating'); ?></th>
                <th scope="col"><?php echo __('Max Char:', 'wpdating'); ?></th>
                <th scope="col"><?php echo __('Required:', 'wpdating'); ?></th>
                <th scope="col"><?php echo __('Show Into Advanced Search', 'wpdating'); ?></th>
            </tr>
            <tr>
                ...
                <td><input type="button" name="submit1" class="button"
                           value="<?php echo __('Add Profile Question:', 'wpdating'); ?>"
