...
<div id="general" class="postbox">
    <h3 class="hndle"><span><?php echo __('Bank & Cheque Users', 'wpdating') ?></span></h3>
        ...
        <table class="wp-list-table widefat fixed users" border="0" width="100%">
        	<thead>    
                    <tr>     
                        ...
                        <th><strong><?php _e(__('Username: ', 'wpdating')); ?></strong></th>
                        <th><strong><?php _e(__('Plan Name', 'wpdating')); ?></strong></th>
                        <th><strong><?php _e(__('Plan Amount', 'wpdating')); ?></strong></th>
                        <th><strong><?php _e(__('Plan Days', 'wpdating')); ?></strong></th>
                        <th><strong><?php _e(__('Status', 'wpdating')); ?></strong></th>
                        <th><strong><?php _e(__('Expiration Date', 'wpdating')); ?></strong></th>
        	...
        	<tbody>
    			<?php foreach ($chequeBankwireUsers as  $userDetails): ?>
    				<tr>
	        			...
	        			<td>
	        				<?php 
	        					$status = $userDetails['payment_status']== 0 ? __('Processing Payment...', 'wpdating') : __('Completed', 'wpdating'); 
