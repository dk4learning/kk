...
<div>
    ...
    <div id="general" class="postbox">
        <h3 class="hndle"><span><?php echo __('Profile Generator', 'wpdating') ?></span></h3>
        <form name="frm_u_profile" action="" method="post" enctype="multipart/form-data" onsubmit="return dsp_profile_validation();
            ...
            <table cellpadding="3" cellspacing="0" border="0" style="padding-left:20px; padding-top:10px; width:930px;">	
                ...
                <tr class="profile-td">	
                    ...
                    <td style="width:120px; text-align:right;"><?php echo __('Country:', 'wpdating') ?></td>	
                ...
                <tr class="profile-td">	
                    ...
                    <td style="text-align:right;"><?php echo __('State:', 'wpdating') ?></td>	
                ...
                <tr>		
                    ...
                    <td style="text-align:right;"><?php echo __('City:', 'wpdating') ?></td>		
                ...
                <!-- End city combo-->
                <tr>
                    <td style="text-align:right;"><?php echo __('Gender', 'wpdating') ?>:</td>
                    <?php 
                ...
                <tr>
                    <td style="text-align:right;"><?php echo __('Seeking:', 'wpdating') ?></td>
                    <?php 
                ...
                <tr>
                    <td  style="text-align:right;"><?php echo __('Age Range', 'wpdating'); ?>:</td>
                    <td>
                ...
                <tr>
                    ...
                    <td  style="text-align:right;"><?php echo __('Add About Me', 'wpdating'); ?>:</td>
                ...
                <tr>
                    ...
                    <td  style="text-align:right;"><?php echo __('Add My Match', 'wpdating'); ?>:</td>
                ...
                <tr>
                    ...
                    <td  style="text-align:right;"><?php echo __('Images', 'wpdating'); ?>:</td>
                ...
                <tr>
                    ...
                    <td  style="text-align:right;"><?php echo __('Number of Interests', 'wpdating'); ?>:</td>
                                    ...
                                    <td>
                                        ...
                                        <?php if ($profile_ques_type_id == 1) { ?>
                                            ...
                                            <div style="float:right; width:100px; margin-right:55px; margin-left:20px; margin-top:8px;">
                                                ...
                                                <input type="checkbox" id="random_option_i_<?php echo $ques_id; ?>" name="random_option_id[<?php echo $ques_id; ?>]" value="<?php echo $ques_id; ?>" style="width:35px;" onClick="chkrandom(<?php echo $ques_id ?>)" /><?php echo __('Random', 'wpdating'); ?>
                ...
                <tr>
                    ...
                    <td colspan="2" align="right"  style="padding-right:75px;"><input type="submit" name="submit" value="<?php echo __('Generate', 'wpdating'); ?>" /></td>
        ...
        //Get the IP of the person registering
            ...
            if ($check_blacklist_ipaddress_table <= 0) {
                ...
                if(is_plugin_active('admin_message_reply/admin_message_reply.php')){
                    $wpdb->query("UPDATE $dsp_users_table SET fake_key = 1 WHERE ID = '{$user_id}'");
                }
...
//print_r($file_type);
                        ...
                        if ($files !== "." && $files !== ".." && in_array($file_type, $file_display) == true) {
                            ...
                            if ($exist_user_photo <= 0) {
                                ...
                                $member_photos = "INSERT INTO $dsp_members_photos_table SET user_id=%d ,picture='$files', status_id=1";

                                $wpdb->query($wpdb->prepare($member_photos,$user_id));
                            }
                        }
                    }
        ...
        foreach ($get_data as $text) {
            ...
            if ($check_blacklist_ipaddress_table <= 0) {
                ...
                if ($images == 'checked') {
                    ...
                    if (file_exists($dir) && is_dir($dir) == false) { 
                        //echo "directory not found";
                    } else {
