...
<div id="general" class="postbox">
    <h3 class="hndle"><span><?php echo __('Quick Stats', 'wpdating') ?></span></h3>
                ...
                <td>
                    <table width="500" border="0" cellspacing="0" cellpadding="2" style="padding-top:20x">
                        ...
                        <tr>
                            ...
                            <td style="font-weight:bold;"><?php echo __('Members Photos', 'wpdating') ?></td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td style="font-weight:bold;"><?php echo __('Galleries', 'wpdating') ?></td>
                        </tr> 
                        ...
                        <tr>
                            ...
                            <td style="font-weight:bold;"><?php echo __('Audios', 'wpdating') ?></td>
                        </tr> 
                        ...
                        <tr>
                            ...
                            <td style="font-weight:bold;"><?php echo __('Videos', 'wpdating') ?></td>
                        </tr> 
                        ...
                        <tr>
                            ...
                            <td style="font-weight:bold;"><?php echo __('Emails', 'wpdating') ?></td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td style="font-weight:bold;"><?php echo __('Total Intrest', 'wpdating') ?></td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td style="font-weight:bold;"><?php echo __('Registered Users', 'wpdating') ?></td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td style="font-weight:bold;"><?php echo __('Profiles', 'wpdating') ?></td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td style="font-weight:bold;"><?php echo __('Dates Tracked', 'wpdating') ?></td>
                        </tr>
                    </table>
                </td>
            </tr>
