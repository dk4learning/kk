                        ...
                        foreach ($myrows as $fivesimage) {
                            ...
                            if ($list_status == 0) {
                                ...
                                <td align="left" class="thumbnails-bg">
                                    <table cellpadding="0" border="0">
                                        <tr><td align="center" colspan="3"><a class="group1" href="<?php echo $image_path ?>"><img src="<?php echo $image_path ?>" alt="no image" title="<?php echo $photo_username; ?>"  width="100px" /></a></td></tr>
                                        <tr>
                                            <td><span onclick="approve_images('<?php echo $gal_image_id ?>')" class="span_pointer" style="font-size:12px;"><?php echo __('Approve', 'wpdating') ?></span>|</td>
                                            <td><span onclick="reject_images('<?php echo $gal_image_id ?>')" class="span_pointer" style="font-size:12px;"><?php echo __('Reject', 'wpdating') ?></span>|</td>
                                            <td><span onclick="delete_images('<?php echo $gal_image_id ?>')" class="span_pointer" style="font-size:12px;"><?php echo __('Delete', 'wpdating'); ?></span></td></tr>
                                    </table>
                                </td>
                                <?php
                            ...
                            if ($list_status == 2) {
                                ...
                                <td class="thumbnails-bg">
                                    <table cellpadding="0" border="0">
                                        <tr><td align="center" colspan="2"><a class="group1" href="<?php echo $image_path ?>"><img src="<?php echo $image_path ?>" alt="no image" title="<?php echo $photo_username; ?>"  width="100px" /></a></td></tr>
                                        <tr>
                                            <td><span onclick="approve_images('<?php echo $gal_image_id ?>')" class="span_pointer" style="font-size:12px;"><?php echo __('Approve', 'wpdating') ?></span>|</td>
                                            <td><span onclick="delete_images('<?php echo $gal_image_id ?>')" class="span_pointer" style="font-size:12px;"><?php echo __('Delete', 'wpdating'); ?></span></td></tr>
                                    </table>
                            ...
                            if ($list_status == 1) {
                                ...
                                <td class="thumbnails-bg">
                                    <table cellpadding="0" border="0">
                                        <tr><td align="center" colspan="2"><a class="group1" href="<?php echo $image_path ?>"><img src="<?php echo $image_path ?>" alt="no image" title="<?php echo $photo_username; ?>"  width="100px" /></a></td></tr>
                                        <tr>
                                            <td><span onclick="delete_approve_images('<?php echo $gal_photo_id ?>')" class="span_pointer" style="font-size:12px;margin-left:22px; text-decoration:none;"><input name="<?php echo __('Delete', 'wpdating'); ?>" type="button" value="<?php echo __('Delete', 'wpdating'); ?>" class="button" /></span></td>
                                        </tr>
                                    </table>
                                </td>
                                <?php
...
// -------------------------------- END OF PRINT PAGING LINKS ------------------------------------- //
    ...
    <tr><td>
            <?php if ($_GET['status'] == 1) { ?>	
                ...
                </style><div id="general" class="postbox" >
