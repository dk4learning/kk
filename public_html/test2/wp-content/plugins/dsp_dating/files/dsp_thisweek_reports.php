...
<div id="general" class="postbox">
    ...
    <h3 class="hndle"><span><?php echo __('This Week', 'wpdating') ?></span></h3>
...
<?php
$array = array(__('Mon', 'wpdating') => 'Mon', __('Tue', 'wpdating') => 'Tue',
    __('Wed', 'wpdating') => 'Wed', __('Thu', 'wpdating') => 'Thu',
    __('Fri', 'wpdating') => 'Fri', __('Sat', 'wpdating') => 'Sat',
    __('Sun', 'wpdating') => 'Sun');
?>
