        ...
        <div class="dsp_box-in">
            <div class="box-page">
                ...
                <ul class="edit-profile">
                    <li><span><?php echo __('I am:', 'wpdating') ?></span>
                        <?php
                    ...
                    <?php if ($check_zipcode_mode->setting_status == 'Y') { ?> 
                        <li><span><?php echo __('Zip:', 'wpdating'); ?></span>
        ...
        <div class="dsp_box-in">
            <div class="box-page profile-edit-page">
                ...
                foreach ($myrows as $profile_questions) {
                    ...
                    ?>	
                    <li class="dsp-row"><span><?php echo __('About Me', 'wpdating') ?></span>
                    ...
                    ?>	
                    <li class="dsp-row"><span><?php echo __('My Interests', 'wpdating'); ?></span>
...
//Display error message if there are any
                ...
                <ul class="image-edit-profile">
                    ...
                    <li> <img src="<?php echo display_members_photo($current_user->ID, $imagepath); ?>" style="width:100px; height:100px;"  class="img" alt="<?php echo get_username($current_user->ID);?>" />
                        <span><input name="private" type="checkbox" value="Y" <?php if ($exist_profile_details->make_private == 'Y') { ?> checked="checked"  <?php } ?>/><?php echo __('Make Private', 'wpdating'); ?></span>
                    </li>
                    <li><input type="file" name="photoUpload" value=""></li>
                    <li><input type="hidden" name="mode"  value="update"/>
                        <input type="submit" name="submit1" class="dsp_submit_button" value="<?php _e(__('Update', 'wpdating')); ?>" />
                    </li>
                </ul>
