    ...
    jQuery(document).ready(function(e) {
        jQuery("input[name=add_story]").click(function() {
            ...
            if (jQuery.trim(story_title) == "") {
                html += "<?php echo __('Please enter story title.', 'wpdating'); ?>\n";
            }
            var story_content = jQuery("[name=story_content]").val();
            if (jQuery.trim(story_content) == "") {
                html += "<?php echo __('Please enter story content.', 'wpdating'); ?>";
            }
            if (jQuery.trim(html) != "") {
                alert(html);
                return false;
...
<div style="float:left; width:100%;" id="general" class="postbox">
    <h3 class="hndle"><span><?php echo __('Stories', 'wpdating'); ?></span></h3>
    <br />

    <div class="stories-box">
        <h3 class="stories-form-heading"><?php echo __('Add New Story', 'wpdating'); ?></h3>
        <form method="post" enctype="multipart/form-data">
            <div class="story-form"><div class="story-form-row"><span class="story-form-heading"><?php echo __('Title:', 'wpdating'); ?></span><input type="text" name="story_title" value="" /></div>
                <div class="story-form-row"><span class="story-form-heading"><?php echo __('Story:', 'wpdating'); ?></span><textarea name="story_content"></textarea>
<div class="story-pic-add-box"><input type="file" name="story_pic" /><input type="submit" name="add_story" value="<?php echo __('Add', 'wpdating'); ?>" />
<span class="story-add-photo-heading"><?php echo __('Add Photo', 'wpdating'); ?></span></div><div class="image-box" style="display:none;"><input type="hidden" name="update_id" value="" /><img src="" width="100" height="100" alt="Story"/></div>
</div></div>
</form>
</div>
    ...
    if (count($story_result) > 0) {
        ?>
                                    ...
                                    <ul>
                                    <li><span class="story-title-view-heading"><?php echo __('Title:', 'wpdating'); ?></span><span class="story-content-view-heading"><?php echo __('Story:', 'wpdating'); ?></span></li>
                <?php
