...
<div>
    <div id="general" class="postbox">
        <h3 class="hndle"><span><?php echo __('Matches', 'wpdating'); ?></span></h3>
...
//                            echo $dsp_general_settings_table;die;
                    ...
                    <form name="frmgeneralsettings" method="post" action="<?php
                        ...
                        <select name="default_match" style="width:85px;">                            
                            <option value="man" <?php echo ($check_default_match->setting_value == 'man') ?  ' selected="selected"' : ''; ?>><?php echo __('Male', 'wpdating'); ?></option>
                            <option value="woman" <?php echo ($check_default_match->setting_value == 'woman') ?  ' selected="selected"' : ''; ?>><?php echo __('Female', 'wpdating'); ?></option>
                            <option value="couples" <?php echo ($check_default_match->setting_value == 'couples') ?  ' selected="selected"' : ''; ?>><?php echo __('Couples', 'wpdating'); ?></option>
                            <option value="all" <?php echo ($check_default_match->setting_value == 'all') ?  ' selected="selected"' : ''; ?>><?php echo __('All', 'wpdating'); ?></option>                                                        
                        </select>
            ...
            foreach ($myrows as $profile_questions) {
                ...
                <tr>
                    ...
                    <td class="form-field form-required"><a href="<?php
                                                            ...
                                                            ?>"><?php
                                                                if ($display_status == 'Y') {
                                                                    echo __('Active', 'wpdating');
                                                                } else {
                                                                    echo __('Inactive', 'wpdating');
                                                                }
                                                                ?></a></td>
