                    ...
                    jQuery.ajax({
                        ...
                        success: function(html) {
                            if (jQuery.trim(html['output']) === 'success') {
                                ...
                                jQuery("#reset_password").after('<p style="color:red;margin: 10px 0 0 0;" class="error"><?php echo addslashes(__('Alert Email Notifications-> We can&rsquo;t send you a reset password because your notification setting for reset password is selected NO.', 'wpdating')); ?></p>');
                                jQuery(".lost-password-page .error").slideDown();
                                jQuery("#password").val('');
                                jQuery("#cpassword").val('');
                            }
