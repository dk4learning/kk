 ...
 */
class DspFacebookApiException extends Exception
{
  /**
 ...
 * @author Naitik Shah <naitik@facebook.com>
 */
abstract class DspBaseFacebook
{
  /**
   * Version.
   */
  ...
  public function setExtendedAccessToken() {
    ...
    catch (DspFacebookApiException $e) {
   ...
   * @throws DspFacebookApiException
   */
  ...
  protected function makeRequest($url, $params, $ch=null) {
    ...
    if ($result === false) {
      $e = new DspFacebookApiException(array(
  ...
  protected function throwAPIException($result) {
    $e = new DspFacebookApiException($result);
    switch ($e->getType()) {
      // OAuth 2.0 Draft 00 style
      case 'OAuthException':
        // OAuth 2.0 Draft 10 style
