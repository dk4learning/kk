...
function sidebar_login_options_add_page() {
	add_options_page(__('DSP Login','sblogin'), __('DSP Login','sblogin'), 'manage_options', 'sidebar-login', 'sidebar_login_options');
}
...
function sidebar_login_options() {
	...
	?>
	<div class="wrap">
		<?php screen_icon(); echo "<h2>" .__( 'DSP Login Options','sblogin') . "</h2>"; ?>
